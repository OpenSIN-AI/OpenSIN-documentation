# OpenSIN-Code-Database — Setup Guide

> **Repository:** OpenSIN-Code-Database | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
git clone git@github.com:OpenSIN-AI/OpenSIN-Code-Database.git
cd OpenSIN-Code-Database
...
```bash
# Development mode
npm run dev  # or python -m opensin_code_database
