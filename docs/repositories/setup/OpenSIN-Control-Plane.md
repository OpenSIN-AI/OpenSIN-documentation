# OpenSIN-Control-Plane — Setup Guide

> **Repository:** OpenSIN-Control-Plane | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
git clone git@github.com:OpenSIN-AI/OpenSIN-Control-Plane.git
cd OpenSIN-Control-Plane
...
```bash
# Development mode
npm run dev  # or python -m opensin_control_plane
