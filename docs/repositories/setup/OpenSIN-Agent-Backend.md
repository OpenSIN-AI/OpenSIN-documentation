# OpenSIN-Agent-Backend — Setup Guide

> **Repository:** OpenSIN-Agent-Backend | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
git clone git@github.com:OpenSIN-AI/OpenSIN-Agent-Backend.git
cd OpenSIN-Agent-Backend
...
```bash
# Development mode
npm run dev  # or python -m opensin_agent_backend
