# OpenSIN-Security-Forensics — Setup Guide

> **Repository:** OpenSIN-Security-Forensics | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m opensin_security_forensics
