# OpenSIN-Security-RedTeam — Setup Guide

> **Repository:** OpenSIN-Security-RedTeam | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m opensin_security_redteam
