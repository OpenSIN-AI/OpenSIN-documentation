# OpenSIN-Apple-Shortcuts — Setup Guide

> **Repository:** OpenSIN-Apple-Shortcuts | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m opensin_apple_shortcuts
