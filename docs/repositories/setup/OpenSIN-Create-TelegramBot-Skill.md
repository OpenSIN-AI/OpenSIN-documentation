# OpenSIN-Create-TelegramBot-Skill — Setup Guide

> **Repository:** OpenSIN-Create-TelegramBot-Skill | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m opensin_create_telegrambot_skill
