# OpenSIN-Code-AI — Setup Guide

> **Repository:** OpenSIN-Code-AI | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
git clone git@github.com:OpenSIN-AI/OpenSIN-Code-AI.git
cd OpenSIN-Code-AI
...
```bash
# Development mode
npm run dev  # or python -m opensin_code_ai
