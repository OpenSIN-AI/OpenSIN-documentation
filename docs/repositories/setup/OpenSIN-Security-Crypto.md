# OpenSIN-Security-Crypto — Setup Guide

> **Repository:** OpenSIN-Security-Crypto | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m opensin_security_crypto
