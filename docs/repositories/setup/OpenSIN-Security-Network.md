# OpenSIN-Security-Network — Setup Guide

> **Repository:** OpenSIN-Security-Network | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
git clone git@github.com:OpenSIN-AI/OpenSIN-Security-Network.git
cd OpenSIN-Security-Network
...
```bash
# Development mode
npm run dev  # or python -m opensin_security_network
