# OpenSIN-Apple-Mobile — Setup Guide

> **Repository:** OpenSIN-Apple-Mobile | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
git clone git@github.com:OpenSIN-AI/OpenSIN-Apple-Mobile.git
cd OpenSIN-Apple-Mobile
...
```bash
# Development mode
npm run dev  # or python -m opensin_apple_mobile
