# OpenSIN-Security-Social — Setup Guide

> **Repository:** OpenSIN-Security-Social | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
git clone git@github.com:OpenSIN-AI/OpenSIN-Security-Social.git
cd OpenSIN-Security-Social
...
```bash
# Development mode
npm run dev  # or python -m opensin_security_social
