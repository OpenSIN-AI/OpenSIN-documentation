# OpenSIN-Security-Cloud — Setup Guide

> **Repository:** OpenSIN-Security-Cloud | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m opensin_security_cloud
