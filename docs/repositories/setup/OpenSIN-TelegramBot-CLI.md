# OpenSIN-TelegramBot-CLI — Setup Guide

> **Repository:** OpenSIN-TelegramBot-CLI | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m opensin_telegrambot_cli
