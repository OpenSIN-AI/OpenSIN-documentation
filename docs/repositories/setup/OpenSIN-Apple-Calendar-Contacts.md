# OpenSIN-Apple-Calendar-Contacts — Setup Guide

> **Repository:** OpenSIN-Apple-Calendar-Contacts | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
git clone git@github.com:OpenSIN-AI/OpenSIN-Apple-Calendar-Contacts.git
cd OpenSIN-Apple-Calendar-Contacts
...
```bash
# Development mode
npm run dev  # or python -m opensin_apple_calendar_contacts
