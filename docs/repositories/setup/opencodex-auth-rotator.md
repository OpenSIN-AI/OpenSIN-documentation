# opencodex-auth-rotator — Setup Guide

> **Repository:** opencodex-auth-rotator | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m opencodex_auth_rotator
