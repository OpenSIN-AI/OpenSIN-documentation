# A2A-SIN-Team-Orchestrator — Setup Guide

> **Repository:** A2A-SIN-Team-Orchestrator | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m a2a_sin_team_orchestrator
