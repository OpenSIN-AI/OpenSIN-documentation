# OpenSIN-Agent-Forge-Skill — Setup Guide

> **Repository:** OpenSIN-Agent-Forge-Skill | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
git clone git@github.com:OpenSIN-AI/OpenSIN-Agent-Forge-Skill.git
cd OpenSIN-Agent-Forge-Skill
...
```bash
# Development mode
npm run dev  # or python -m opensin_agent_forge_skill
