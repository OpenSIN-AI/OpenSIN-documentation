# OpenSIN-Security-Recon — Setup Guide

> **Repository:** OpenSIN-Security-Recon | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m opensin_security_recon
