# OpenSIN-Agent-Frontend — Setup Guide

> **Repository:** OpenSIN-Agent-Frontend | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m opensin_agent_frontend
