# OpenSIN-Apple-Notifications — Setup Guide

> **Repository:** OpenSIN-Apple-Notifications | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m opensin_apple_notifications
