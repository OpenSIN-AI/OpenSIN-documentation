# Template-A2A-SIN-Agent — Setup Guide

> **Repository:** Template-A2A-SIN-Agent | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m template_a2a_sin_agent
