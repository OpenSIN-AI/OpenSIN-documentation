# A2A-SIN-Team-Community — Setup Guide

> **Repository:** A2A-SIN-Team-Community | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m a2a_sin_team_community
