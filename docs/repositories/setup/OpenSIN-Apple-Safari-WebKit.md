# OpenSIN-Apple-Safari-WebKit — Setup Guide

> **Repository:** OpenSIN-Apple-Safari-WebKit | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m opensin_apple_safari_webkit
