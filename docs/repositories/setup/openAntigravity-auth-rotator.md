# openAntigravity-auth-rotator — Setup Guide

> **Repository:** openAntigravity-auth-rotator | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
git clone git@github.com:OpenSIN-AI/openAntigravity-auth-rotator.git
cd openAntigravity-auth-rotator
...
```bash
# Development mode
npm run dev  # or python -m openantigravity_auth_rotator
