# OpenSIN-Apple-Reminders — Setup Guide

> **Repository:** OpenSIN-Apple-Reminders | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
git clone git@github.com:OpenSIN-AI/OpenSIN-Apple-Reminders.git
cd OpenSIN-Apple-Reminders
...
```bash
# Development mode
npm run dev  # or python -m opensin_apple_reminders
