# A2A-SIN-Stripe — Setup Guide

> **Repository:** A2A-SIN-Stripe | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
git clone git@github.com:OpenSIN-AI/A2A-SIN-Stripe.git
cd A2A-SIN-Stripe
...
```bash
# Development mode
npm run dev  # or python -m a2a_sin_stripe
