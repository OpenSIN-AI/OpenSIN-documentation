# A2A-SIN-TelegramBot — Setup Guide

> **Repository:** A2A-SIN-TelegramBot | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
git clone git@github.com:OpenSIN-AI/A2A-SIN-TelegramBot.git
cd A2A-SIN-TelegramBot
...
```bash
# Development mode
npm run dev  # or python -m a2a_sin_telegrambot
