# OpenSIN-Competitor-Tracker — Setup Guide

> **Repository:** OpenSIN-Competitor-Tracker | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m opensin_competitor_tracker
