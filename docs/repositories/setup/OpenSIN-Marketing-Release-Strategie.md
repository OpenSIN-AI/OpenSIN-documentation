# OpenSIN-Marketing-Release-Strategie — Setup Guide

> **Repository:** OpenSIN-Marketing-Release-Strategie | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
git clone git@github.com:OpenSIN-AI/OpenSIN-Marketing-Release-Strategie.git
cd OpenSIN-Marketing-Release-Strategie
...
```bash
# Development mode
npm run dev  # or python -m opensin_marketing_release_strategie
