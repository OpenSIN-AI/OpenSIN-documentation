# OpenSIN-2Captcha-Worker — Setup Guide

> **Repository:** OpenSIN-2Captcha-Worker | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m opensin_2captcha_worker
