# OpenSIN-Apple-Photos-Files — Setup Guide

> **Repository:** OpenSIN-Apple-Photos-Files | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
git clone git@github.com:OpenSIN-AI/OpenSIN-Apple-Photos-Files.git
cd OpenSIN-Apple-Photos-Files
...
```bash
# Development mode
npm run dev  # or python -m opensin_apple_photos_files
