# OpenSIN-Code-DataScience — Setup Guide

> **Repository:** OpenSIN-Code-DataScience | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m opensin_code_datascience
