# OpenSIN-Apple-DeviceControl — Setup Guide

> **Repository:** OpenSIN-Apple-DeviceControl | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
git clone git@github.com:OpenSIN-AI/OpenSIN-Apple-DeviceControl.git
cd OpenSIN-Apple-DeviceControl
...
```bash
# Development mode
npm run dev  # or python -m opensin_apple_devicecontrol
