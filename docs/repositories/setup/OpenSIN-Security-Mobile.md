# OpenSIN-Security-Mobile — Setup Guide

> **Repository:** OpenSIN-Security-Mobile | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
```bash
# Development mode
npm run dev  # or python -m opensin_security_mobile
