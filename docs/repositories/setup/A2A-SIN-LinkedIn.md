# A2A-SIN-LinkedIn — Setup Guide

> **Repository:** A2A-SIN-LinkedIn | **Organization:** OpenSIN-AI | **Status:** ✅ Active
...
git clone git@github.com:OpenSIN-AI/A2A-SIN-LinkedIn.git
cd A2A-SIN-LinkedIn
...
```bash
# Development mode
npm run dev  # or python -m a2a_sin_linkedin
