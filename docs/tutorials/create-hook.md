...
This tutorial walks you through create hook in the OpenSIN-AI ecosystem.
...
- Read the [advanced guide](../guide/advanced-create-hook.md)
- Check [best practices](../best-practices/create-hook.md)
