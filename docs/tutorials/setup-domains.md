...
This tutorial walks you through setup domains in the OpenSIN-AI ecosystem.
...
- Read the [advanced guide](../guide/advanced-setup-domains.md)
- Check [best practices](../best-practices/setup-domains.md)
