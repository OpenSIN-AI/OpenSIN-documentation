...
This tutorial walks you through configure authorization in the OpenSIN-AI ecosystem.
...
opensin init configure-authorization
cd configure-authorization
```
...
- Read the [advanced guide](../guide/advanced-configure-authorization.md)
- Check [best practices](../best-practices/configure-authorization.md)
