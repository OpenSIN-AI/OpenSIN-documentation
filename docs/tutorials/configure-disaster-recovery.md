...
This tutorial walks you through configure disaster recovery in the OpenSIN-AI ecosystem.
...
opensin init configure-disaster-recovery
cd configure-disaster-recovery
```
...
- Read the [advanced guide](../guide/advanced-configure-disaster-recovery.md)
- Check [best practices](../best-practices/configure-disaster-recovery.md)
