...
This tutorial walks you through optimize performance in the OpenSIN-AI ecosystem.
...
opensin init optimize-performance
cd optimize-performance
```
...
- Read the [advanced guide](../guide/advanced-optimize-performance.md)
- Check [best practices](../best-practices/optimize-performance.md)
