...
This tutorial walks you through setup batch processing in the OpenSIN-AI ecosystem.
...
opensin init setup-batch-processing
cd setup-batch-processing
```
...
- Read the [advanced guide](../guide/advanced-setup-batch-processing.md)
- Check [best practices](../best-practices/setup-batch-processing.md)
