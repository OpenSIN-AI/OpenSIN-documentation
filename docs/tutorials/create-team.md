...
This tutorial walks you through create team in the OpenSIN-AI ecosystem.
...
- Read the [advanced guide](../guide/advanced-create-team.md)
- Check [best practices](../best-practices/create-team.md)
