...
This tutorial walks you through create command in the OpenSIN-AI ecosystem.
...
- Read the [advanced guide](../guide/advanced-create-command.md)
- Check [best practices](../best-practices/create-command.md)
