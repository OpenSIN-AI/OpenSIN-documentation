...
This tutorial walks you through setup microservices in the OpenSIN-AI ecosystem.
...
opensin init setup-microservices
cd setup-microservices
```
...
- Read the [advanced guide](../guide/advanced-setup-microservices.md)
- Check [best practices](../best-practices/setup-microservices.md)
