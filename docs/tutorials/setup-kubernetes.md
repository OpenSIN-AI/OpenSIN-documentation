...
This tutorial walks you through setup kubernetes in the OpenSIN-AI ecosystem.
...
- Read the [advanced guide](../guide/advanced-setup-kubernetes.md)
- Check [best practices](../best-practices/setup-kubernetes.md)
