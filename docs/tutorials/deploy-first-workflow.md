...
This tutorial walks you through deploy first workflow in the OpenSIN-AI ecosystem.
...
opensin init deploy-first-workflow
cd deploy-first-workflow
```
...
- Read the [advanced guide](../guide/advanced-deploy-first-workflow.md)
- Check [best practices](../best-practices/deploy-first-workflow.md)
