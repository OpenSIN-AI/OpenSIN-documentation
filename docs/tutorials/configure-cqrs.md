...
This tutorial walks you through configure cqrs in the OpenSIN-AI ecosystem.
...
- Read the [advanced guide](../guide/advanced-configure-cqrs.md)
- Check [best practices](../best-practices/configure-cqrs.md)
