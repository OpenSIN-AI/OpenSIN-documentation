...
This tutorial walks you through configure auto scaling in the OpenSIN-AI ecosystem.
...
opensin init configure-auto-scaling
cd configure-auto-scaling
```
...
- Read the [advanced guide](../guide/advanced-configure-auto-scaling.md)
- Check [best practices](../best-practices/configure-auto-scaling.md)
