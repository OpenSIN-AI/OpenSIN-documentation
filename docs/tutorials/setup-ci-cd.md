...
This tutorial walks you through setup ci cd in the OpenSIN-AI ecosystem.
...
- Read the [advanced guide](../guide/advanced-setup-ci-cd.md)
- Check [best practices](../best-practices/setup-ci-cd.md)
