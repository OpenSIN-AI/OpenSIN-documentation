...
This tutorial walks you through configure containers in the OpenSIN-AI ecosystem.
...
opensin init configure-containers
cd configure-containers
```
...
- Read the [advanced guide](../guide/advanced-configure-containers.md)
- Check [best practices](../best-practices/configure-containers.md)
