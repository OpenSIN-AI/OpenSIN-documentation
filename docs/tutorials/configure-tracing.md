...
This tutorial walks you through configure tracing in the OpenSIN-AI ecosystem.
...
opensin init configure-tracing
cd configure-tracing
```
...
- Read the [advanced guide](../guide/advanced-configure-tracing.md)
- Check [best practices](../best-practices/configure-tracing.md)
