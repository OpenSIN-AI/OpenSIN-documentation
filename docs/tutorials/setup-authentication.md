...
This tutorial walks you through setup authentication in the OpenSIN-AI ecosystem.
...
opensin init setup-authentication
cd setup-authentication
```
...
- Read the [advanced guide](../guide/advanced-setup-authentication.md)
- Check [best practices](../best-practices/setup-authentication.md)
