...
This tutorial walks you through configure notifications in the OpenSIN-AI ecosystem.
...
opensin init configure-notifications
cd configure-notifications
```
...
- Read the [advanced guide](../guide/advanced-configure-notifications.md)
- Check [best practices](../best-practices/configure-notifications.md)
