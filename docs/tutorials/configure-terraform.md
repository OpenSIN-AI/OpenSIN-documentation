...
This tutorial walks you through configure terraform in the OpenSIN-AI ecosystem.
...
opensin init configure-terraform
cd configure-terraform
```
...
- Read the [advanced guide](../guide/advanced-configure-terraform.md)
- Check [best practices](../best-practices/configure-terraform.md)
