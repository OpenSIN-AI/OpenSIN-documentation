...
This tutorial walks you through setup load balancing in the OpenSIN-AI ecosystem.
...
opensin init setup-load-balancing
cd setup-load-balancing
```
...
- Read the [advanced guide](../guide/advanced-setup-load-balancing.md)
- Check [best practices](../best-practices/setup-load-balancing.md)
