...
This tutorial walks you through setup service mesh in the OpenSIN-AI ecosystem.
...
opensin init setup-service-mesh
cd setup-service-mesh
```
...
- Read the [advanced guide](../guide/advanced-setup-service-mesh.md)
- Check [best practices](../best-practices/setup-service-mesh.md)
