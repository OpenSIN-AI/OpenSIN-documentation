...
This tutorial walks you through configure monolith in the OpenSIN-AI ecosystem.
...
opensin init configure-monolith
cd configure-monolith
```
...
- Read the [advanced guide](../guide/advanced-configure-monolith.md)
- Check [best practices](../best-practices/configure-monolith.md)
