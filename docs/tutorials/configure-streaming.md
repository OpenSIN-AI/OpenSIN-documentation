...
This tutorial walks you through configure streaming in the OpenSIN-AI ecosystem.
...
opensin init configure-streaming
cd configure-streaming
```
...
- Read the [advanced guide](../guide/advanced-configure-streaming.md)
- Check [best practices](../best-practices/configure-streaming.md)
