...
This tutorial walks you through create skill in the OpenSIN-AI ecosystem.
...
- Read the [advanced guide](../guide/advanced-create-skill.md)
- Check [best practices](../best-practices/create-skill.md)
