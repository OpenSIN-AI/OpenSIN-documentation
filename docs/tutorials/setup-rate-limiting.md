...
This tutorial walks you through setup rate limiting in the OpenSIN-AI ecosystem.
...
opensin init setup-rate-limiting
cd setup-rate-limiting
```
...
- Read the [advanced guide](../guide/advanced-setup-rate-limiting.md)
- Check [best practices](../best-practices/setup-rate-limiting.md)
