...
This tutorial walks you through configure dashboards in the OpenSIN-AI ecosystem.
...
opensin init configure-dashboards
cd configure-dashboards
```
...
- Read the [advanced guide](../guide/advanced-configure-dashboards.md)
- Check [best practices](../best-practices/configure-dashboards.md)
