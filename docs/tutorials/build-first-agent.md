...
This tutorial walks you through build first agent in the OpenSIN-AI ecosystem.
...
opensin init build-first-agent
cd build-first-agent
```
...
- Read the [advanced guide](../guide/advanced-build-first-agent.md)
- Check [best practices](../best-practices/build-first-agent.md)
