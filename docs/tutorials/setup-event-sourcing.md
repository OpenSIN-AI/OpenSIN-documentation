...
This tutorial walks you through setup event sourcing in the OpenSIN-AI ecosystem.
...
opensin init setup-event-sourcing
cd setup-event-sourcing
```
...
- Read the [advanced guide](../guide/advanced-setup-event-sourcing.md)
- Check [best practices](../best-practices/setup-event-sourcing.md)
