...
This tutorial walks you through setup webhooks in the OpenSIN-AI ecosystem.
...
- Read the [advanced guide](../guide/advanced-setup-webhooks.md)
- Check [best practices](../best-practices/setup-webhooks.md)
