...
This tutorial walks you through setup monitoring in the OpenSIN-AI ecosystem.
...
- Read the [advanced guide](../guide/advanced-setup-monitoring.md)
- Check [best practices](../best-practices/setup-monitoring.md)
