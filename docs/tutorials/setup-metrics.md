...
This tutorial walks you through setup metrics in the OpenSIN-AI ecosystem.
...
- Read the [advanced guide](../guide/advanced-setup-metrics.md)
- Check [best practices](../best-practices/setup-metrics.md)
