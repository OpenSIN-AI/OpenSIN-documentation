...
This tutorial walks you through configure alerts in the OpenSIN-AI ecosystem.
...
- Read the [advanced guide](../guide/advanced-configure-alerts.md)
- Check [best practices](../best-practices/configure-alerts.md)
