...
This tutorial walks you through configure api gateway in the OpenSIN-AI ecosystem.
...
opensin init configure-api-gateway
cd configure-api-gateway
```
...
- Read the [advanced guide](../guide/advanced-configure-api-gateway.md)
- Check [best practices](../best-practices/configure-api-gateway.md)
