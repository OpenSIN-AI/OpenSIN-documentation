...
This tutorial walks you through configure scheduling in the OpenSIN-AI ecosystem.
...
opensin init configure-scheduling
cd configure-scheduling
```
...
- Read the [advanced guide](../guide/advanced-configure-scheduling.md)
- Check [best practices](../best-practices/configure-scheduling.md)
