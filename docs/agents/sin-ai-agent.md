# Sin Ai Agent — Troubleshooting Guide

> **Agent:** sin-ai-agent | **Category:** Troubleshooting | **Status:** ✅ Active
...
**Resolution:**
1. Check agent status: `sin-n8n get sin-ai-agent`
2. Restart agent: `opencode run --agent "sin-ai-agent" "ping"`
3. Check logs: `tail -f /var/log/opensin/sin-ai-agent.log`
...
1. Collect logs: `journalctl -u sin-ai-agent --no-pager > /tmp/sin-ai-agent-logs.txt`
2. Collect config: `cat /etc/opensin/sin-ai-agent/config.yaml > /tmp/sin-ai-agent-config.txt`
