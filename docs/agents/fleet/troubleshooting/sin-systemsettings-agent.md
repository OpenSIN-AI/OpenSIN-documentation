# Sin Systemsettings Agent — Troubleshooting Guide

> **Agent:** sin-systemsettings-agent | **Category:** Troubleshooting | **Status:** ✅ Active
...
**Resolution:**
1. Check agent status: `sin-n8n get sin-systemsettings-agent`
2. Restart agent: `opencode run --agent "sin-systemsettings-agent" "ping"`
3. Check logs: `tail -f /var/log/opensin/sin-systemsettings-agent.log`
...
1. Collect logs: `journalctl -u sin-systemsettings-agent --no-pager > /tmp/sin-systemsettings-agent-logs.txt`
2. Collect config: `cat /etc/opensin/sin-systemsettings-agent/config.yaml > /tmp/sin-systemsettings-agent-config.txt`
