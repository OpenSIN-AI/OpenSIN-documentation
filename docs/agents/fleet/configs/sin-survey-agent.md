# Sin Survey Agent — Configuration Reference

> **Agent:** sin-survey-agent | **Team:** Survey | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-survey-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin survey agent",
  "team": "survey",
...
|----------|----------|---------|-------------|
| `SIN_SURVEY_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_SURVEY_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_SURVEY_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_SURVEY_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_SURVEY_AGENT_LOG_LEVEL` | No | info | Logging level |
