# Sin Tiktok Agent — Configuration Reference

> **Agent:** sin-tiktok-agent | **Team:** Tiktok | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-tiktok-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin tiktok agent",
  "team": "tiktok",
...
|----------|----------|---------|-------------|
| `SIN_TIKTOK_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_TIKTOK_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_TIKTOK_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_TIKTOK_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_TIKTOK_AGENT_LOG_LEVEL` | No | info | Logging level |
