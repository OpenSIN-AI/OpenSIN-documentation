# Sin Frontend Agent — Configuration Reference

> **Agent:** sin-frontend-agent | **Team:** Frontend | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-frontend-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin frontend agent",
  "team": "frontend",
...
|----------|----------|---------|-------------|
| `SIN_FRONTEND_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_FRONTEND_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_FRONTEND_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_FRONTEND_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_FRONTEND_AGENT_LOG_LEVEL` | No | info | Logging level |
