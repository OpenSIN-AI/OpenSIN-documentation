# Sin Notes Agent — Configuration Reference

> **Agent:** sin-notes-agent | **Team:** Notes | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-notes-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin notes agent",
  "team": "notes",
...
|----------|----------|---------|-------------|
| `SIN_NOTES_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_NOTES_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_NOTES_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_NOTES_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_NOTES_AGENT_LOG_LEVEL` | No | info | Logging level |
