# Sin Ai Agent — Configuration Reference

> **Agent:** sin-ai-agent | **Team:** Ai | **Status:** ✅ Active
...
```json
{
  "name": "sin-ai-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin ai agent",
  "team": "ai",
...
|----------|----------|---------|-------------|
| `SIN_AI_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_AI_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_AI_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_AI_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_AI_AGENT_LOG_LEVEL` | No | info | Logging level |
