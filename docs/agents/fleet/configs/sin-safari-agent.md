# Sin Safari Agent — Configuration Reference

> **Agent:** sin-safari-agent | **Team:** Safari | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-safari-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin safari agent",
  "team": "safari",
...
|----------|----------|---------|-------------|
| `SIN_SAFARI_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_SAFARI_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_SAFARI_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_SAFARI_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_SAFARI_AGENT_LOG_LEVEL` | No | info | Logging level |
