# Sin Privacy Agent — Configuration Reference

> **Agent:** sin-privacy-agent | **Team:** Privacy | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-privacy-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin privacy agent",
  "team": "privacy",
...
|----------|----------|---------|-------------|
| `SIN_PRIVACY_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_PRIVACY_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_PRIVACY_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_PRIVACY_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_PRIVACY_AGENT_LOG_LEVEL` | No | info | Logging level |
