# Sin Monitoring Agent — Configuration Reference

> **Agent:** sin-monitoring-agent | **Team:** Monitoring | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-monitoring-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin monitoring agent",
  "team": "monitoring",
...
|----------|----------|---------|-------------|
| `SIN_MONITORING_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_MONITORING_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_MONITORING_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_MONITORING_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_MONITORING_AGENT_LOG_LEVEL` | No | info | Logging level |
