# Sin Dns Agent — Configuration Reference

> **Agent:** sin-dns-agent | **Team:** Dns | **Status:** ✅ Active
...
```json
{
  "name": "sin-dns-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin dns agent",
  "team": "dns",
...
|----------|----------|---------|-------------|
| `SIN_DNS_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_DNS_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_DNS_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_DNS_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_DNS_AGENT_LOG_LEVEL` | No | info | Logging level |
