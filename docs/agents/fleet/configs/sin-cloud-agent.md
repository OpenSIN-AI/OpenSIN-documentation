# Sin Cloud Agent — Configuration Reference

> **Agent:** sin-cloud-agent | **Team:** Cloud | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-cloud-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin cloud agent",
  "team": "cloud",
...
|----------|----------|---------|-------------|
| `SIN_CLOUD_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_CLOUD_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_CLOUD_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_CLOUD_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_CLOUD_AGENT_LOG_LEVEL` | No | info | Logging level |
