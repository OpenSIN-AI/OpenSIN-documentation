# Sin Prolific Agent — Configuration Reference

> **Agent:** sin-prolific-agent | **Team:** Prolific | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-prolific-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin prolific agent",
  "team": "prolific",
...
|----------|----------|---------|-------------|
| `SIN_PROLIFIC_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_PROLIFIC_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_PROLIFIC_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_PROLIFIC_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_PROLIFIC_AGENT_LOG_LEVEL` | No | info | Logging level |
