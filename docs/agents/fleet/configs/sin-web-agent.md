# Sin Web Agent — Configuration Reference

> **Agent:** sin-web-agent | **Team:** Web | **Status:** ✅ Active
...
```json
{
  "name": "sin-web-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin web agent",
  "team": "web",
...
|----------|----------|---------|-------------|
| `SIN_WEB_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_WEB_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_WEB_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_WEB_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_WEB_AGENT_LOG_LEVEL` | No | info | Logging level |
