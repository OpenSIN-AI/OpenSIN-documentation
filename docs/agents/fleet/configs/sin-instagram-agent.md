# Sin Instagram Agent — Configuration Reference

> **Agent:** sin-instagram-agent | **Team:** Instagram | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-instagram-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin instagram agent",
  "team": "instagram",
...
|----------|----------|---------|-------------|
| `SIN_INSTAGRAM_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_INSTAGRAM_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_INSTAGRAM_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_INSTAGRAM_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_INSTAGRAM_AGENT_LOG_LEVEL` | No | info | Logging level |
