# Sin Oci Agent — Configuration Reference

> **Agent:** sin-oci-agent | **Team:** Oci | **Status:** ✅ Active
...
```json
{
  "name": "sin-oci-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin oci agent",
  "team": "oci",
...
|----------|----------|---------|-------------|
| `SIN_OCI_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_OCI_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_OCI_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_OCI_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_OCI_AGENT_LOG_LEVEL` | No | info | Logging level |
