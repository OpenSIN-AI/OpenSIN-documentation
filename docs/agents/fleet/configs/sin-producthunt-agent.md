# Sin Producthunt Agent — Configuration Reference

> **Agent:** sin-producthunt-agent | **Team:** Producthunt | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-producthunt-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin producthunt agent",
  "team": "producthunt",
...
|----------|----------|---------|-------------|
| `SIN_PRODUCTHUNT_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_PRODUCTHUNT_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_PRODUCTHUNT_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_PRODUCTHUNT_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_PRODUCTHUNT_AGENT_LOG_LEVEL` | No | info | Logging level |
