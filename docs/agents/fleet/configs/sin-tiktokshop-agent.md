# Sin Tiktokshop Agent — Configuration Reference

> **Agent:** sin-tiktokshop-agent | **Team:** Tiktokshop | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-tiktokshop-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin tiktokshop agent",
  "team": "tiktokshop",
...
|----------|----------|---------|-------------|
| `SIN_TIKTOKSHOP_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_TIKTOKSHOP_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_TIKTOKSHOP_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_TIKTOKSHOP_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_TIKTOKSHOP_AGENT_LOG_LEVEL` | No | info | Logging level |
