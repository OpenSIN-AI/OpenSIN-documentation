# Sin Forensics Agent — Configuration Reference

> **Agent:** sin-forensics-agent | **Team:** Forensics | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-forensics-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin forensics agent",
  "team": "forensics",
...
|----------|----------|---------|-------------|
| `SIN_FORENSICS_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_FORENSICS_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_FORENSICS_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_FORENSICS_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_FORENSICS_AGENT_LOG_LEVEL` | No | info | Logging level |
