# Sin Mobile Sec Agent — Configuration Reference

> **Agent:** sin-mobile-sec-agent | **Team:** Mobile | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-mobile-sec-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin mobile sec agent",
  "team": "mobile",
...
|----------|----------|---------|-------------|
| `SIN_MOBILE_SEC_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_MOBILE_SEC_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_MOBILE_SEC_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_MOBILE_SEC_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_MOBILE_SEC_AGENT_LOG_LEVEL` | No | info | Logging level |
