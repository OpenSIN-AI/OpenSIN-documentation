# Sin Social Agent — Configuration Reference

> **Agent:** sin-social-agent | **Team:** Social | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-social-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin social agent",
  "team": "social",
...
|----------|----------|---------|-------------|
| `SIN_SOCIAL_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_SOCIAL_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_SOCIAL_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_SOCIAL_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_SOCIAL_AGENT_LOG_LEVEL` | No | info | Logging level |
