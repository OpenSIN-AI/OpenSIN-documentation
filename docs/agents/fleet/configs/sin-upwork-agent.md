# Sin Upwork Agent — Configuration Reference

> **Agent:** sin-upwork-agent | **Team:** Upwork | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-upwork-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin upwork agent",
  "team": "upwork",
...
|----------|----------|---------|-------------|
| `SIN_UPWORK_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_UPWORK_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_UPWORK_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_UPWORK_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_UPWORK_AGENT_LOG_LEVEL` | No | info | Logging level |
