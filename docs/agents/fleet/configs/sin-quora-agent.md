# Sin Quora Agent — Configuration Reference

> **Agent:** sin-quora-agent | **Team:** Quora | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-quora-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin quora agent",
  "team": "quora",
...
|----------|----------|---------|-------------|
| `SIN_QUORA_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_QUORA_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_QUORA_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_QUORA_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_QUORA_AGENT_LOG_LEVEL` | No | info | Logging level |
