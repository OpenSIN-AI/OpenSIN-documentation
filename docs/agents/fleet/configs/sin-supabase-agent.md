# Sin Supabase Agent — Configuration Reference

> **Agent:** sin-supabase-agent | **Team:** Supabase | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-supabase-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin supabase agent",
  "team": "supabase",
...
|----------|----------|---------|-------------|
| `SIN_SUPABASE_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_SUPABASE_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_SUPABASE_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_SUPABASE_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_SUPABASE_AGENT_LOG_LEVEL` | No | info | Logging level |
