# Sin Logistic Agent — Configuration Reference

> **Agent:** sin-logistic-agent | **Team:** Logistic | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-logistic-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin logistic agent",
  "team": "logistic",
...
|----------|----------|---------|-------------|
| `SIN_LOGISTIC_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_LOGISTIC_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_LOGISTIC_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_LOGISTIC_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_LOGISTIC_AGENT_LOG_LEVEL` | No | info | Logging level |
