# Sin Cloudflare Agent — Configuration Reference

> **Agent:** sin-cloudflare-agent | **Team:** Cloudflare | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-cloudflare-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin cloudflare agent",
  "team": "cloudflare",
...
|----------|----------|---------|-------------|
| `SIN_CLOUDFLARE_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_CLOUDFLARE_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_CLOUDFLARE_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_CLOUDFLARE_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_CLOUDFLARE_AGENT_LOG_LEVEL` | No | info | Logging level |
