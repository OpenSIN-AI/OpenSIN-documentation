# Sin Mindrift Agent — Configuration Reference

> **Agent:** sin-mindrift-agent | **Team:** Mindrift | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-mindrift-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin mindrift agent",
  "team": "mindrift",
...
|----------|----------|---------|-------------|
| `SIN_MINDRIFT_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_MINDRIFT_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_MINDRIFT_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_MINDRIFT_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_MINDRIFT_AGENT_LOG_LEVEL` | No | info | Logging level |
