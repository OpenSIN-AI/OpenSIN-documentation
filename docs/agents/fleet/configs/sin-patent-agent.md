# Sin Patent Agent — Configuration Reference

> **Agent:** sin-patent-agent | **Team:** Patent | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-patent-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin patent agent",
  "team": "patent",
...
|----------|----------|---------|-------------|
| `SIN_PATENT_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_PATENT_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_PATENT_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_PATENT_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_PATENT_AGENT_LOG_LEVEL` | No | info | Logging level |
