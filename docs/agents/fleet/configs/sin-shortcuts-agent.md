# Sin Shortcuts Agent — Configuration Reference

> **Agent:** sin-shortcuts-agent | **Team:** Shortcuts | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-shortcuts-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin shortcuts agent",
  "team": "shortcuts",
...
|----------|----------|---------|-------------|
| `SIN_SHORTCUTS_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_SHORTCUTS_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_SHORTCUTS_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_SHORTCUTS_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_SHORTCUTS_AGENT_LOG_LEVEL` | No | info | Logging level |
