# Sin Mail Agent — Configuration Reference

> **Agent:** sin-mail-agent | **Team:** Mail | **Status:** ✅ Active
...
```json
{
  "name": "sin-mail-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin mail agent",
  "team": "mail",
...
|----------|----------|---------|-------------|
| `SIN_MAIL_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_MAIL_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_MAIL_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_MAIL_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_MAIL_AGENT_LOG_LEVEL` | No | info | Logging level |
