# Sin Refactor Agent — Configuration Reference

> **Agent:** sin-refactor-agent | **Team:** Refactor | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-refactor-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin refactor agent",
  "team": "refactor",
...
|----------|----------|---------|-------------|
| `SIN_REFACTOR_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_REFACTOR_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_REFACTOR_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_REFACTOR_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_REFACTOR_AGENT_LOG_LEVEL` | No | info | Logging level |
