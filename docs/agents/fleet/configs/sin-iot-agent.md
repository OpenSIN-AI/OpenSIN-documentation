# Sin Iot Agent — Configuration Reference

> **Agent:** sin-iot-agent | **Team:** Iot | **Status:** ✅ Active
...
```json
{
  "name": "sin-iot-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin iot agent",
  "team": "iot",
...
|----------|----------|---------|-------------|
| `SIN_IOT_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_IOT_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_IOT_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_IOT_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_IOT_AGENT_LOG_LEVEL` | No | info | Logging level |
