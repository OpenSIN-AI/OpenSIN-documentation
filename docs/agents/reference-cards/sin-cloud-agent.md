# Sin Cloud Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-cloud-agent/)
- [Configuration](../fleet/configs/sin-cloud-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-cloud-agent.md)
