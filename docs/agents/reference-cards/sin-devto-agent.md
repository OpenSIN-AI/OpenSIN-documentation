# Sin Devto Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-devto-agent/)
- [Configuration](../fleet/configs/sin-devto-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-devto-agent.md)
