# Sin Dns Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-dns-agent/)
- [Configuration](../fleet/configs/sin-dns-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-dns-agent.md)
