# Sin Email Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-email-agent/)
- [Configuration](../fleet/configs/sin-email-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-email-agent.md)
