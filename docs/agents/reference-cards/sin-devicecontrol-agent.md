# Sin Devicecontrol Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-devicecontrol-agent/)
- [Configuration](../fleet/configs/sin-devicecontrol-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-devicecontrol-agent.md)
