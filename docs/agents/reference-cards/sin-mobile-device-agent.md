# Sin Mobile Device Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-mobile-device-agent/)
- [Configuration](../fleet/configs/sin-mobile-device-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-mobile-device-agent.md)
