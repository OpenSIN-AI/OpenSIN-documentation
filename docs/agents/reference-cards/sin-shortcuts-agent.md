# Sin Shortcuts Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-shortcuts-agent/)
- [Configuration](../fleet/configs/sin-shortcuts-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-shortcuts-agent.md)
