# Sin Tiktokshop Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-tiktokshop-agent/)
- [Configuration](../fleet/configs/sin-tiktokshop-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-tiktokshop-agent.md)
