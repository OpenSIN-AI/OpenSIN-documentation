# Sin Survey Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-survey-agent/)
- [Configuration](../fleet/configs/sin-survey-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-survey-agent.md)
