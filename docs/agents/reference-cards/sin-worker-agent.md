# Sin Worker Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-worker-agent/)
- [Configuration](../fleet/configs/sin-worker-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-worker-agent.md)
