# Sin Freelancer Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-freelancer-agent/)
- [Configuration](../fleet/configs/sin-freelancer-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-freelancer-agent.md)
