# Sin Refactor Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-refactor-agent/)
- [Configuration](../fleet/configs/sin-refactor-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-refactor-agent.md)
