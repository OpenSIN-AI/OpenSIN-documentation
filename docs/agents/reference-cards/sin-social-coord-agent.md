# Sin Social Coord Agent — Agent Reference Card

> **Agent:** sin-social-coord-agent | **Team:** Social | **Status:** Active
...
```json
{
  ...
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin social coord agent",
  "team": "social",
...
- [Playbooks](../playbooks/sin-social-coord-agent/)
- [Configuration](../fleet/configs/sin-social-coord-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-social-coord-agent.md)
