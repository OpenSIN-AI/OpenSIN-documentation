# Sin Mobile Sec Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-mobile-sec-agent/)
- [Configuration](../fleet/configs/sin-mobile-sec-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-mobile-sec-agent.md)
