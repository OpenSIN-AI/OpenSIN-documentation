# Sin Reminders Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-reminders-agent/)
- [Configuration](../fleet/configs/sin-reminders-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-reminders-agent.md)
