# Sin Web Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-web-agent/)
- [Configuration](../fleet/configs/sin-web-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-web-agent.md)
