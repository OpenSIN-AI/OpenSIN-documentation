# Sin Forensics Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-forensics-agent/)
- [Configuration](../fleet/configs/sin-forensics-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-forensics-agent.md)
