# Sin Systemsettings Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-systemsettings-agent/)
- [Configuration](../fleet/configs/sin-systemsettings-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-systemsettings-agent.md)
