# Sin Medium Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-medium-agent/)
- [Configuration](../fleet/configs/sin-medium-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-medium-agent.md)
