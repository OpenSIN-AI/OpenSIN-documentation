# Sin Upwork Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-upwork-agent/)
- [Configuration](../fleet/configs/sin-upwork-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-upwork-agent.md)
