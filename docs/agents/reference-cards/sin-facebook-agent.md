# Sin Facebook Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-facebook-agent/)
- [Configuration](../fleet/configs/sin-facebook-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-facebook-agent.md)
