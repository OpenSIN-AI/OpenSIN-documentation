# Sin Oci Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-oci-agent/)
- [Configuration](../fleet/configs/sin-oci-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-oci-agent.md)
