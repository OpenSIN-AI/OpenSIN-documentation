# Sin Cloud Agent — Deployment Guide

> **Agent:** sin-cloud-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Cloud Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-cloud-agent.git
cd sin-cloud-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-cloud-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-cloud-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-cloud-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-cloud-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-cloud-agent.md)
- [Integration Guide](../../integrations/agents/sin-cloud-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-cloud-agent.md)
