# Sin Privacy Agent — Deployment Guide

> **Agent:** sin-privacy-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Privacy Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-privacy-agent.git
cd sin-privacy-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-privacy-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-privacy-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-privacy-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-privacy-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-privacy-agent.md)
- [Integration Guide](../../integrations/agents/sin-privacy-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-privacy-agent.md)
