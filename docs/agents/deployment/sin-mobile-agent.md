# Sin Mobile Agent — Deployment Guide

> **Agent:** sin-mobile-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Mobile Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-mobile-agent.git
cd sin-mobile-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-mobile-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-mobile-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-mobile-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-mobile-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-mobile-agent.md)
- [Integration Guide](../../integrations/agents/sin-mobile-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-mobile-agent.md)
