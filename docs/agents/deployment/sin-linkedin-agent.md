# Sin Linkedin Agent — Deployment Guide

> **Agent:** sin-linkedin-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Linkedin Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-linkedin-agent.git
cd sin-linkedin-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-linkedin-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-linkedin-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-linkedin-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-linkedin-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-linkedin-agent.md)
- [Integration Guide](../../integrations/agents/sin-linkedin-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-linkedin-agent.md)
