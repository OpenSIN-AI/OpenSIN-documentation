# Sin Social Agent — Deployment Guide

> **Agent:** sin-social-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Social Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-social-agent.git
cd sin-social-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-social-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-social-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-social-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-social-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-social-agent.md)
- [Integration Guide](../../integrations/agents/sin-social-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-social-agent.md)
