# Sin Gdpr Agent — Deployment Guide

> **Agent:** sin-gdpr-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Gdpr Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-gdpr-agent.git
cd sin-gdpr-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-gdpr-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-gdpr-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-gdpr-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-gdpr-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-gdpr-agent.md)
- [Integration Guide](../../integrations/agents/sin-gdpr-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-gdpr-agent.md)
