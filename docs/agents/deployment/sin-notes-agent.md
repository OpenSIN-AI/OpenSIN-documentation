# Sin Notes Agent — Deployment Guide

> **Agent:** sin-notes-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Notes Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-notes-agent.git
cd sin-notes-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-notes-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-notes-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-notes-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-notes-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-notes-agent.md)
- [Integration Guide](../../integrations/agents/sin-notes-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-notes-agent.md)
