# Sin Oci Agent — Deployment Guide

> **Agent:** sin-oci-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Oci Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-oci-agent.git
cd sin-oci-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-oci-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-oci-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-oci-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-oci-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-oci-agent.md)
- [Integration Guide](../../integrations/agents/sin-oci-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-oci-agent.md)
