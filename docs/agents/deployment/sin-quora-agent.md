# Sin Quora Agent — Deployment Guide

> **Agent:** sin-quora-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Quora Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-quora-agent.git
cd sin-quora-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-quora-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-quora-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-quora-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-quora-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-quora-agent.md)
- [Integration Guide](../../integrations/agents/sin-quora-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-quora-agent.md)
