# Sin Tiktok Agent — Deployment Guide

> **Agent:** sin-tiktok-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Tiktok Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-tiktok-agent.git
cd sin-tiktok-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-tiktok-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-tiktok-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-tiktok-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-tiktok-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-tiktok-agent.md)
- [Integration Guide](../../integrations/agents/sin-tiktok-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-tiktok-agent.md)
