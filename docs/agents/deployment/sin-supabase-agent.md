# Sin Supabase Agent — Deployment Guide

> **Agent:** sin-supabase-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Supabase Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-supabase-agent.git
cd sin-supabase-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-supabase-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-supabase-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-supabase-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-supabase-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-supabase-agent.md)
- [Integration Guide](../../integrations/agents/sin-supabase-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-supabase-agent.md)
