# Sin Producthunt Agent — Deployment Guide

> **Agent:** sin-producthunt-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Producthunt Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-producthunt-agent.git
cd sin-producthunt-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-producthunt-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-producthunt-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-producthunt-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-producthunt-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-producthunt-agent.md)
- [Integration Guide](../../integrations/agents/sin-producthunt-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-producthunt-agent.md)
