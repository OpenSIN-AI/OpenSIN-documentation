# Sin Iot Agent — Deployment Guide

> **Agent:** sin-iot-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Iot Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-iot-agent.git
cd sin-iot-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-iot-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-iot-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-iot-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-iot-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-iot-agent.md)
- [Integration Guide](../../integrations/agents/sin-iot-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-iot-agent.md)
