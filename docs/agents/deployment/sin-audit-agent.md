# Sin Audit Agent — Deployment Guide

> **Agent:** sin-audit-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Audit Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-audit-agent.git
cd sin-audit-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-audit-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-audit-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-audit-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-audit-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-audit-agent.md)
- [Integration Guide](../../integrations/agents/sin-audit-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-audit-agent.md)
