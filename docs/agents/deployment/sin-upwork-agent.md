# Sin Upwork Agent — Deployment Guide

> **Agent:** sin-upwork-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Upwork Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-upwork-agent.git
cd sin-upwork-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-upwork-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-upwork-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-upwork-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-upwork-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-upwork-agent.md)
- [Integration Guide](../../integrations/agents/sin-upwork-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-upwork-agent.md)
