# Sin Fuzz Agent — Incident Response Playbook

> **Agent:** sin-fuzz-agent | **Playbook:** incident-response | **Version:** 1.0 | **Status:** Active

## Purpose

This playbook provides standard operating procedures (SOPs) for incident response playbook of the Sin Fuzz Agent.

## Scope

This playbook covers all aspects of incident response for sin-fuzz-agent.
