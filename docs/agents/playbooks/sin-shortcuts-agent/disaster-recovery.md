# Sin Shortcuts Agent — Disaster Recovery Playbook

> **Agent:** sin-shortcuts-agent | **Playbook:** disaster-recovery | **Version:** 1.0 | **Status:** Active

## Purpose

This playbook provides standard operating procedures (SOPs) for disaster recovery playbook of the Sin Shortcuts Agent.

## Scope

This playbook covers all aspects of disaster recovery for sin-shortcuts-agent.
