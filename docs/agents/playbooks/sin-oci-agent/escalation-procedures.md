# Sin Oci Agent — Escalation Procedures Playbook

> **Agent:** sin-oci-agent | **Playbook:** escalation-procedures | **Version:** 1.0 | **Status:** Active

## Purpose

This playbook provides standard operating procedures (SOPs) for escalation procedures playbook of the Sin Oci Agent.

## Scope

This playbook covers all aspects of escalation procedures for sin-oci-agent.
