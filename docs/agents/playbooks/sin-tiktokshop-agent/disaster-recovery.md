# Sin Tiktokshop Agent — Disaster Recovery Playbook

> **Agent:** sin-tiktokshop-agent | **Playbook:** disaster-recovery | **Version:** 1.0 | **Status:** Active

## Purpose

This playbook provides standard operating procedures (SOPs) for disaster recovery playbook of the Sin Tiktokshop Agent.

## Scope

This playbook covers all aspects of disaster recovery for sin-tiktokshop-agent.
