# Sin Forensics Agent — Disaster Recovery Playbook

> **Agent:** sin-forensics-agent | **Playbook:** disaster-recovery | **Version:** 1.0 | **Status:** Active

## Purpose

This playbook provides standard operating procedures (SOPs) for disaster recovery playbook of the Sin Forensics Agent.

## Scope

This playbook covers all aspects of disaster recovery for sin-forensics-agent.
