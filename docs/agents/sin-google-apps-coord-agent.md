# Sin Google Apps Coord Agent — Troubleshooting Guide

> **Agent:** sin-google-apps-coord-agent | **Category:** Troubleshooting | **Status:** ✅ Active
...
**Resolution:**
1. Check agent status: `sin-n8n get sin-google-apps-coord-agent`
2. Restart agent: `opencode run --agent "sin-google-apps-coord-agent" "ping"`
3. Check logs: `tail -f /var/log/opensin/sin-google-apps-coord-agent.log`
...
1. Collect logs: `journalctl -u sin-google-apps-coord-agent --no-pager > /tmp/sin-google-apps-coord-agent-logs.txt`
2. Collect config: `cat /etc/opensin/sin-google-apps-coord-agent/config.yaml > /tmp/sin-google-apps-coord-agent-config.txt`
