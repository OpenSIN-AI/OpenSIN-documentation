# Sin Iot Agent — Troubleshooting Guide

> **Agent:** sin-iot-agent | **Category:** Troubleshooting | **Status:** ✅ Active
...
**Resolution:**
1. Check agent status: `sin-n8n get sin-iot-agent`
2. Restart agent: `opencode run --agent "sin-iot-agent" "ping"`
3. Check logs: `tail -f /var/log/opensin/sin-iot-agent.log`
...
1. Collect logs: `journalctl -u sin-iot-agent --no-pager > /tmp/sin-iot-agent-logs.txt`
2. Collect config: `cat /etc/opensin/sin-iot-agent/config.yaml > /tmp/sin-iot-agent-config.txt`
