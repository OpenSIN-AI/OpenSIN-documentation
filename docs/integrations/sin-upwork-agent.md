# Sin Upwork Agent — Integration Guide

> **Agent:** sin-upwork-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Upwork Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-upwork-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-upwork-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-upwork-agent.md)
