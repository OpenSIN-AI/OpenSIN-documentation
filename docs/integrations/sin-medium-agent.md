# Sin Medium Agent — Integration Guide

> **Agent:** sin-medium-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Medium Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-medium-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-medium-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-medium-agent.md)
