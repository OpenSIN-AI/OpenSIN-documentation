# Sin Database Agent — Integration Guide

> **Agent:** sin-database-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Database Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-database-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-database-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-database-agent.md)
