# Sin Security Agent — Integration Guide

> **Agent:** sin-security-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Security Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-security-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-security-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-security-agent.md)
