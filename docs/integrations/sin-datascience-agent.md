# Sin Datascience Agent — Integration Guide

> **Agent:** sin-datascience-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Datascience Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-datascience-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-datascience-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-datascience-agent.md)
