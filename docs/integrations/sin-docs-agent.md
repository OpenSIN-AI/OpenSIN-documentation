# Sin Docs Agent — Integration Guide

> **Agent:** sin-docs-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Docs Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-docs-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-docs-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-docs-agent.md)
