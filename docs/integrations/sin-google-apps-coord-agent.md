# Sin Google Apps Coord Agent — Integration Guide

> **Agent:** sin-google-apps-coord-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Google Apps Coord Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-google-apps-coord-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-google-apps-coord-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-google-apps-coord-agent.md)
