# Sin Hf Agent — Integration Guide

> **Agent:** sin-hf-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Hf Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-hf-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-hf-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-hf-agent.md)
