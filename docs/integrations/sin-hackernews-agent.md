# Sin Hackernews Agent — Integration Guide

> **Agent:** sin-hackernews-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Hackernews Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-hackernews-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-hackernews-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-hackernews-agent.md)
