# Sin Qa Agent — Integration Guide

> **Agent:** sin-qa-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Qa Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-qa-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-qa-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-qa-agent.md)
