# Sin Social Agent — Integration Guide

> **Agent:** sin-social-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Social Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-social-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-social-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-social-agent.md)
