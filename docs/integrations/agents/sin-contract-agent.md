# Sin Contract Agent — Integration Guide

> **Agent:** sin-contract-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Contract Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-contract-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-contract-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-contract-agent.md)
