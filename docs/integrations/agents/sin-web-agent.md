# Sin Web Agent — Integration Guide

> **Agent:** sin-web-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Web Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-web-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-web-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-web-agent.md)
