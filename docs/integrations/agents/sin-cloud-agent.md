# Sin Cloud Agent — Integration Guide

> **Agent:** sin-cloud-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Cloud Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-cloud-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-cloud-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-cloud-agent.md)
