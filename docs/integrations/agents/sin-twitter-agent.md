# Sin Twitter Agent — Integration Guide

> **Agent:** sin-twitter-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Twitter Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-twitter-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-twitter-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-twitter-agent.md)
