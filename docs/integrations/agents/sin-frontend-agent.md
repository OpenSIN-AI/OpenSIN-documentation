# Sin Frontend Agent — Integration Guide

> **Agent:** sin-frontend-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Frontend Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-frontend-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-frontend-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-frontend-agent.md)
