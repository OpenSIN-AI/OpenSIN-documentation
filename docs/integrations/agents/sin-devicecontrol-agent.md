# Sin Devicecontrol Agent — Integration Guide

> **Agent:** sin-devicecontrol-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Devicecontrol Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-devicecontrol-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-devicecontrol-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-devicecontrol-agent.md)
