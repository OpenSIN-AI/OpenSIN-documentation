# Sin Calendar Agent — Integration Guide

> **Agent:** sin-calendar-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Calendar Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-calendar-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-calendar-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-calendar-agent.md)
