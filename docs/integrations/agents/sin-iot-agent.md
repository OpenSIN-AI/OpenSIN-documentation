# Sin Iot Agent — Integration Guide

> **Agent:** sin-iot-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Iot Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-iot-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-iot-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-iot-agent.md)
