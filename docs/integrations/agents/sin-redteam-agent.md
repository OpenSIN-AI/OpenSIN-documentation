# Sin Redteam Agent — Integration Guide

> **Agent:** sin-redteam-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Redteam Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-redteam-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-redteam-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-redteam-agent.md)
