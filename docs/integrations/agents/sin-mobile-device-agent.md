# Sin Mobile Device Agent — Integration Guide

> **Agent:** sin-mobile-device-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Mobile Device Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-mobile-device-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-mobile-device-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-mobile-device-agent.md)
