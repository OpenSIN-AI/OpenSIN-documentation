# Sin Refactor Agent — Integration Guide

> **Agent:** sin-refactor-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Refactor Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-refactor-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-refactor-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-refactor-agent.md)
