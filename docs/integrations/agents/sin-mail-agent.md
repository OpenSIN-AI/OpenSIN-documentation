# Sin Mail Agent — Integration Guide

> **Agent:** sin-mail-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Mail Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-mail-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-mail-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-mail-agent.md)
