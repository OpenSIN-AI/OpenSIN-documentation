# Sin Devto Agent — Integration Guide

> **Agent:** sin-devto-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Devto Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-devto-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-devto-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-devto-agent.md)
