# Sin Notes Agent — Integration Guide

> **Agent:** sin-notes-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Notes Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-notes-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-notes-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-notes-agent.md)
