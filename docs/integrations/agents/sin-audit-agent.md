# Sin Audit Agent — Integration Guide

> **Agent:** sin-audit-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Audit Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-audit-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-audit-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-audit-agent.md)
