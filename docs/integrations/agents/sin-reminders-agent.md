# Sin Reminders Agent — Integration Guide

> **Agent:** sin-reminders-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Reminders Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-reminders-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-reminders-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-reminders-agent.md)
