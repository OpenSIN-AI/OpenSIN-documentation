# Sin Logistic Agent — Integration Guide

> **Agent:** sin-logistic-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Logistic Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-logistic-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-logistic-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-logistic-agent.md)
