# Sin Photos Agent — Integration Guide

> **Agent:** sin-photos-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Photos Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-photos-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-photos-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-photos-agent.md)
