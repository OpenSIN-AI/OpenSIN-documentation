# Sin Ai Agent — Integration Guide

> **Agent:** sin-ai-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Ai Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-ai-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-ai-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-ai-agent.md)
