...
- [Agent Playbooks](../../agents/playbooks/sin-crypto-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-crypto-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-crypto-agent.md)
