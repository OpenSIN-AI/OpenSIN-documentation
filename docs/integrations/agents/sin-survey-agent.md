# Sin Survey Agent — Integration Guide

> **Agent:** sin-survey-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Survey Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-survey-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-survey-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-survey-agent.md)
