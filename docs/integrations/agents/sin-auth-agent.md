# Sin Auth Agent — Integration Guide

> **Agent:** sin-auth-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Auth Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-auth-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-auth-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-auth-agent.md)
