# Sin Mindrift Agent — Integration Guide

> **Agent:** sin-mindrift-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Mindrift Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-mindrift-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-mindrift-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-mindrift-agent.md)
