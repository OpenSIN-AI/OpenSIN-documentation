# Sin Safari Agent — Integration Guide

> **Agent:** sin-safari-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Safari Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-safari-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-safari-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-safari-agent.md)
