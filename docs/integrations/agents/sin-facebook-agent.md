# Sin Facebook Agent — Integration Guide

> **Agent:** sin-facebook-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Facebook Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-facebook-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-facebook-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-facebook-agent.md)
