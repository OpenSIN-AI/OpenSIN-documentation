# Sin Youtube Agent — Integration Guide

> **Agent:** sin-youtube-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Youtube Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-youtube-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-youtube-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-youtube-agent.md)
