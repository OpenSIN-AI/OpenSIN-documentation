# Sin Finance Agent — Integration Guide

> **Agent:** sin-finance-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Finance Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-finance-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-finance-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-finance-agent.md)
