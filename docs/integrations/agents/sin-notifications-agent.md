# Sin Notifications Agent — Integration Guide

> **Agent:** sin-notifications-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Notifications Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-notifications-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-notifications-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-notifications-agent.md)
