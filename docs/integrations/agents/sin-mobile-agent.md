# Sin Mobile Agent — Integration Guide

> **Agent:** sin-mobile-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Mobile Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-mobile-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-mobile-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-mobile-agent.md)
