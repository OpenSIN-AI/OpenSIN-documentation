# Sin Pinterest Agent — Integration Guide

> **Agent:** sin-pinterest-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Pinterest Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-pinterest-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-pinterest-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-pinterest-agent.md)
