# Sin Mobile Sec Agent — Integration Guide

> **Agent:** sin-mobile-sec-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Mobile Sec Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-mobile-sec-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-mobile-sec-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-mobile-sec-agent.md)
