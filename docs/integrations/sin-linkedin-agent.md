# Sin Linkedin Agent — Integration Guide

> **Agent:** sin-linkedin-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Linkedin Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-linkedin-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-linkedin-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-linkedin-agent.md)
