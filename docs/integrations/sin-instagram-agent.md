# Sin Instagram Agent — Integration Guide

> **Agent:** sin-instagram-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Instagram Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-instagram-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-instagram-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-instagram-agent.md)
