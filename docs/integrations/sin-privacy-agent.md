# Sin Privacy Agent — Integration Guide

> **Agent:** sin-privacy-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Privacy Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-privacy-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-privacy-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-privacy-agent.md)
