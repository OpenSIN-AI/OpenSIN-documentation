# Sin Email Agent — Integration Guide

> **Agent:** sin-email-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Email Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-email-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-email-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-email-agent.md)
