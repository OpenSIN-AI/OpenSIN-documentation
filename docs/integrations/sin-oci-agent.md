# Sin Oci Agent — Integration Guide

> **Agent:** sin-oci-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Oci Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-oci-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-oci-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-oci-agent.md)
