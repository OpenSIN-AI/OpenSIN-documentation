# Sin Worker Agent — Integration Guide

> **Agent:** sin-worker-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Worker Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-worker-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-worker-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-worker-agent.md)
