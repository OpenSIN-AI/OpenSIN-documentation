# Sin Orchestrator Agent — Integration Guide

> **Agent:** sin-orchestrator-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Orchestrator Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-orchestrator-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-orchestrator-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-orchestrator-agent.md)
