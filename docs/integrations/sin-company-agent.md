# Sin Company Agent — Integration Guide

> **Agent:** sin-company-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Company Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-company-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-company-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-company-agent.md)
