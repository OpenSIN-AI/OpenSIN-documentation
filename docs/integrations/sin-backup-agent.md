# Sin Backup Agent — Integration Guide

> **Agent:** sin-backup-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Backup Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-backup-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-backup-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-backup-agent.md)
