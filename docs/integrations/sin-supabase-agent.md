# Sin Supabase Agent — Integration Guide

> **Agent:** sin-supabase-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Supabase Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-supabase-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-supabase-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-supabase-agent.md)
