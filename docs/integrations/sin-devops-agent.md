# Sin Devops Agent — Integration Guide

> **Agent:** sin-devops-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Devops Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-devops-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-devops-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-devops-agent.md)
