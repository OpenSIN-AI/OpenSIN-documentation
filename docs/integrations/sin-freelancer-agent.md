# Sin Freelancer Agent — Integration Guide

> **Agent:** sin-freelancer-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Freelancer Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-freelancer-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-freelancer-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-freelancer-agent.md)
