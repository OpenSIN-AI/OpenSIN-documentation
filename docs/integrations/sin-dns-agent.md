# Sin Dns Agent — Integration Guide

> **Agent:** sin-dns-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Dns Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-dns-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-dns-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-dns-agent.md)
