# Sin Monitoring Agent — Integration Guide

> **Agent:** sin-monitoring-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Monitoring Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-monitoring-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-monitoring-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-monitoring-agent.md)
