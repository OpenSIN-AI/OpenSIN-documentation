# Sin Forensics Agent — Integration Guide

> **Agent:** sin-forensics-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Forensics Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-forensics-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-forensics-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-forensics-agent.md)
