# Sin Patent Agent — Integration Guide

> **Agent:** sin-patent-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Patent Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-patent-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-patent-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-patent-agent.md)
