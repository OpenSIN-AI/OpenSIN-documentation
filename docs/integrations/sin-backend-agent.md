# Sin Backend Agent — Integration Guide

> **Agent:** sin-backend-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Backend Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-backend-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-backend-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-backend-agent.md)
