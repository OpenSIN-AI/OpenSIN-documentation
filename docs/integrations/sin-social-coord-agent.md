# Sin Social Coord Agent — Integration Guide

> **Agent:** sin-social-coord-agent | **Category:** A2A Agent Integration | **Status:** Active

## Overview

This guide provides detailed integration instructions for the Sin Social Coord Agent within the OpenSIN-AI ecosystem.
...
- [Agent Playbooks](../../agents/playbooks/sin-social-coord-agent/)
- [Agent Configuration](../../agents/fleet/configs/sin-social-coord-agent.md)
- [Agent Troubleshooting](../../agents/fleet/troubleshooting/sin-social-coord-agent.md)
