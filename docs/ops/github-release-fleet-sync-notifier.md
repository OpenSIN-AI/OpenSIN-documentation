# Github Release Fleet Sync Notifier — Operational Runbook

> **Workflow:** github-release-fleet-sync-notifier | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the github release fleet sync notifier workflow.
...
2. Navigate to Workflows > Github Release Fleet Sync Notifier
...
- [Workflow Config](../workflows/github-release-fleet-sync-notifier-json-config.md)
- [Execution Log](../workflows/github-release-fleet-sync-notifier-execution-log.md)
