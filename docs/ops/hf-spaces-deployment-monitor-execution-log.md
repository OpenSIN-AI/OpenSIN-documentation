# Hf Spaces Deployment Monitor — Execution Log Template

> **Workflow:** hf-spaces-deployment-monitor | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the hf spaces deployment monitor workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "hf-spaces-deployment-monitor",
  "workflowName": "Hf Spaces Deployment Monitor",
