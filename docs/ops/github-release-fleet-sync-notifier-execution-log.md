# Github Release Fleet Sync Notifier — Execution Log Template

> **Workflow:** github-release-fleet-sync-notifier | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the github release fleet sync notifier workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "github-release-fleet-sync-notifier",
  "workflowName": "Github Release Fleet Sync Notifier",
