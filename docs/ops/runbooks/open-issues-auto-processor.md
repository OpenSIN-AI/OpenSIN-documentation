# Open Issues Auto Processor — Operational Runbook

> **Workflow:** open-issues-auto-processor | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the open issues auto processor workflow.
...
2. Navigate to Workflows > Open Issues Auto Processor
...
- [Workflow Config](../workflows/open-issues-auto-processor-json-config.md)
- [Execution Log](../workflows/open-issues-auto-processor-execution-log.md)
