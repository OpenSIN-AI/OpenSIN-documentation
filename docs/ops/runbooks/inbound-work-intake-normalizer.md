# Inbound Work Intake Normalizer — Operational Runbook

> **Workflow:** inbound-work-intake-normalizer | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the inbound work intake normalizer workflow.
...
2. Navigate to Workflows > Inbound Work Intake Normalizer
...
- [Workflow Config](../workflows/inbound-work-intake-normalizer-json-config.md)
- [Execution Log](../workflows/inbound-work-intake-normalizer-execution-log.md)
