# Runbook: Telegram Webhook Cert Expired

> **Priority:** P2 | **Service:** Telegram | **Status:** ✅ Active
...
### Immediate Actions
1. **Restart the service:** `systemctl restart telegram`
2. **Clear cache:** `rm -rf /var/cache/telegram/*`
3. **Check dependencies:** Verify all dependent services are running

### If Issue Persists
1. **Check disk space:** `df -h`
2. **Check memory:** `free -h`
3. **Check logs for errors:** `grep -i error /var/log/telegram.log`
