# Github Issue Stale Detector — Operational Runbook

> **Workflow:** github-issue-stale-detector | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the github issue stale detector workflow.
...
2. Navigate to Workflows > Github Issue Stale Detector
...
- [Workflow Config](../workflows/github-issue-stale-detector-json-config.md)
- [Execution Log](../workflows/github-issue-stale-detector-execution-log.md)
