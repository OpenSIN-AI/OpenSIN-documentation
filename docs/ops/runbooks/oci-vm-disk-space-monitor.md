# Oci Vm Disk Space Monitor — Operational Runbook

> **Workflow:** oci-vm-disk-space-monitor | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the oci vm disk space monitor workflow.
...
2. Navigate to Workflows > Oci Vm Disk Space Monitor
...
- [Workflow Config](../workflows/oci-vm-disk-space-monitor-json-config.md)
- [Execution Log](../workflows/oci-vm-disk-space-monitor-execution-log.md)
