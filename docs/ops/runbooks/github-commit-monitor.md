# Github Commit Monitor — Operational Runbook

> **Workflow:** github-commit-monitor | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the github commit monitor workflow.
...
2. Navigate to Workflows > Github Commit Monitor
...
- [Workflow Config](../workflows/github-commit-monitor-json-config.md)
- [Execution Log](../workflows/github-commit-monitor-execution-log.md)
