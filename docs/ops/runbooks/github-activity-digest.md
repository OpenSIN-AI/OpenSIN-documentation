# Github Activity Digest — Operational Runbook

> **Workflow:** github-activity-digest | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the github activity digest workflow.
...
2. Navigate to Workflows > Github Activity Digest
...
- [Workflow Config](../workflows/github-activity-digest-json-config.md)
- [Execution Log](../workflows/github-activity-digest-execution-log.md)
