# Documentation Change Detector — Operational Runbook

> **Workflow:** documentation-change-detector | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the documentation change detector workflow.
...
2. Navigate to Workflows > Documentation Change Detector
...
- [Workflow Config](../workflows/documentation-change-detector-json-config.md)
- [Execution Log](../workflows/documentation-change-detector-execution-log.md)
