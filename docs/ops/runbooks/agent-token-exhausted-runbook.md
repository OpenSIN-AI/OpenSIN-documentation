# Agent Token Exhausted Runbook

> **Category:** Runbook | **Severity:** High | **Version:** 1.0 | **Status:** Active

## Overview

This runbook provides step-by-step procedures for handling agent token exhausted runbook in the OpenSIN-AI ecosystem.

## Symptoms

- Agent Token Exhausted detected
