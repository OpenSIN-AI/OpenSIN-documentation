# Oci Vm Disk Space Monitor — JSON Configuration

> **Workflow:** oci-vm-disk-space-monitor | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Oci Vm Disk Space Monitor",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Oci Vm Disk Space Monitor\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
