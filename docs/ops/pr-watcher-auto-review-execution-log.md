# Pr Watcher Auto Review — Execution Log Template

> **Workflow:** pr-watcher-auto-review | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the pr watcher auto review workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "pr-watcher-auto-review",
  "workflowName": "Pr Watcher Auto Review",
