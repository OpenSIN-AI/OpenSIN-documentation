# Opensin Ai Repo Health Monitor — JSON Configuration

> **Workflow:** opensin-ai-repo-health-monitor | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Opensin Ai Repo Health Monitor",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Opensin Ai Repo Health Monitor\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
