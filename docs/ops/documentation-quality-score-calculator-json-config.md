# Documentation Quality Score Calculator — JSON Configuration

> **Workflow:** documentation-quality-score-calculator | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Documentation Quality Score Calculator",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Documentation Quality Score Calculator\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
