# Auto Security Md Generator — Execution Log Template

> **Workflow:** auto-security-md-generator | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the auto security md generator workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "auto-security-md-generator",
  "workflowName": "Auto Security Md Generator",
