# Auto Changelog Updater — Execution Log Template

> **Workflow:** auto-changelog-updater | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the auto changelog updater workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "auto-changelog-updater",
  "workflowName": "Auto Changelog Updater",
