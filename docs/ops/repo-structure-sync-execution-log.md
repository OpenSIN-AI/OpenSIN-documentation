# Repo Structure Sync — Execution Log Template

> **Workflow:** repo-structure-sync | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the repo structure sync workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "repo-structure-sync",
  "workflowName": "Repo Structure Sync",
