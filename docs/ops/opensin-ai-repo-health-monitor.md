# Opensin Ai Repo Health Monitor — Operational Runbook

> **Workflow:** opensin-ai-repo-health-monitor | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the opensin ai repo health monitor workflow.
...
2. Navigate to Workflows > Opensin Ai Repo Health Monitor
...
- [Workflow Config](../workflows/opensin-ai-repo-health-monitor-json-config.md)
- [Execution Log](../workflows/opensin-ai-repo-health-monitor-execution-log.md)
