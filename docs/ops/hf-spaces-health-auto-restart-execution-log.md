# Hf Spaces Health Auto Restart — Execution Log Template

> **Workflow:** hf-spaces-health-auto-restart | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the hf spaces health auto restart workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "hf-spaces-health-auto-restart",
  "workflowName": "Hf Spaces Health Auto Restart",
