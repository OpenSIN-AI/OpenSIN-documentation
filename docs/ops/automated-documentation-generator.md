# Automated Documentation Generator — Operational Runbook

> **Workflow:** automated-documentation-generator | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the automated documentation generator workflow.
...
2. Navigate to Workflows > Automated Documentation Generator
...
- [Workflow Config](../workflows/automated-documentation-generator-json-config.md)
- [Execution Log](../workflows/automated-documentation-generator-execution-log.md)
