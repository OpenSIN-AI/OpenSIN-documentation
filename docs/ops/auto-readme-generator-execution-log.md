# Auto Readme Generator — Execution Log Template

> **Workflow:** auto-readme-generator | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the auto readme generator workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "auto-readme-generator",
  "workflowName": "Auto Readme Generator",
