# Global Fleet Self Healing Protocol — Operational Runbook

> **Workflow:** global-fleet-self-healing-protocol | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the global fleet self healing protocol workflow.
...
2. Navigate to Workflows > Global Fleet Self Healing Protocol
...
- [Workflow Config](../workflows/global-fleet-self-healing-protocol-json-config.md)
- [Execution Log](../workflows/global-fleet-self-healing-protocol-execution-log.md)
