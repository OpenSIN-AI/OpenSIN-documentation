# Automated Documentation Generator — Execution Log Template

> **Workflow:** automated-documentation-generator | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the automated documentation generator workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "automated-documentation-generator",
  "workflowName": "Automated Documentation Generator",
