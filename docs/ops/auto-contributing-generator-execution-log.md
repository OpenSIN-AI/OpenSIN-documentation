# Auto Contributing Generator — Execution Log Template

> **Workflow:** auto-contributing-generator | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the auto contributing generator workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "auto-contributing-generator",
  "workflowName": "Auto Contributing Generator",
