# New Repo Documentation Bootstrap — Operational Runbook

> **Workflow:** new-repo-documentation-bootstrap | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the new repo documentation bootstrap workflow.
...
2. Navigate to Workflows > New Repo Documentation Bootstrap
...
- [Workflow Config](../workflows/new-repo-documentation-bootstrap-json-config.md)
- [Execution Log](../workflows/new-repo-documentation-bootstrap-execution-log.md)
