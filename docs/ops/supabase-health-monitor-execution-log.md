# Supabase Health Monitor — Execution Log Template

> **Workflow:** supabase-health-monitor | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the supabase health monitor workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "supabase-health-monitor",
  "workflowName": "Supabase Health Monitor",
