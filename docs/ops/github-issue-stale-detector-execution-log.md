# Github Issue Stale Detector — Execution Log Template

> **Workflow:** github-issue-stale-detector | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the github issue stale detector workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "github-issue-stale-detector",
  "workflowName": "Github Issue Stale Detector",
