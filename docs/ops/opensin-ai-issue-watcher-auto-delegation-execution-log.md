# Opensin Ai Issue Watcher Auto Delegation — Execution Log Template

> **Workflow:** opensin-ai-issue-watcher-auto-delegation | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the opensin ai issue watcher auto delegation workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "opensin-ai-issue-watcher-auto-delegation",
  "workflowName": "Opensin Ai Issue Watcher Auto Delegation",
