# Automated Documentation Generator — JSON Configuration

> **Workflow:** automated-documentation-generator | **Category:** n8n Workflow Config | **Status:** Active
  ...
  "nodes": [
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Automated Documentation Generator\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
