# Github Commit Monitor — JSON Configuration

> **Workflow:** github-commit-monitor | **Category:** n8n Workflow Config | **Status:** Active
  ...
  "nodes": [
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Github Commit Monitor\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
