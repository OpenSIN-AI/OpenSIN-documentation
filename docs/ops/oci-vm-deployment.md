# Oci Vm Deployment — Deployment Procedure

> **Category:** Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This document provides step-by-step deployment procedures for oci vm deployment in the OpenSIN-AI ecosystem.
...
```bash
# Clone repository
git clone git@github.com:OpenSIN-AI/oci-vm-deployment.git
cd oci-vm-deployment
...
```bash
# Build application
npm run build  # or docker build -t oci-vm-deployment:latest .
```
...
```bash
# Monitor logs
tail -f /var/log/oci-vm-deployment.log
