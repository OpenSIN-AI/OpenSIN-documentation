# Hugging Face Keepalive Pinger — JSON Configuration

> **Workflow:** hugging-face-keepalive-pinger | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Hugging Face Keepalive Pinger",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Hugging Face Keepalive Pinger\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
