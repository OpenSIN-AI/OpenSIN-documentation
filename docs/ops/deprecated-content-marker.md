# Deprecated Content Marker — Operational Runbook

> **Workflow:** deprecated-content-marker | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the deprecated content marker workflow.
...
2. Navigate to Workflows > Deprecated Content Marker
...
- [Workflow Config](../workflows/deprecated-content-marker-json-config.md)
- [Execution Log](../workflows/deprecated-content-marker-execution-log.md)
