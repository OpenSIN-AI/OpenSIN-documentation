# Open Issues Auto Processor — Execution Log Template

> **Workflow:** open-issues-auto-processor | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the open issues auto processor workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "open-issues-auto-processor",
  "workflowName": "Open Issues Auto Processor",
