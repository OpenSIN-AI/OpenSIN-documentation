# Token Pool Monitor Enhanced — Execution Log Template

> **Workflow:** token-pool-monitor-enhanced | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the token pool monitor enhanced workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "token-pool-monitor-enhanced",
  "workflowName": "Token Pool Monitor Enhanced",
