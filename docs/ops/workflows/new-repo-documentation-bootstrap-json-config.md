# New Repo Documentation Bootstrap — JSON Configuration

> **Workflow:** new-repo-documentation-bootstrap | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "New Repo Documentation Bootstrap",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 New Repo Documentation Bootstrap\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
