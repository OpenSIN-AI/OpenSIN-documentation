# Youtube Playlist Watcher — Reference Guide

> **Workflow:** youtube-playlist-watcher | **Category:** n8n Automation | **Status:** Active

## Overview

The **Youtube Playlist Watcher** workflow is part of the OpenSIN-AI n8n automation system.
