# Open Issues Auto Processor — Reference Guide

> **Workflow:** open-issues-auto-processor | **Category:** n8n Automation | **Status:** Active

## Overview

The **Open Issues Auto Processor** workflow is part of the OpenSIN-AI n8n automation system.
