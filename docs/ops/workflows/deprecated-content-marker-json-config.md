# Deprecated Content Marker — JSON Configuration

> **Workflow:** deprecated-content-marker | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Deprecated Content Marker",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Deprecated Content Marker\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
