# Cross Repo Consistency Enforcer — JSON Configuration

> **Workflow:** cross-repo-consistency-enforcer | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Cross Repo Consistency Enforcer",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Cross Repo Consistency Enforcer\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
