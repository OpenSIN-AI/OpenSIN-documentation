# Opensin Ai Issue Watcher Auto Delegation — JSON Configuration

> **Workflow:** opensin-ai-issue-watcher-auto-delegation | **Category:** n8n Workflow Config | **Status:** Active
  ...
  "nodes": [
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Opensin Ai Issue Watcher Auto Delegation\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
