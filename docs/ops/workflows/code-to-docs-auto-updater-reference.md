# Code To Docs Auto Updater — Reference Guide

> **Workflow:** code-to-docs-auto-updater | **Category:** n8n Automation | **Status:** Active

## Overview

The **Code To Docs Auto Updater** workflow is part of the OpenSIN-AI n8n automation system.
