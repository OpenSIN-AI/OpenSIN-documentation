# Auto Contributing Generator — JSON Configuration

> **Workflow:** auto-contributing-generator | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Auto Contributing Generator",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Auto Contributing Generator\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
