# Repo Structure Sync — Reference Guide

> **Workflow:** repo-structure-sync | **Category:** n8n Automation | **Status:** Active

## Overview

The **Repo Structure Sync** workflow is part of the OpenSIN-AI n8n automation system.
