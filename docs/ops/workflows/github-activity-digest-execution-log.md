# Github Activity Digest — Execution Log Template

> **Workflow:** github-activity-digest | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the github activity digest workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "github-activity-digest",
  "workflowName": "Github Activity Digest",
