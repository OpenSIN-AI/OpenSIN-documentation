# Api Changes Detector — Reference Guide

> **Workflow:** api-changes-detector | **Category:** n8n Automation | **Status:** Active

## Overview

The **Api Changes Detector** workflow is part of the OpenSIN-AI n8n automation system.
