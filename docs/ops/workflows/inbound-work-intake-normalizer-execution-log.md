# Inbound Work Intake Normalizer — Execution Log Template

> **Workflow:** inbound-work-intake-normalizer | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the inbound work intake normalizer workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "inbound-work-intake-normalizer",
  "workflowName": "Inbound Work Intake Normalizer",
