# Auto Documentation Sync Engine — JSON Configuration

> **Workflow:** auto-documentation-sync-engine | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Auto Documentation Sync Engine",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Auto Documentation Sync Engine\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
