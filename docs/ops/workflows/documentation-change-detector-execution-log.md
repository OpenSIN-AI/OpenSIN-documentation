# Documentation Change Detector — Execution Log Template

> **Workflow:** documentation-change-detector | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the documentation change detector workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "documentation-change-detector",
  "workflowName": "Documentation Change Detector",
