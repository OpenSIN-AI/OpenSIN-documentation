# Inbound Work Intake Normalizer — JSON Configuration

> **Workflow:** inbound-work-intake-normalizer | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Inbound Work Intake Normalizer",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Inbound Work Intake Normalizer\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
