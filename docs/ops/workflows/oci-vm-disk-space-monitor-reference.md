# Oci Vm Disk Space Monitor — Reference Guide

> **Workflow:** oci-vm-disk-space-monitor | **Category:** n8n Automation | **Status:** Active

## Overview

The **Oci Vm Disk Space Monitor** workflow is part of the OpenSIN-AI n8n automation system.
