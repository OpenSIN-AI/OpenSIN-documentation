# Feature To Docs Generator — Execution Log Template

> **Workflow:** feature-to-docs-generator | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the feature to docs generator workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "feature-to-docs-generator",
  "workflowName": "Feature To Docs Generator",
