# Sin Fleet Incident Watcher Telegram Hermes — JSON Configuration

> **Workflow:** sin-fleet-incident-watcher-telegram-hermes | **Category:** n8n Workflow Config | **Status:** Active
  ...
  "nodes": [
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Sin Fleet Incident Watcher Telegram Hermes\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
