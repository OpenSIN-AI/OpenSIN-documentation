# Hf Spaces Deployment Monitor — JSON Configuration

> **Workflow:** hf-spaces-deployment-monitor | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Hf Spaces Deployment Monitor",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Hf Spaces Deployment Monitor\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
