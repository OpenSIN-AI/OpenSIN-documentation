# Documentation Staleness Detector — Execution Log Template

> **Workflow:** documentation-staleness-detector | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the documentation staleness detector workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "documentation-staleness-detector",
  "workflowName": "Documentation Staleness Detector",
