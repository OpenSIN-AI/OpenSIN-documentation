# Deprecated Content Marker — Execution Log Template

> **Workflow:** deprecated-content-marker | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the deprecated content marker workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "deprecated-content-marker",
  "workflowName": "Deprecated Content Marker",
