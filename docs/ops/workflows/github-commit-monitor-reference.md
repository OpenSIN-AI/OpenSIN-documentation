# Github Commit Monitor — Reference Guide

> **Workflow:** github-commit-monitor | **Category:** n8n Automation | **Status:** Active

## Overview

The **Github Commit Monitor** workflow is part of the OpenSIN-AI n8n automation system.
