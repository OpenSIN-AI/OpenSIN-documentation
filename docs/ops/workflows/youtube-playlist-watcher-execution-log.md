# Youtube Playlist Watcher — Execution Log Template

> **Workflow:** youtube-playlist-watcher | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the youtube playlist watcher workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "youtube-playlist-watcher",
  "workflowName": "Youtube Playlist Watcher",
