# Api Changes Detector — JSON Configuration

> **Workflow:** api-changes-detector | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Api Changes Detector",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Api Changes Detector\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
