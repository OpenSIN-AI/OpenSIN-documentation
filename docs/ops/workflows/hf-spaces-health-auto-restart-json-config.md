# Hf Spaces Health Auto Restart — JSON Configuration

> **Workflow:** hf-spaces-health-auto-restart | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Hf Spaces Health Auto Restart",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Hf Spaces Health Auto Restart\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
