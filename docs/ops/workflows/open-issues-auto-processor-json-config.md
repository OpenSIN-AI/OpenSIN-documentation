# Open Issues Auto Processor — JSON Configuration

> **Workflow:** open-issues-auto-processor | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Open Issues Auto Processor",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Open Issues Auto Processor\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
