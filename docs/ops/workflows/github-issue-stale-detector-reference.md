# Github Issue Stale Detector — Reference Guide

> **Workflow:** github-issue-stale-detector | **Category:** n8n Automation | **Status:** Active

## Overview

The **Github Issue Stale Detector** workflow is part of the OpenSIN-AI n8n automation system.
