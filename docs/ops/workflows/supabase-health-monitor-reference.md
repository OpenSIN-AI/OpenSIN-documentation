# Supabase Health Monitor — Reference Guide

> **Workflow:** supabase-health-monitor | **Category:** n8n Automation | **Status:** Active

## Overview

The **Supabase Health Monitor** workflow is part of the OpenSIN-AI n8n automation system.
