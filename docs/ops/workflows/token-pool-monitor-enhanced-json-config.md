# Token Pool Monitor Enhanced — JSON Configuration

> **Workflow:** token-pool-monitor-enhanced | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Token Pool Monitor Enhanced",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Token Pool Monitor Enhanced\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
