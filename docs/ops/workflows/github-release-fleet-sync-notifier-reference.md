# Github Release Fleet Sync Notifier — Reference Guide

> **Workflow:** github-release-fleet-sync-notifier | **Category:** n8n Automation | **Status:** Active

## Overview

The **Github Release Fleet Sync Notifier** workflow is part of the OpenSIN-AI n8n automation system.
