# Oci Vm Disk Space Monitor — Execution Log Template

> **Workflow:** oci-vm-disk-space-monitor | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the oci vm disk space monitor workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "oci-vm-disk-space-monitor",
  "workflowName": "Oci Vm Disk Space Monitor",
