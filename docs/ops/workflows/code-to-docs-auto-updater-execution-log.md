# Code To Docs Auto Updater — Execution Log Template

> **Workflow:** code-to-docs-auto-updater | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the code to docs auto updater workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "code-to-docs-auto-updater",
  "workflowName": "Code To Docs Auto Updater",
