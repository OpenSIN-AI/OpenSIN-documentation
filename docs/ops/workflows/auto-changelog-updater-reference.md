# Auto Changelog Updater — Reference Guide

> **Workflow:** auto-changelog-updater | **Category:** n8n Automation | **Status:** Active

## Overview

The **Auto Changelog Updater** workflow is part of the OpenSIN-AI n8n automation system.
