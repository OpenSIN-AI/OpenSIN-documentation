# Cross Repo Documentation Consistency Checker — JSON Configuration

> **Workflow:** cross-repo-documentation-consistency-checker | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Cross Repo Documentation Consistency Checker",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Cross Repo Documentation Consistency Checker\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
