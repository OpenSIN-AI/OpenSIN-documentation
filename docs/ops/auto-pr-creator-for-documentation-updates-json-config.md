# Auto Pr Creator For Documentation Updates — JSON Configuration

> **Workflow:** auto-pr-creator-for-documentation-updates | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Auto Pr Creator For Documentation Updates",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Auto Pr Creator For Documentation Updates\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
