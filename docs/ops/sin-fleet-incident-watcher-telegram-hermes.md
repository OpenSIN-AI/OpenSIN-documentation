# Sin Fleet Incident Watcher Telegram Hermes — Operational Runbook

> **Workflow:** sin-fleet-incident-watcher-telegram-hermes | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the sin fleet incident watcher telegram hermes workflow.
...
2. Navigate to Workflows > Sin Fleet Incident Watcher Telegram Hermes
...
- [Workflow Config](../workflows/sin-fleet-incident-watcher-telegram-hermes-json-config.md)
- [Execution Log](../workflows/sin-fleet-incident-watcher-telegram-hermes-execution-log.md)
