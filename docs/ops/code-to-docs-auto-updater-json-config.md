# Code To Docs Auto Updater — JSON Configuration

> **Workflow:** code-to-docs-auto-updater | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Code To Docs Auto Updater",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Code To Docs Auto Updater\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
