# Pr Watcher Auto Review — JSON Configuration

> **Workflow:** pr-watcher-auto-review | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Pr Watcher Auto Review",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Pr Watcher Auto Review\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
