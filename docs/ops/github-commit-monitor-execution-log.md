# Github Commit Monitor — Execution Log Template

> **Workflow:** github-commit-monitor | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the github commit monitor workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "github-commit-monitor",
  "workflowName": "Github Commit Monitor",
