# Api Changes Detector — Execution Log Template

> **Workflow:** api-changes-detector | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the api changes detector workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "api-changes-detector",
  "workflowName": "Api Changes Detector",
