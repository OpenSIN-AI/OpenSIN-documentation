# Documentation Change Detector — JSON Configuration

> **Workflow:** documentation-change-detector | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Documentation Change Detector",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Documentation Change Detector\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
