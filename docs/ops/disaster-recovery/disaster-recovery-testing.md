...
This document defines the disaster recovery testing procedures for the OpenSIN-AI ecosystem.

## Purpose

Disaster Recovery Testing ensures business continuity and rapid recovery in case of system failures.
