# Pr Watcher Auto Review — Operational Runbook

> **Workflow:** pr-watcher-auto-review | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the pr watcher auto review workflow.
...
2. Navigate to Workflows > Pr Watcher Auto Review
...
- [Workflow Config](../workflows/pr-watcher-auto-review-json-config.md)
- [Execution Log](../workflows/pr-watcher-auto-review-execution-log.md)
