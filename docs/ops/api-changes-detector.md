# Api Changes Detector — Operational Runbook

> **Workflow:** api-changes-detector | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the api changes detector workflow.
...
2. Navigate to Workflows > Api Changes Detector
...
- [Workflow Config](../workflows/api-changes-detector-json-config.md)
- [Execution Log](../workflows/api-changes-detector-execution-log.md)
