# Database Corrupt Runbook

> **Category:** Runbook | **Severity:** High | **Version:** 1.0 | **Status:** Active

## Overview

This runbook provides step-by-step procedures for handling database corrupt runbook in the OpenSIN-AI ecosystem.

## Symptoms

- Database Corrupt detected
