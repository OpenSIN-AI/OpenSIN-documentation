# Opensin Ai Issue Watcher Auto Delegation — Operational Runbook

> **Workflow:** opensin-ai-issue-watcher-auto-delegation | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the opensin ai issue watcher auto delegation workflow.
...
2. Navigate to Workflows > Opensin Ai Issue Watcher Auto Delegation
...
- [Workflow Config](../workflows/opensin-ai-issue-watcher-auto-delegation-json-config.md)
- [Execution Log](../workflows/opensin-ai-issue-watcher-auto-delegation-execution-log.md)
