# Repo Structure Sync — Operational Runbook

> **Workflow:** repo-structure-sync | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the repo structure sync workflow.
...
2. Navigate to Workflows > Repo Structure Sync
...
- [Workflow Config](../workflows/repo-structure-sync-json-config.md)
- [Execution Log](../workflows/repo-structure-sync-execution-log.md)
