# Documentation Staleness Detector — Operational Runbook

> **Workflow:** documentation-staleness-detector | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the documentation staleness detector workflow.
...
2. Navigate to Workflows > Documentation Staleness Detector
...
- [Workflow Config](../workflows/documentation-staleness-detector-json-config.md)
- [Execution Log](../workflows/documentation-staleness-detector-execution-log.md)
