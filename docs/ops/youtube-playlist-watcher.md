# Youtube Playlist Watcher — Operational Runbook

> **Workflow:** youtube-playlist-watcher | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the youtube playlist watcher workflow.
...
2. Navigate to Workflows > Youtube Playlist Watcher
...
- [Workflow Config](../workflows/youtube-playlist-watcher-json-config.md)
- [Execution Log](../workflows/youtube-playlist-watcher-execution-log.md)
