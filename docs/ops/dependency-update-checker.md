# Dependency Update Checker — Operational Runbook

> **Workflow:** dependency-update-checker | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the dependency update checker workflow.
...
2. Navigate to Workflows > Dependency Update Checker
...
- [Workflow Config](../workflows/dependency-update-checker-json-config.md)
- [Execution Log](../workflows/dependency-update-checker-execution-log.md)
