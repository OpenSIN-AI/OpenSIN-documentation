# Auto Contributing Generator — Operational Runbook

> **Workflow:** auto-contributing-generator | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the auto contributing generator workflow.
...
2. Navigate to Workflows > Auto Contributing Generator
...
- [Workflow Config](../workflows/auto-contributing-generator-json-config.md)
- [Execution Log](../workflows/auto-contributing-generator-execution-log.md)
