# Documentation Quality Score Calculator — Operational Runbook

> **Workflow:** documentation-quality-score-calculator | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the documentation quality score calculator workflow.
...
2. Navigate to Workflows > Documentation Quality Score Calculator
...
- [Workflow Config](../workflows/documentation-quality-score-calculator-json-config.md)
- [Execution Log](../workflows/documentation-quality-score-calculator-execution-log.md)
