# New Repo Documentation Bootstrap — Execution Log Template

> **Workflow:** new-repo-documentation-bootstrap | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the new repo documentation bootstrap workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "new-repo-documentation-bootstrap",
  "workflowName": "New Repo Documentation Bootstrap",
