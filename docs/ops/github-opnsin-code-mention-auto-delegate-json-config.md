# Github Opnsin Code Mention Auto Delegate — JSON Configuration

> **Workflow:** github-opnsin-code-mention-auto-delegate | **Category:** n8n Workflow Config | **Status:** Active
  ...
  "nodes": [
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Github Opnsin Code Mention Auto Delegate\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
