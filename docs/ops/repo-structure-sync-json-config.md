# Repo Structure Sync — JSON Configuration

> **Workflow:** repo-structure-sync | **Category:** n8n Workflow Config | **Status:** Active
  ...
  "nodes": [
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Repo Structure Sync\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
