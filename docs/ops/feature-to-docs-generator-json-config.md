# Feature To Docs Generator — JSON Configuration

> **Workflow:** feature-to-docs-generator | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Feature To Docs Generator",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Feature To Docs Generator\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
