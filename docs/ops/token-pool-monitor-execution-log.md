# Token Pool Monitor — Execution Log Template

> **Workflow:** token-pool-monitor | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the token pool monitor workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "token-pool-monitor",
  "workflowName": "Token Pool Monitor",
