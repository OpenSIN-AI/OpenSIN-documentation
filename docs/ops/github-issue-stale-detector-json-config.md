# Github Issue Stale Detector — JSON Configuration

> **Workflow:** github-issue-stale-detector | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Github Issue Stale Detector",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Github Issue Stale Detector\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
