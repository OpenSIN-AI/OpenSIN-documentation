# Code To Docs Auto Updater — Operational Runbook

> **Workflow:** code-to-docs-auto-updater | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the code to docs auto updater workflow.
...
2. Navigate to Workflows > Code To Docs Auto Updater
...
- [Workflow Config](../workflows/code-to-docs-auto-updater-json-config.md)
- [Execution Log](../workflows/code-to-docs-auto-updater-execution-log.md)
