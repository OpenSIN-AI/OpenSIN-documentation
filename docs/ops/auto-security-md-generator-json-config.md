# Auto Security Md Generator — JSON Configuration

> **Workflow:** auto-security-md-generator | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Auto Security Md Generator",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Auto Security Md Generator\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
