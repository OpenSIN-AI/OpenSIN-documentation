# Auto Changelog Updater — JSON Configuration

> **Workflow:** auto-changelog-updater | **Category:** n8n Workflow Config | **Status:** Active

## Workflow JSON

```json
{
  "name": "Auto Changelog Updater",
  "nodes": [
    {
      "parameters": {
        "rule": {
    ...
    },
    {
      "parameters": {
        ...
        "sendBody": true,
        "specifyBody": "json",
        "jsonBody": "={"chat_id": "{{ $env.TELEGRAM_CHAT_ID }}", "text": "📚 Auto Changelog Updater\nTime: {{ $now.format('yyyy-MM-dd HH:mm') }} "}",
        "options": {}
      },
