# Documentation Quality Score Calculator — Execution Log Template

> **Workflow:** documentation-quality-score-calculator | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the documentation quality score calculator workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "documentation-quality-score-calculator",
  "workflowName": "Documentation Quality Score Calculator",
