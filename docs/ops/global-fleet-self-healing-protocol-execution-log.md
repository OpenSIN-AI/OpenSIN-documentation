# Global Fleet Self Healing Protocol — Execution Log Template

> **Workflow:** global-fleet-self-healing-protocol | **Category:** Execution Log | **Status:** Active

## Execution Log Format

Each execution of the global fleet self healing protocol workflow generates a log entry with the following format:

```json
{
  "executionId": "unique-execution-id",
  "workflowId": "global-fleet-self-healing-protocol",
  "workflowName": "Global Fleet Self Healing Protocol",
