# Auto Changelog Updater — Operational Runbook

> **Workflow:** auto-changelog-updater | **Category:** n8n Operations | **Version:** 1.0 | **Status:** Active

## Purpose

This runbook provides step-by-step operational procedures for the auto changelog updater workflow.
...
2. Navigate to Workflows > Auto Changelog Updater
...
- [Workflow Config](../workflows/auto-changelog-updater-json-config.md)
- [Execution Log](../workflows/auto-changelog-updater-execution-log.md)
