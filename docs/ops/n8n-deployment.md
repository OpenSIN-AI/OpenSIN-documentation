# N8N Deployment — Deployment Procedure

> **Category:** Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This document provides step-by-step deployment procedures for n8n deployment in the OpenSIN-AI ecosystem.
...
```bash
# Clone repository
git clone git@github.com:OpenSIN-AI/n8n-deployment.git
cd n8n-deployment
...
```bash
# Build application
npm run build  # or docker build -t n8n-deployment:latest .
```
...
```bash
# Monitor logs
tail -f /var/log/n8n-deployment.log
