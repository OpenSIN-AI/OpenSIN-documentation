# Mcps Health API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Mcps | **Action:** Health | **Version:** v1

## Endpoint

```
GET /api/v1/mcps/health
```

## Description

Detailed reference for the mcps health endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/mcps/health \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/mcps/health",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/mcps/health", nil)
...
curl -X GET http://localhost:3000/api/v1/mcps/health

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/mcps/health
```
