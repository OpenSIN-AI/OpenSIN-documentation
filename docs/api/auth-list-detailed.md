# Auth List API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Auth | **Action:** List | **Version:** v1
...
Detailed reference for the auth list endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/auth/list \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/auth/list",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/auth/list", nil)
...
# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/auth/list
```
