# Tokens Delete API Endpoint — Detailed Reference

> **Method:** DELETE | **Resource:** Tokens | **Action:** Delete | **Version:** v1
...
Detailed reference for the tokens delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/tokens/delete \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/tokens/delete",
    headers={
...
```go
req, _ := http.NewRequest("DELETE", "https://api.opensin.ai/api/v1/tokens/delete", nil)
...
curl -X DELETE http://localhost:3000/api/v1/tokens/delete

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/tokens/delete
```
