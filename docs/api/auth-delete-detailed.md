# Auth Delete API Endpoint — Detailed Reference

> **Method:** DELETE | **Resource:** Auth | **Action:** Delete | **Version:** v1
...
Detailed reference for the auth delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/auth/delete \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/auth/delete",
    headers={
...
```go
req, _ := http.NewRequest("DELETE", "https://api.opensin.ai/api/v1/auth/delete", nil)
...
# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/auth/delete
```
