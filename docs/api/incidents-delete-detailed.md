# Incidents Delete API Endpoint — Detailed Reference

> **Method:** DELETE | **Resource:** Incidents | **Action:** Delete | **Version:** v1
...
Detailed reference for the incidents delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/incidents/delete \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/incidents/delete",
    headers={
...
```go
req, _ := http.NewRequest("DELETE", "https://api.opensin.ai/api/v1/incidents/delete", nil)
...
curl -X DELETE http://localhost:3000/api/v1/incidents/delete

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/incidents/delete
```
