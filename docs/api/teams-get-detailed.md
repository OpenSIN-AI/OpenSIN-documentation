# Teams Get API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Teams | **Action:** Get | **Version:** v1

## Endpoint

```
GET /api/v1/teams/get
```

## Description

Detailed reference for the teams get endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/teams/get \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/teams/get",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/teams/get", nil)
...
curl -X GET http://localhost:3000/api/v1/teams/get

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/teams/get
```
