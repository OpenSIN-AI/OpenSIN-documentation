# Workflows Patch Partial — OpenAPI Specification

> **Endpoint:** /api/v1/workflows | **Method:** PATCH | **Version:** 1.0

## Overview

OpenAPI specification for the workflows patch partial endpoint.
