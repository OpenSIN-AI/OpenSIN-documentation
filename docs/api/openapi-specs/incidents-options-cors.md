# Incidents Options Cors — OpenAPI Specification

> **Endpoint:** /api/v1/incidents | **Method:** OPTIONS | **Version:** 1.0

## Overview

OpenAPI specification for the incidents options cors endpoint.
