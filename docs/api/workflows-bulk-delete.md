# Workflows Bulk Delete — API Reference

> **Endpoint:** `DELETE /api/v1/workflows` | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the workflows bulk delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/workflows \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/workflows",
    headers={
...
curl -X DELETE http://localhost:3000/api/v1/workflows

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/workflows
```
