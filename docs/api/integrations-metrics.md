# Integrations Metrics — API Reference

> **Endpoint:** `GET /api/v1/integrations` | **Method:** GET | **Version:** 1.0

## Overview

Detailed API reference for the integrations metrics endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/integrations \
...
# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/integrations
```
