...
This document covers api gateway compression for the OpenSIN-AI API Gateway.

## Configuration

```yaml
api_gateway:
  api_gateway_compression:
    enabled: true
    settings:
      timeout: 30s
      retries: 3
...
### Step 1: Setup
Configure the api gateway compression in the API Gateway.
