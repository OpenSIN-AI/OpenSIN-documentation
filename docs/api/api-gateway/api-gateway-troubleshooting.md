...
This document covers api gateway troubleshooting for the OpenSIN-AI API Gateway.

## Configuration

```yaml
api_gateway:
  api_gateway_troubleshooting:
    enabled: true
    settings:
      timeout: 30s
      retries: 3
...
### Step 1: Setup
Configure the api gateway troubleshooting in the API Gateway.
