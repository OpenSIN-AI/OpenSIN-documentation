# Api Gateway Downgrade

> **Category:** API Gateway | **Version:** 1.0 | **Status:** Active

## Overview

This document covers api gateway downgrade for the OpenSIN-AI API Gateway.

## Configuration

```yaml
api_gateway:
  api_gateway_downgrade:
    enabled: true
    settings:
      timeout: 30s
      retries: 3
...
### Step 1: Setup
Configure the api gateway downgrade in the API Gateway.
