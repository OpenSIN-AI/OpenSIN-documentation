...
This document covers api gateway ddos protection for the OpenSIN-AI API Gateway.

## Configuration

```yaml
api_gateway:
  api_gateway_ddos_protection:
    enabled: true
    settings:
      timeout: 30s
      retries: 3
...
### Step 1: Setup
Configure the api gateway ddos protection in the API Gateway.
