# Api Gateway Cdn Integration

> **Category:** API Gateway | **Version:** 1.0 | **Status:** Active

## Overview

This document covers api gateway cdn integration for the OpenSIN-AI API Gateway.

## Configuration

```yaml
api_gateway:
  api_gateway_cdn_integration:
    enabled: true
    settings:
      timeout: 30s
      retries: 3
...
### Step 1: Setup
Configure the api gateway cdn integration in the API Gateway.
