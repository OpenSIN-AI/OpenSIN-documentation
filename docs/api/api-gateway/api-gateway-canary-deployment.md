...
This document covers api gateway canary deployment for the OpenSIN-AI API Gateway.

## Configuration

```yaml
api_gateway:
  api_gateway_canary_deployment:
    enabled: true
    settings:
      timeout: 30s
      retries: 3
...
### Step 1: Setup
Configure the api gateway canary deployment in the API Gateway.
