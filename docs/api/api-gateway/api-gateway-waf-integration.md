...
This document covers api gateway waf integration for the OpenSIN-AI API Gateway.

## Configuration

```yaml
api_gateway:
  api_gateway_waf_integration:
    enabled: true
    settings:
      timeout: 30s
      retries: 3
...
### Step 1: Setup
Configure the api gateway waf integration in the API Gateway.
