# Api Gateway Grpc Support

> **Category:** API Gateway | **Version:** 1.0 | **Status:** Active

## Overview

This document covers api gateway grpc support for the OpenSIN-AI API Gateway.

## Configuration

```yaml
api_gateway:
  api_gateway_grpc_support:
    enabled: true
    settings:
      timeout: 30s
      retries: 3
...
### Step 1: Setup
Configure the api gateway grpc support in the API Gateway.
