# Api Gateway Multi Zone

> **Category:** API Gateway | **Version:** 1.0 | **Status:** Active

## Overview

This document covers api gateway multi zone for the OpenSIN-AI API Gateway.

## Configuration

```yaml
api_gateway:
  api_gateway_multi_zone:
    enabled: true
    settings:
      timeout: 30s
      retries: 3
...
### Step 1: Setup
Configure the api gateway multi zone in the API Gateway.
