...
This document covers api gateway websocket support for the OpenSIN-AI API Gateway.

## Configuration

```yaml
api_gateway:
  api_gateway_websocket_support:
    enabled: true
    settings:
      timeout: 30s
      retries: 3
...
### Step 1: Setup
Configure the api gateway websocket support in the API Gateway.
