# Mcps Delete API Endpoint — Detailed Reference

> **Method:** DELETE | **Resource:** Mcps | **Action:** Delete | **Version:** v1

## Endpoint

```
DELETE /api/v1/mcps/delete
```

## Description

Detailed reference for the mcps delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/mcps/delete \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/mcps/delete",
    headers={
...
```go
req, _ := http.NewRequest("DELETE", "https://api.opensin.ai/api/v1/mcps/delete", nil)
...
curl -X DELETE http://localhost:3000/api/v1/mcps/delete

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/mcps/delete
```
