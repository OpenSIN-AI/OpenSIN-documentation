# Agents Delete — API Reference

> **Endpoint:** `DELETE /api/v1/agents`/{id} | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the agents delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/agents/{id} \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/agents/{id}",
    headers={
...
curl -X DELETE http://localhost:3000/api/v1/agents/{id}

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/agents/{id}
```

## Related Endpoints

- [Agents List](./agents-list.md)
- [Agents Health](./agents-health.md)
- [Agents Metrics](./agents-metrics.md)
