# Agents Get — API Reference

> **Endpoint:** `GET /api/v1/agents`/{id} | **Method:** GET | **Version:** 1.0

## Overview

Detailed API reference for the agents get endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/agents/{id} \
...
curl -X GET http://localhost:3000/api/v1/agents/{id}

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/agents/{id}
```
