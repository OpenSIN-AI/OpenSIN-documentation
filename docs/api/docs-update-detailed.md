# Docs Update API Endpoint — Detailed Reference

> **Method:** PUT | **Resource:** Docs | **Action:** Update | **Version:** v1
...
Detailed reference for the docs update endpoint.
...
```bash
curl -X PUT https://api.opensin.ai/api/v1/docs/update \
...
response = requests.put(
    "https://api.opensin.ai/api/v1/docs/update",
    headers={
...
```go
req, _ := http.NewRequest("PUT", "https://api.opensin.ai/api/v1/docs/update", nil)
...
curl -X PUT http://localhost:3000/api/v1/docs/update

# Test with staging
curl -X PUT https://staging-api.opensin.ai/api/v1/docs/update
```
