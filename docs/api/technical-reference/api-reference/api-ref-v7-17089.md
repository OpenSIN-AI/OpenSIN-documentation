...
### cURL
```bash
curl -X GET https://api.opensin.ai/api/v1/api-ref-v7-17089
```

### Python
```python
import requests
response = requests.get('https://api.opensin.ai/api/v1/api-ref-v7-17089')
data = response.json()
```

### JavaScript
```javascript
const response = await fetch('https://api.opensin.ai/api/v1/api-ref-v7-17089');
...
```bash
curl -X GET http://localhost:3000/api/v1/api-ref-v7-17089
```
