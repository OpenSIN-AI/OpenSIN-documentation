# Skills Delete API Endpoint — Detailed Reference

> **Method:** DELETE | **Resource:** Skills | **Action:** Delete | **Version:** v1
...
Detailed reference for the skills delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/skills/delete \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/skills/delete",
    headers={
...
```go
req, _ := http.NewRequest("DELETE", "https://api.opensin.ai/api/v1/skills/delete", nil)
...
curl -X DELETE http://localhost:3000/api/v1/skills/delete

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/skills/delete
```

## Related Endpoints

- [Skills List](./skills-list-detailed.md)
- [Skills Health](./skills-health-detailed.md)
