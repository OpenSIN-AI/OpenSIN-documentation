# Agents Health API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Agents | **Action:** Health | **Version:** v1
...
Detailed reference for the agents health endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/agents/health \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/agents/health",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/agents/health", nil)
...
curl -X GET http://localhost:3000/api/v1/agents/health

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/agents/health
```
