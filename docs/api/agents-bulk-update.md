# Agents Bulk Update — API Reference

> **Endpoint:** `PUT /api/v1/agents` | **Method:** PUT | **Version:** 1.0

## Overview

Detailed API reference for the agents bulk update endpoint.
...
```bash
curl -X PUT https://api.opensin.ai/api/v1/agents \
...
curl -X PUT http://localhost:3000/api/v1/agents

# Test with staging
curl -X PUT https://staging-api.opensin.ai/api/v1/agents
```
