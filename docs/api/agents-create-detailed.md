# Agents Create API Endpoint — Detailed Reference

> **Method:** POST | **Resource:** Agents | **Action:** Create | **Version:** v1
...
Detailed reference for the agents create endpoint.
...
```bash
curl -X POST https://api.opensin.ai/api/v1/agents/create \
...
response = requests.post(
    "https://api.opensin.ai/api/v1/agents/create",
    headers={
...
```go
req, _ := http.NewRequest("POST", "https://api.opensin.ai/api/v1/agents/create", nil)
...
# Test with staging
curl -X POST https://staging-api.opensin.ai/api/v1/agents/create
```
