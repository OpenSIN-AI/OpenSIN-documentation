# Repos Logs API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Repos | **Action:** Logs | **Version:** v1

## Endpoint

```
GET /api/v1/repos/logs
```

## Description

Detailed reference for the repos logs endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/repos/logs \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/repos/logs",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/repos/logs", nil)
...
curl -X GET http://localhost:3000/api/v1/repos/logs

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/repos/logs
```
