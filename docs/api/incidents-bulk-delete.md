# Incidents Bulk Delete — API Reference

> **Endpoint:** `DELETE /api/v1/incidents` | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the incidents bulk delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/incidents \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/incidents",
    headers={
...
curl -X DELETE http://localhost:3000/api/v1/incidents

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/incidents
```
