...
This document covers v2 to v3 migration for the OpenSIN-AI API.

## Description

Detailed documentation for v2 to v3 migration including endpoints, parameters, and response formats.
