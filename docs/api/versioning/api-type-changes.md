...
This document covers api type changes for the OpenSIN-AI API.

## Description

Detailed documentation for api type changes including endpoints, parameters, and response formats.
