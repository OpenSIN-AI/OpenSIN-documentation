...
This document covers api request changes for the OpenSIN-AI API.

## Description

Detailed documentation for api request changes including endpoints, parameters, and response formats.
