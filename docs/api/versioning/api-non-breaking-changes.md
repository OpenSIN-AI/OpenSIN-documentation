...
This document covers api non breaking changes for the OpenSIN-AI API.

## Description

Detailed documentation for api non breaking changes including endpoints, parameters, and response formats.
