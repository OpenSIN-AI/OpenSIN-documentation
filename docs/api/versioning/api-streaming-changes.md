# Api Streaming Changes

> **Category:** API Versioning | **Version:** 1.0 | **Status:** Active

## Overview

This document covers api streaming changes for the OpenSIN-AI API.

## Description

Detailed documentation for api streaming changes including endpoints, parameters, and response formats.
