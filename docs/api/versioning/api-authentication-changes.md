...
This document covers api authentication changes for the OpenSIN-AI API.

## Description

Detailed documentation for api authentication changes including endpoints, parameters, and response formats.
