...
This document covers api response changes for the OpenSIN-AI API.

## Description

Detailed documentation for api response changes including endpoints, parameters, and response formats.
