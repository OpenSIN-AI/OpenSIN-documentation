# Api Batch Operation Changes

> **Category:** API Versioning | **Version:** 1.0 | **Status:** Active

## Overview

This document covers api batch operation changes for the OpenSIN-AI API.

## Description

Detailed documentation for api batch operation changes including endpoints, parameters, and response formats.
