...
This document covers backward compatibility guide for the OpenSIN-AI API.

## Description

Detailed documentation for backward compatibility guide including endpoints, parameters, and response formats.
