...
This document covers api header changes for the OpenSIN-AI API.

## Description

Detailed documentation for api header changes including endpoints, parameters, and response formats.
