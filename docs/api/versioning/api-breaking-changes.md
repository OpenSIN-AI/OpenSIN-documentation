...
This document covers api breaking changes for the OpenSIN-AI API.

## Description

Detailed documentation for api breaking changes including endpoints, parameters, and response formats.
