...
This document covers api authorization changes for the OpenSIN-AI API.

## Description

Detailed documentation for api authorization changes including endpoints, parameters, and response formats.
