...
This document covers api behavior changes for the OpenSIN-AI API.

## Description

Detailed documentation for api behavior changes including endpoints, parameters, and response formats.
