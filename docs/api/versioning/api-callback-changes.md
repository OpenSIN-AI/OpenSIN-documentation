# Api Callback Changes

> **Category:** API Versioning | **Version:** 1.0 | **Status:** Active

## Overview

This document covers api callback changes for the OpenSIN-AI API.

## Description

Detailed documentation for api callback changes including endpoints, parameters, and response formats.
