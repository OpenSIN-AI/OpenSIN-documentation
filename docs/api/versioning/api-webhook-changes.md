...
This document covers api webhook changes for the OpenSIN-AI API.

## Description

Detailed documentation for api webhook changes including endpoints, parameters, and response formats.
