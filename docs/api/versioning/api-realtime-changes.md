...
This document covers api realtime changes for the OpenSIN-AI API.

## Description

Detailed documentation for api realtime changes including endpoints, parameters, and response formats.
