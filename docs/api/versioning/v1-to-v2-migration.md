...
This document covers v1 to v2 migration for the OpenSIN-AI API.

## Description

Detailed documentation for v1 to v2 migration including endpoints, parameters, and response formats.
