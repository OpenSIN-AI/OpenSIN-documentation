# Docs Bulk Delete — API Reference

> **Endpoint:** `DELETE /api/v1/docs` | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the docs bulk delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/docs \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/docs",
    headers={
...
curl -X DELETE http://localhost:3000/api/v1/docs

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/docs
```

## Related Endpoints

- [Docs List](./docs-list.md)
- [Docs Health](./docs-health.md)
- [Docs Metrics](./docs-metrics.md)
