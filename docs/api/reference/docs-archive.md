# Docs Archive — API Reference

> **Endpoint:** `PUT /api/v1/docs`/{id} | **Method:** PUT | **Version:** 1.0

## Overview

Detailed API reference for the docs archive endpoint.
...
```bash
curl -X PUT https://api.opensin.ai/api/v1/docs/{id} \
...
curl -X PUT http://localhost:3000/api/v1/docs/{id}

# Test with staging
curl -X PUT https://staging-api.opensin.ai/api/v1/docs/{id}
```
