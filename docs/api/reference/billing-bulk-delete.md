# Billing Bulk Delete — API Reference

> **Endpoint:** `DELETE /api/v1/billing` | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the billing bulk delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/billing \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/billing",
    headers={
...
curl -X DELETE http://localhost:3000/api/v1/billing

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/billing
```
