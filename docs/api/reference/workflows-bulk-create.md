# Workflows Bulk Create — API Reference

> **Endpoint:** `POST /api/v1/workflows` | **Method:** POST | **Version:** 1.0

## Overview

Detailed API reference for the workflows bulk create endpoint.
...
```bash
curl -X POST https://api.opensin.ai/api/v1/workflows \
...
# Test with staging
curl -X POST https://staging-api.opensin.ai/api/v1/workflows
```
