# Incidents Delete — API Reference

> **Endpoint:** `DELETE /api/v1/incidents`/{id} | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the incidents delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/incidents/{id} \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/incidents/{id}",
    headers={
...
curl -X DELETE http://localhost:3000/api/v1/incidents/{id}

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/incidents/{id}
```

## Related Endpoints

- [Incidents List](./incidents-list.md)
- [Incidents Health](./incidents-health.md)
- [Incidents Metrics](./incidents-metrics.md)
