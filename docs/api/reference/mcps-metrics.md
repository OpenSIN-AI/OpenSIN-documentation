# Mcps Metrics — API Reference

> **Endpoint:** `GET /api/v1/mcps` | **Method:** GET | **Version:** 1.0

## Overview

Detailed API reference for the mcps metrics endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/mcps \
...
curl -X GET http://localhost:3000/api/v1/mcps

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/mcps
```
