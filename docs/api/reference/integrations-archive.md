# Integrations Archive — API Reference

> **Endpoint:** `PUT /api/v1/integrations`/{id} | **Method:** PUT | **Version:** 1.0

## Overview

Detailed API reference for the integrations archive endpoint.
...
```bash
curl -X PUT https://api.opensin.ai/api/v1/integrations/{id} \
...
# Test with staging
curl -X PUT https://staging-api.opensin.ai/api/v1/integrations/{id}
```
