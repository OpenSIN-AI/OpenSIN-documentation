# Agents Bulk Delete — API Reference

> **Endpoint:** `DELETE /api/v1/agents` | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the agents bulk delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/agents \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/agents",
    headers={
...
curl -X DELETE http://localhost:3000/api/v1/agents

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/agents
```
