# Analytics Patch — API Reference

> **Endpoint:** `PATCH /api/v1/analytics`/{id} | **Method:** PATCH | **Version:** 1.0

## Overview

Detailed API reference for the analytics patch endpoint.
...
```bash
curl -X PATCH https://api.opensin.ai/api/v1/analytics/{id} \
...
response = requests.patch(
    "https://api.opensin.ai/api/v1/analytics/{id}",
    headers={
...
curl -X PATCH http://localhost:3000/api/v1/analytics/{id}

# Test with staging
curl -X PATCH https://staging-api.opensin.ai/api/v1/analytics/{id}
```

## Related Endpoints

- [Analytics List](./analytics-list.md)
- [Analytics Health](./analytics-health.md)
