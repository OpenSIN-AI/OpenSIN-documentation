# Docs Metrics API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Docs | **Action:** Metrics | **Version:** v1

## Endpoint

```
GET /api/v1/docs/metrics
```

## Description

Detailed reference for the docs metrics endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/docs/metrics \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/docs/metrics",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/docs/metrics", nil)
...
curl -X GET http://localhost:3000/api/v1/docs/metrics

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/docs/metrics
```

## Related Endpoints

- [Docs List](./docs-list-detailed.md)
- [Docs Health](./docs-health-detailed.md)
