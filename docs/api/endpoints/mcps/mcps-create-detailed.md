# Mcps Create API Endpoint — Detailed Reference

> **Method:** POST | **Resource:** Mcps | **Action:** Create | **Version:** v1

## Endpoint

```
POST /api/v1/mcps/create
```

## Description

Detailed reference for the mcps create endpoint.
...
```bash
curl -X POST https://api.opensin.ai/api/v1/mcps/create \
...
response = requests.post(
    "https://api.opensin.ai/api/v1/mcps/create",
    headers={
...
```go
req, _ := http.NewRequest("POST", "https://api.opensin.ai/api/v1/mcps/create", nil)
...
curl -X POST http://localhost:3000/api/v1/mcps/create

# Test with staging
curl -X POST https://staging-api.opensin.ai/api/v1/mcps/create
```
