# Tokens Health API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Tokens | **Action:** Health | **Version:** v1
...
Detailed reference for the tokens health endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/tokens/health \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/tokens/health",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/tokens/health", nil)
...
curl -X GET http://localhost:3000/api/v1/tokens/health

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/tokens/health
```
