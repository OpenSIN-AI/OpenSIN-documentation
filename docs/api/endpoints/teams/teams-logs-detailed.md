# Teams Logs API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Teams | **Action:** Logs | **Version:** v1

## Endpoint

```
GET /api/v1/teams/logs
```

## Description

Detailed reference for the teams logs endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/teams/logs \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/teams/logs",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/teams/logs", nil)
...
curl -X GET http://localhost:3000/api/v1/teams/logs

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/teams/logs
```
