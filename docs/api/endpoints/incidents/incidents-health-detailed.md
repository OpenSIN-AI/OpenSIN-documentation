# Incidents Health API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Incidents | **Action:** Health | **Version:** v1
...
Detailed reference for the incidents health endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/incidents/health \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/incidents/health",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/incidents/health", nil)
...
curl -X GET http://localhost:3000/api/v1/incidents/health

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/incidents/health
```
