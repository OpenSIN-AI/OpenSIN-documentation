# Auth Create API Endpoint — Detailed Reference

> **Method:** POST | **Resource:** Auth | **Action:** Create | **Version:** v1
...
Detailed reference for the auth create endpoint.
...
```bash
curl -X POST https://api.opensin.ai/api/v1/auth/create \
...
response = requests.post(
    "https://api.opensin.ai/api/v1/auth/create",
    headers={
...
```go
req, _ := http.NewRequest("POST", "https://api.opensin.ai/api/v1/auth/create", nil)
...
# Test with staging
curl -X POST https://staging-api.opensin.ai/api/v1/auth/create
```
