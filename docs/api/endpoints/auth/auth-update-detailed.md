# Auth Update API Endpoint — Detailed Reference

> **Method:** PUT | **Resource:** Auth | **Action:** Update | **Version:** v1
...
Detailed reference for the auth update endpoint.
...
```bash
curl -X PUT https://api.opensin.ai/api/v1/auth/update \
...
response = requests.put(
    "https://api.opensin.ai/api/v1/auth/update",
    headers={
...
```go
req, _ := http.NewRequest("PUT", "https://api.opensin.ai/api/v1/auth/update", nil)
...
# Test with staging
curl -X PUT https://staging-api.opensin.ai/api/v1/auth/update
```
