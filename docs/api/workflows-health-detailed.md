# Workflows Health API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Workflows | **Action:** Health | **Version:** v1
...
Detailed reference for the workflows health endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/workflows/health \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/workflows/health",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/workflows/health", nil)
...
curl -X GET http://localhost:3000/api/v1/workflows/health

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/workflows/health
```
