# Billing Delete — API Reference

> **Endpoint:** `DELETE /api/v1/billing`/{id} | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the billing delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/billing/{id} \
...
curl -X DELETE http://localhost:3000/api/v1/billing/{id}

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/billing/{id}
```
