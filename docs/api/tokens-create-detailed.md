# Tokens Create API Endpoint — Detailed Reference

> **Method:** POST | **Resource:** Tokens | **Action:** Create | **Version:** v1
...
Detailed reference for the tokens create endpoint.
...
```bash
curl -X POST https://api.opensin.ai/api/v1/tokens/create \
...
response = requests.post(
    "https://api.opensin.ai/api/v1/tokens/create",
    headers={
...
```go
req, _ := http.NewRequest("POST", "https://api.opensin.ai/api/v1/tokens/create", nil)
...
# Test with staging
curl -X POST https://staging-api.opensin.ai/api/v1/tokens/create
```
