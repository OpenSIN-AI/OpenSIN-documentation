# Teams Create API Endpoint — Detailed Reference

> **Method:** POST | **Resource:** Teams | **Action:** Create | **Version:** v1
...
Detailed reference for the teams create endpoint.
...
```bash
curl -X POST https://api.opensin.ai/api/v1/teams/create \
...
response = requests.post(
    "https://api.opensin.ai/api/v1/teams/create",
    headers={
...
```go
req, _ := http.NewRequest("POST", "https://api.opensin.ai/api/v1/teams/create", nil)
...
curl -X POST http://localhost:3000/api/v1/teams/create

# Test with staging
curl -X POST https://staging-api.opensin.ai/api/v1/teams/create
```
