# Skills Get API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Skills | **Action:** Get | **Version:** v1

## Endpoint

```
GET /api/v1/skills/get
```

## Description

Detailed reference for the skills get endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/skills/get \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/skills/get",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/skills/get", nil)
...
curl -X GET http://localhost:3000/api/v1/skills/get

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/skills/get
```
