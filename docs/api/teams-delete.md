# Teams Delete — API Reference

> **Endpoint:** `DELETE /api/v1/teams`/{id} | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the teams delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/teams/{id} \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/teams/{id}",
    headers={
...
curl -X DELETE http://localhost:3000/api/v1/teams/{id}

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/teams/{id}
```
