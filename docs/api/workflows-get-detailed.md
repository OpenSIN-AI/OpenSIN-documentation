# Workflows Get API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Workflows | **Action:** Get | **Version:** v1
...
Detailed reference for the workflows get endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/workflows/get \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/workflows/get",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/workflows/get", nil)
...
curl -X GET http://localhost:3000/api/v1/workflows/get

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/workflows/get
```
