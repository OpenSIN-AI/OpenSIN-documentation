# Billing Restore — API Reference

> **Endpoint:** `POST /api/v1/billing`/{id} | **Method:** POST | **Version:** 1.0

## Overview

Detailed API reference for the billing restore endpoint.
...
```bash
curl -X POST https://api.opensin.ai/api/v1/billing/{id} \
...
response = requests.post(
    "https://api.opensin.ai/api/v1/billing/{id}",
    headers={
...
curl -X POST http://localhost:3000/api/v1/billing/{id}

# Test with staging
curl -X POST https://staging-api.opensin.ai/api/v1/billing/{id}
```

## Related Endpoints

- [Billing List](./billing-list.md)
- [Billing Health](./billing-health.md)
- [Billing Metrics](./billing-metrics.md)
