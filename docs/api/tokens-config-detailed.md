# Tokens Config API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Tokens | **Action:** Config | **Version:** v1

## Endpoint

```
GET /api/v1/tokens/config
```

## Description

Detailed reference for the tokens config endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/tokens/config \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/tokens/config",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/tokens/config", nil)
...
curl -X GET http://localhost:3000/api/v1/tokens/config

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/tokens/config
```

## Related Endpoints

- [Tokens List](./tokens-list-detailed.md)
- [Tokens Health](./tokens-health-detailed.md)
