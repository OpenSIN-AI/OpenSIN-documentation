# Agents Delete API Endpoint — Detailed Reference

> **Method:** DELETE | **Resource:** Agents | **Action:** Delete | **Version:** v1
...
Detailed reference for the agents delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/agents/delete \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/agents/delete",
    headers={
...
```go
req, _ := http.NewRequest("DELETE", "https://api.opensin.ai/api/v1/agents/delete", nil)
...
curl -X DELETE http://localhost:3000/api/v1/agents/delete

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/agents/delete
```

## Related Endpoints

- [Agents List](./agents-list-detailed.md)
- [Agents Health](./agents-health-detailed.md)
