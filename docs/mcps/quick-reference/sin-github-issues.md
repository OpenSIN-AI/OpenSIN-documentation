# Sin Github Issues — Quick Reference Card
...
| **Type** | MCP Server |
| **Command** | npx -y @opensin/sin-github-issues |
...
### Basic Usage
```typescript
const result = await mcp.call("sin-github-issues", "tool_1", { param1: "value" });
```

### Advanced Usage
```typescript
const result = await mcp.call("sin-github-issues", "tool_2", { 
  param1: "value1",
  param2: "value2"
});
```
...
- [Reference Guide](../sin-github-issues-reference.md)
- [Troubleshooting](../sin-github-issues-troubleshooting.md)
- [Quick Reference](./sin-github-issues.md)
