# Sin Research — Quick Reference Card
...
| **Name** | sin-research |
| **Type** | MCP Server |
| **Command** | npx -y @opensin/sin-research |
...
### Basic Usage
```typescript
const result = await mcp.call("sin-research", "tool_1", { param1: "value" });
```

### Advanced Usage
```typescript
const result = await mcp.call("sin-research", "tool_2", { 
  param1: "value1",
  param2: "value2"
});
```
...
- [Reference Guide](../sin-research-reference.md)
- [Troubleshooting](../sin-research-troubleshooting.md)
- [Quick Reference](./sin-research.md)
