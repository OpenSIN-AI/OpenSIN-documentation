...
### Basic Usage
```typescript
const result = await mcp.call("canva", "tool_1", { param1: "value" });
```

### Advanced Usage
```typescript
const result = await mcp.call("canva", "tool_2", { 
  param1: "value1",
  param2: "value2"
});
```
...
- [Reference Guide](../canva-reference.md)
- [Troubleshooting](../canva-troubleshooting.md)
- [Quick Reference](./canva.md)
