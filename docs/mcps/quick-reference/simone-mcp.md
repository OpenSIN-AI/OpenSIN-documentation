# Simone Mcp — Quick Reference Card
...
| **Name** | simone-mcp |
| **Type** | MCP Server |
| **Command** | npx -y @opensin/simone-mcp |
...
### Basic Usage
```typescript
const result = await mcp.call("simone-mcp", "tool_1", { param1: "value" });
```

### Advanced Usage
```typescript
const result = await mcp.call("simone-mcp", "tool_2", { 
  param1: "value1",
  param2: "value2"
});
```
...
- [Reference Guide](../simone-mcp-reference.md)
- [Troubleshooting](../simone-mcp-troubleshooting.md)
- [Quick Reference](./simone-mcp.md)
