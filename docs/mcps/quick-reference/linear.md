...
### Basic Usage
```typescript
const result = await mcp.call("linear", "tool_1", { param1: "value" });
```

### Advanced Usage
```typescript
const result = await mcp.call("linear", "tool_2", { 
  param1: "value1",
  param2: "value2"
});
```
...
- [Reference Guide](../linear-reference.md)
- [Troubleshooting](../linear-troubleshooting.md)
- [Quick Reference](./linear.md)
