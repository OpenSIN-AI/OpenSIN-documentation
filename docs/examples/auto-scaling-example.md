# Auto Scaling Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates auto scaling example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/auto-scaling-example.git
cd auto-scaling-example
