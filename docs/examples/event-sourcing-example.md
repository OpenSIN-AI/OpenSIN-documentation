# Event Sourcing Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates event sourcing example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/event-sourcing-example.git
