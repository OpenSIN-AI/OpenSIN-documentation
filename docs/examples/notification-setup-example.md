# Notification Setup Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates notification setup example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/notification-setup-example.git
cd notification-setup-example
