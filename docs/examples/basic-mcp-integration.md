...
This example demonstrates basic mcp integration in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/basic-mcp-integration.git
cd basic-mcp-integration
