# Real Time Processing Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates real time processing example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/real-time-processing-example.git
cd real-time-processing-example
