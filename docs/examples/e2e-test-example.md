# E2E Test Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates e2e test example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/e2e-test-example.git
cd e2e-test-example
