# Strangler Fig Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates strangler fig example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/strangler-fig-example.git
cd strangler-fig-example
