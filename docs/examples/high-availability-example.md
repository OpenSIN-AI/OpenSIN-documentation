# High Availability Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates high availability example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/high-availability-example.git
cd high-availability-example
