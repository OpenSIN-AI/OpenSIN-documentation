# Authorization Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates authorization example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/authorization-example.git
cd authorization-example
