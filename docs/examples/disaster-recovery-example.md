# Disaster Recovery Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates disaster recovery example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/disaster-recovery-example.git
cd disaster-recovery-example
