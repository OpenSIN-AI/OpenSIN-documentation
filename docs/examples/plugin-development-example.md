# Plugin Development Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates plugin development example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/plugin-development-example.git
cd plugin-development-example
