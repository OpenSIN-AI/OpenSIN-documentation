# Dns Setup Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates dns setup example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/dns-setup-example.git
cd dns-setup-example
