# Api Design Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates api design example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/api-design-example.git
cd api-design-example
