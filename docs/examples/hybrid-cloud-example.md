# Hybrid Cloud Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates hybrid cloud example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/hybrid-cloud-example.git
cd hybrid-cloud-example
