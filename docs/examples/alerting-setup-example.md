# Alerting Setup Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates alerting setup example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/alerting-setup-example.git
cd alerting-setup-example
