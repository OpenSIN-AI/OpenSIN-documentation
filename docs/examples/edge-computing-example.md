# Edge Computing Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates edge computing example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/edge-computing-example.git
cd edge-computing-example
