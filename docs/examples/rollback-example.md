# Rollback Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates rollback example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/rollback-example.git
cd rollback-example
