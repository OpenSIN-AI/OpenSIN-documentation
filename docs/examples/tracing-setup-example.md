# Tracing Setup Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates tracing setup example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/tracing-setup-example.git
cd tracing-setup-example
