# Rest Api Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates rest api example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/rest-api-example.git
cd rest-api-example
