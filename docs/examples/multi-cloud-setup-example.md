# Multi Cloud Setup Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates multi cloud setup example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/multi-cloud-setup-example.git
cd multi-cloud-setup-example
