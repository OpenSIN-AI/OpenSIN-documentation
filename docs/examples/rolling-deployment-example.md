# Rolling Deployment Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates rolling deployment example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/rolling-deployment-example.git
cd rolling-deployment-example
