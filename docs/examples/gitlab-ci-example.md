# Gitlab Ci Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates gitlab ci example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/gitlab-ci-example.git
