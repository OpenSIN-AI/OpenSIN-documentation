# Performance Test Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates performance test example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/performance-test-example.git
cd performance-test-example
