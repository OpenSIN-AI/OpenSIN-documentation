# Cloudformation Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates cloudformation example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/cloudformation-example.git
cd cloudformation-example
