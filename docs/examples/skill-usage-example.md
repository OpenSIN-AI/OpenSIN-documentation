# Skill Usage Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates skill usage example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/skill-usage-example.git
cd skill-usage-example
