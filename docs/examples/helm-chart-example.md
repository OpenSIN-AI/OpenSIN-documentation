# Helm Chart Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates helm chart example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/helm-chart-example.git
