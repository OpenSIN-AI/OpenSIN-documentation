# Post Mortem Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates post mortem example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/post-mortem-example.git
cd post-mortem-example
