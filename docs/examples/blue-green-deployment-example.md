# Blue Green Deployment Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates blue green deployment example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/blue-green-deployment-example.git
cd blue-green-deployment-example
