# Canary Deployment Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates canary deployment example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/canary-deployment-example.git
cd canary-deployment-example
