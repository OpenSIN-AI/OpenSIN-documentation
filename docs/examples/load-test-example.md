# Load Test Example — Example

> **Category:** Example | **Difficulty:** Intermediate | **Version:** 1.0 | **Status:** Active

## Overview

This example demonstrates load test example in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/load-test-example.git
cd load-test-example
