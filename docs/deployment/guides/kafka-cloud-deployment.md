...
This guide provides step-by-step instructions for kafka cloud deployment in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/kafka-cloud-deployment.git
cd kafka-cloud-deployment
```
...
docker build -t opensin/kafka-cloud-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/kafka-cloud-deployment:previous
```
