...
This guide provides step-by-step instructions for pulumi deployment in the OpenSIN-AI ecosystem.
...
docker build -t opensin/pulumi-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/pulumi-deployment:previous
```
