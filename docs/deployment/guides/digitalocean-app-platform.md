...
This guide provides step-by-step instructions for digitalocean app platform in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/digitalocean-app-platform.git
...
docker build -t opensin/digitalocean-app-platform:latest .
```
...
docker-compose down
docker-compose up -d opensin/digitalocean-app-platform:previous
```
