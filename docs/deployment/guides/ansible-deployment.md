...
This guide provides step-by-step instructions for ansible deployment in the OpenSIN-AI ecosystem.
...
docker build -t opensin/ansible-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/ansible-deployment:previous
```
