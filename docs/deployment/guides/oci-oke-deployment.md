...
This guide provides step-by-step instructions for oci oke deployment in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/oci-oke-deployment.git
cd oci-oke-deployment
```
...
docker build -t opensin/oci-oke-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/oci-oke-deployment:previous
```
