...
This guide provides step-by-step instructions for argocd deployment in the OpenSIN-AI ecosystem.
...
docker build -t opensin/argocd-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/argocd-deployment:previous
```
