...
This guide provides step-by-step instructions for gitlab ci deployment in the OpenSIN-AI ecosystem.
...
docker build -t opensin/gitlab-ci-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/gitlab-ci-deployment:previous
```
