...
This guide provides step-by-step instructions for supabase deployment in the OpenSIN-AI ecosystem.
...
docker build -t opensin/supabase-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/supabase-deployment:previous
```
