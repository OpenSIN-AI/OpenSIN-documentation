...
This guide provides step-by-step instructions for aws eks deployment in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/aws-eks-deployment.git
...
docker build -t opensin/aws-eks-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/aws-eks-deployment:previous
```
