...
This guide provides step-by-step instructions for planetscale deployment in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/planetscale-deployment.git
cd planetscale-deployment
```
...
docker build -t opensin/planetscale-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/planetscale-deployment:previous
```
