...
This guide provides step-by-step instructions for neon deployment in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/neon-deployment.git
cd neon-deployment
```
...
docker build -t opensin/neon-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/neon-deployment:previous
```
