...
This guide provides step-by-step instructions for docker compose deployment in the OpenSIN-AI ecosystem.
...
docker build -t opensin/docker-compose-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/docker-compose-deployment:previous
```
