...
This guide provides step-by-step instructions for redis cloud deployment in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/redis-cloud-deployment.git
cd redis-cloud-deployment
```
...
docker build -t opensin/redis-cloud-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/redis-cloud-deployment:previous
```
