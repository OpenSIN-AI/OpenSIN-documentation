...
This guide provides step-by-step instructions for hf spaces deployment in the OpenSIN-AI ecosystem.
...
docker build -t opensin/hf-spaces-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/hf-spaces-deployment:previous
```
