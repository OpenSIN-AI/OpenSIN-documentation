...
This guide provides step-by-step instructions for netlify deployment in the OpenSIN-AI ecosystem.
...
docker build -t opensin/netlify-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/netlify-deployment:previous
```
