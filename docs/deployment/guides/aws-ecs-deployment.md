...
This guide provides step-by-step instructions for aws ecs deployment in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/aws-ecs-deployment.git
...
docker build -t opensin/aws-ecs-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/aws-ecs-deployment:previous
```
