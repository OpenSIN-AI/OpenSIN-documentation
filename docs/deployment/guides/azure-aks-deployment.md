...
This guide provides step-by-step instructions for azure aks deployment in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/azure-aks-deployment.git
...
docker build -t opensin/azure-aks-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/azure-aks-deployment:previous
```
