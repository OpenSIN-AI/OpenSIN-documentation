...
This guide provides step-by-step instructions for oci functions deployment in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/oci-functions-deployment.git
cd oci-functions-deployment
```
...
docker build -t opensin/oci-functions-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/oci-functions-deployment:previous
```
