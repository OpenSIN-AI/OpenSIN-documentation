...
This guide provides step-by-step instructions for docker deployment in the OpenSIN-AI ecosystem.
...
docker build -t opensin/docker-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/docker-deployment:previous
```
