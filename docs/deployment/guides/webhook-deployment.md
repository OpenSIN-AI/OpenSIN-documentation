...
This guide provides step-by-step instructions for webhook deployment in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/webhook-deployment.git
...
docker build -t opensin/webhook-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/webhook-deployment:previous
```
