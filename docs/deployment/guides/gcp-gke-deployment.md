...
This guide provides step-by-step instructions for gcp gke deployment in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/gcp-gke-deployment.git
cd gcp-gke-deployment
```
...
docker build -t opensin/gcp-gke-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/gcp-gke-deployment:previous
```
