...
This guide provides step-by-step instructions for cloudflare pages deployment in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/cloudflare-pages-deployment.git
...
docker build -t opensin/cloudflare-pages-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/cloudflare-pages-deployment:previous
```
