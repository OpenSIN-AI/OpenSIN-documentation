...
This guide provides step-by-step instructions for circleci deployment in the OpenSIN-AI ecosystem.
...
docker build -t opensin/circleci-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/circleci-deployment:previous
```
