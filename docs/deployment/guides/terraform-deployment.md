...
This guide provides step-by-step instructions for terraform deployment in the OpenSIN-AI ecosystem.
...
docker build -t opensin/terraform-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/terraform-deployment:previous
```
