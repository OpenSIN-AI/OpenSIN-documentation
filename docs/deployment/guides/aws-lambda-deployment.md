...
This guide provides step-by-step instructions for aws lambda deployment in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/aws-lambda-deployment.git
...
docker build -t opensin/aws-lambda-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/aws-lambda-deployment:previous
```
