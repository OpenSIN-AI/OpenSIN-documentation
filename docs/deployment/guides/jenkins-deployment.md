...
This guide provides step-by-step instructions for jenkins deployment in the OpenSIN-AI ecosystem.
...
docker build -t opensin/jenkins-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/jenkins-deployment:previous
```
