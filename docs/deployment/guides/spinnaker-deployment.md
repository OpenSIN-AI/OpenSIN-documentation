...
This guide provides step-by-step instructions for spinnaker deployment in the OpenSIN-AI ecosystem.
...
git clone git@github.com:OpenSIN-AI/spinnaker-deployment.git
cd spinnaker-deployment
```
...
docker build -t opensin/spinnaker-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/spinnaker-deployment:previous
```
