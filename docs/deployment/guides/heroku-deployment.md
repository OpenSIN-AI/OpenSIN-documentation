...
This guide provides step-by-step instructions for heroku deployment in the OpenSIN-AI ecosystem.
...
docker build -t opensin/heroku-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/heroku-deployment:previous
```
