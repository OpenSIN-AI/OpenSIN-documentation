...
This guide provides step-by-step instructions for kubernetes deployment in the OpenSIN-AI ecosystem.
...
docker build -t opensin/kubernetes-deployment:latest .
```
...
docker-compose down
docker-compose up -d opensin/kubernetes-deployment:previous
```
