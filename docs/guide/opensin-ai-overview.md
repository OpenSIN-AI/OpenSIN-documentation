# OpenSIN-AI Overview — Das gesamte Ökosystem
...
### A2A Protocol
Agent-to-Agent Kommunikation — 100+ autonome Agenten in 18 Teams.

### SIN.md
Auto-discovery Memory System — findet und nutzt projektspezifisches Wissen.

### MCP Client
Multi-transport Model Context Protocol — stdio, SSE, HTTP, WS, in-process.

### Hook System
20+ Hook Events mit 5 Execution Modes — Shell, HTTP, Function, Agent, Prompt.

### Permission System
Multi-source Permission Rules mit Auto-Mode Classifier.

### Sandbox
Secure Code Execution mit Filesystem/Network Rules.
