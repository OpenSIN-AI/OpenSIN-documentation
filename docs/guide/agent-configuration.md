...
task(
  ...
  (prompt = "[CONTEXT]: Grosse Codebase. [GOAL]: Alle API-Endpunkte..."),
);
task(
  (subagent_type = "explore"),
  (run_in_background = true),
  ...
  (prompt = "[CONTEXT]: Grosse Codebase. [GOAL]: Alle Services..."),
);
task(
  (subagent_type = "explore"),
  (run_in_background = true),
  ...
  (prompt = "[CONTEXT]: Grosse Codebase. [GOAL]: Alle Daten-Modelle..."),
);
task(
  ...
  (prompt = "[GOAL]: Offizielle Doku des Frameworks..."),
);
task(
  (subagent_type = "librarian"),
  (run_in_background = true),
  ...
  (prompt = "[GOAL]: Best Practices für die Technologie..."),
);
```
