# Agent Intelligent Routing

> **Category:** Platform Feature | **Version:** 1.0 | **Status:** Active

## Overview

This document describes the agent intelligent routing feature within the OpenSIN-AI platform.

## Feature Description

Agent Intelligent Routing provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-intelligent-routing | GET | List all items |
| /api/v1/agent-intelligent-routing/id | GET | Get item by ID |
| /api/v1/agent-intelligent-routing | POST | Create new item |
| /api/v1/agent-intelligent-routing/id | PUT | Update item |
| /api/v1/agent-intelligent-routing/id | DELETE | Delete item |
