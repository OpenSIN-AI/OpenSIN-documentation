...
This document describes the agent usage tracking feature within the OpenSIN-AI platform.

## Feature Description

Agent Usage Tracking provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-usage-tracking | GET | List all items |
| /api/v1/agent-usage-tracking/id | GET | Get item by ID |
| /api/v1/agent-usage-tracking | POST | Create new item |
| /api/v1/agent-usage-tracking/id | PUT | Update item |
| /api/v1/agent-usage-tracking/id | DELETE | Delete item |
