...
This document describes the agent multi zone feature within the OpenSIN-AI platform.

## Feature Description

Agent Multi Zone provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-multi-zone | GET | List all items |
| /api/v1/agent-multi-zone/id | GET | Get item by ID |
| /api/v1/agent-multi-zone | POST | Create new item |
| /api/v1/agent-multi-zone/id | PUT | Update item |
| /api/v1/agent-multi-zone/id | DELETE | Delete item |
