...
This document describes the agent downgrade feature within the OpenSIN-AI platform.

## Feature Description

Agent Downgrade provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-downgrade | GET | List all items |
| /api/v1/agent-downgrade/id | GET | Get item by ID |
| /api/v1/agent-downgrade | POST | Create new item |
| /api/v1/agent-downgrade/id | PUT | Update item |
| /api/v1/agent-downgrade/id | DELETE | Delete item |
