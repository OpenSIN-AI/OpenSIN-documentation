# Agent Manual Scaling

> **Category:** Platform Feature | **Version:** 1.0 | **Status:** Active

## Overview

This document describes the agent manual scaling feature within the OpenSIN-AI platform.

## Feature Description

Agent Manual Scaling provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-manual-scaling | GET | List all items |
| /api/v1/agent-manual-scaling/id | GET | Get item by ID |
| /api/v1/agent-manual-scaling | POST | Create new item |
| /api/v1/agent-manual-scaling/id | PUT | Update item |
| /api/v1/agent-manual-scaling/id | DELETE | Delete item |
