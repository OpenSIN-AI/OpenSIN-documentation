...
This document describes the agent rollback feature within the OpenSIN-AI platform.

## Feature Description

Agent Rollback provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-rollback | GET | List all items |
| /api/v1/agent-rollback/id | GET | Get item by ID |
| /api/v1/agent-rollback | POST | Create new item |
| /api/v1/agent-rollback/id | PUT | Update item |
| /api/v1/agent-rollback/id | DELETE | Delete item |
