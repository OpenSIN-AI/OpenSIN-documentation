# Agent Backup Retention

> **Category:** Platform Feature | **Version:** 1.0 | **Status:** Active

## Overview

This document describes the agent backup retention feature within the OpenSIN-AI platform.

## Feature Description

Agent Backup Retention provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-backup-retention | GET | List all items |
| /api/v1/agent-backup-retention/id | GET | Get item by ID |
| /api/v1/agent-backup-retention | POST | Create new item |
| /api/v1/agent-backup-retention/id | PUT | Update item |
| /api/v1/agent-backup-retention/id | DELETE | Delete item |
