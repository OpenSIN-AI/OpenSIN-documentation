...
This document describes the agent forking feature within the OpenSIN-AI platform.

## Feature Description

Agent Forking provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-forking | GET | List all items |
| /api/v1/agent-forking/id | GET | Get item by ID |
| /api/v1/agent-forking | POST | Create new item |
| /api/v1/agent-forking/id | PUT | Update item |
| /api/v1/agent-forking/id | DELETE | Delete item |
