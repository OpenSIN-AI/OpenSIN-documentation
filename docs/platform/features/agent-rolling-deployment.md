...
This document describes the agent rolling deployment feature within the OpenSIN-AI platform.

## Feature Description

Agent Rolling Deployment provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-rolling-deployment | GET | List all items |
| /api/v1/agent-rolling-deployment/id | GET | Get item by ID |
| /api/v1/agent-rolling-deployment | POST | Create new item |
| /api/v1/agent-rolling-deployment/id | PUT | Update item |
| /api/v1/agent-rolling-deployment/id | DELETE | Delete item |
