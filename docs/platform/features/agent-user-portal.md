...
This document describes the agent user portal feature within the OpenSIN-AI platform.

## Feature Description

Agent User Portal provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-user-portal | GET | List all items |
| /api/v1/agent-user-portal/id | GET | Get item by ID |
| /api/v1/agent-user-portal | POST | Create new item |
| /api/v1/agent-user-portal/id | PUT | Update item |
| /api/v1/agent-user-portal/id | DELETE | Delete item |
