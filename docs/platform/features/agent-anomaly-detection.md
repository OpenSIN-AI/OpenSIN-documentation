...
This document describes the agent anomaly detection feature within the OpenSIN-AI platform.

## Feature Description

Agent Anomaly Detection provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-anomaly-detection | GET | List all items |
| /api/v1/agent-anomaly-detection/id | GET | Get item by ID |
| /api/v1/agent-anomaly-detection | POST | Create new item |
| /api/v1/agent-anomaly-detection/id | PUT | Update item |
| /api/v1/agent-anomaly-detection/id | DELETE | Delete item |
