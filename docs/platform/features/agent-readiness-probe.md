...
This document describes the agent readiness probe feature within the OpenSIN-AI platform.

## Feature Description

Agent Readiness Probe provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-readiness-probe | GET | List all items |
| /api/v1/agent-readiness-probe/id | GET | Get item by ID |
| /api/v1/agent-readiness-probe | POST | Create new item |
| /api/v1/agent-readiness-probe/id | PUT | Update item |
| /api/v1/agent-readiness-probe/id | DELETE | Delete item |
