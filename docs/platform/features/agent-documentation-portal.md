# Agent Documentation Portal

> **Category:** Platform Feature | **Version:** 1.0 | **Status:** Active

## Overview

This document describes the agent documentation portal feature within the OpenSIN-AI platform.

## Feature Description

Agent Documentation Portal provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-documentation-portal | GET | List all items |
| /api/v1/agent-documentation-portal/id | GET | Get item by ID |
| /api/v1/agent-documentation-portal | POST | Create new item |
| /api/v1/agent-documentation-portal/id | PUT | Update item |
| /api/v1/agent-documentation-portal/id | DELETE | Delete item |
