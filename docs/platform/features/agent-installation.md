...
This document describes the agent installation feature within the OpenSIN-AI platform.

## Feature Description

Agent Installation provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-installation | GET | List all items |
| /api/v1/agent-installation/id | GET | Get item by ID |
| /api/v1/agent-installation | POST | Create new item |
| /api/v1/agent-installation/id | PUT | Update item |
| /api/v1/agent-installation/id | DELETE | Delete item |
