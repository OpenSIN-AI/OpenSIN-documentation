...
This document describes the agent performance test feature within the OpenSIN-AI platform.

## Feature Description

Agent Performance Test provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-performance-test | GET | List all items |
| /api/v1/agent-performance-test/id | GET | Get item by ID |
| /api/v1/agent-performance-test | POST | Create new item |
| /api/v1/agent-performance-test/id | PUT | Update item |
| /api/v1/agent-performance-test/id | DELETE | Delete item |
