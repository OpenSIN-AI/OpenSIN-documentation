...
This document describes the agent startup probe feature within the OpenSIN-AI platform.

## Feature Description

Agent Startup Probe provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-startup-probe | GET | List all items |
| /api/v1/agent-startup-probe/id | GET | Get item by ID |
| /api/v1/agent-startup-probe | POST | Create new item |
| /api/v1/agent-startup-probe/id | PUT | Update item |
| /api/v1/agent-startup-probe/id | DELETE | Delete item |
