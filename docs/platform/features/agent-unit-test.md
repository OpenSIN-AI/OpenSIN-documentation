...
This document describes the agent unit test feature within the OpenSIN-AI platform.

## Feature Description

Agent Unit Test provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-unit-test | GET | List all items |
| /api/v1/agent-unit-test/id | GET | Get item by ID |
| /api/v1/agent-unit-test | POST | Create new item |
| /api/v1/agent-unit-test/id | PUT | Update item |
| /api/v1/agent-unit-test/id | DELETE | Delete item |
