...
This document describes the agent security scan feature within the OpenSIN-AI platform.

## Feature Description

Agent Security Scan provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-security-scan | GET | List all items |
| /api/v1/agent-security-scan/id | GET | Get item by ID |
| /api/v1/agent-security-scan | POST | Create new item |
| /api/v1/agent-security-scan/id | PUT | Update item |
| /api/v1/agent-security-scan/id | DELETE | Delete item |
