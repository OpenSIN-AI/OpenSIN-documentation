...
This document describes the agent versioning feature within the OpenSIN-AI platform.

## Feature Description

Agent Versioning provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-versioning | GET | List all items |
| /api/v1/agent-versioning/id | GET | Get item by ID |
| /api/v1/agent-versioning | POST | Create new item |
| /api/v1/agent-versioning/id | PUT | Update item |
| /api/v1/agent-versioning/id | DELETE | Delete item |
