...
This document describes the agent deactivation feature within the OpenSIN-AI platform.

## Feature Description

Agent Deactivation provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-deactivation | GET | List all items |
| /api/v1/agent-deactivation/id | GET | Get item by ID |
| /api/v1/agent-deactivation | POST | Create new item |
| /api/v1/agent-deactivation/id | PUT | Update item |
| /api/v1/agent-deactivation/id | DELETE | Delete item |
