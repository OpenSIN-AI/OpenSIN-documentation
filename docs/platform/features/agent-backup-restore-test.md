# Agent Backup Restore Test

> **Category:** Platform Feature | **Version:** 1.0 | **Status:** Active

## Overview

This document describes the agent backup restore test feature within the OpenSIN-AI platform.

## Feature Description

Agent Backup Restore Test provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-backup-restore-test | GET | List all items |
| /api/v1/agent-backup-restore-test/id | GET | Get item by ID |
| /api/v1/agent-backup-restore-test | POST | Create new item |
| /api/v1/agent-backup-restore-test/id | PUT | Update item |
| /api/v1/agent-backup-restore-test/id | DELETE | Delete item |
