# Agent Vertical Scaling

> **Category:** Platform Feature | **Version:** 1.0 | **Status:** Active

## Overview

This document describes the agent vertical scaling feature within the OpenSIN-AI platform.

## Feature Description

Agent Vertical Scaling provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-vertical-scaling | GET | List all items |
| /api/v1/agent-vertical-scaling/id | GET | Get item by ID |
| /api/v1/agent-vertical-scaling | POST | Create new item |
| /api/v1/agent-vertical-scaling/id | PUT | Update item |
| /api/v1/agent-vertical-scaling/id | DELETE | Delete item |
