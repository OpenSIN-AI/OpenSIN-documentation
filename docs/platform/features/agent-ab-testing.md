...
This document describes the agent ab testing feature within the OpenSIN-AI platform.

## Feature Description

Agent Ab Testing provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-ab-testing | GET | List all items |
| /api/v1/agent-ab-testing/id | GET | Get item by ID |
| /api/v1/agent-ab-testing | POST | Create new item |
| /api/v1/agent-ab-testing/id | PUT | Update item |
| /api/v1/agent-ab-testing/id | DELETE | Delete item |
