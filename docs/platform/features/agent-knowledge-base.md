...
This document describes the agent knowledge base feature within the OpenSIN-AI platform.

## Feature Description

Agent Knowledge Base provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-knowledge-base | GET | List all items |
| /api/v1/agent-knowledge-base/id | GET | Get item by ID |
| /api/v1/agent-knowledge-base | POST | Create new item |
| /api/v1/agent-knowledge-base/id | PUT | Update item |
| /api/v1/agent-knowledge-base/id | DELETE | Delete item |
