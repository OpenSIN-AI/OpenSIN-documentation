...
This document describes the agent ui feature within the OpenSIN-AI platform.

## Feature Description

Agent Ui provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-ui | GET | List all items |
| /api/v1/agent-ui/id | GET | Get item by ID |
| /api/v1/agent-ui | POST | Create new item |
| /api/v1/agent-ui/id | PUT | Update item |
| /api/v1/agent-ui/id | DELETE | Delete item |
