# Agent Alerting Rules

> **Category:** Platform Feature | **Version:** 1.0 | **Status:** Active

## Overview

This document describes the agent alerting rules feature within the OpenSIN-AI platform.

## Feature Description

Agent Alerting Rules provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-alerting-rules | GET | List all items |
| /api/v1/agent-alerting-rules/id | GET | Get item by ID |
| /api/v1/agent-alerting-rules | POST | Create new item |
| /api/v1/agent-alerting-rules/id | PUT | Update item |
| /api/v1/agent-alerting-rules/id | DELETE | Delete item |
