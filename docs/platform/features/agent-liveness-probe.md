...
This document describes the agent liveness probe feature within the OpenSIN-AI platform.

## Feature Description

Agent Liveness Probe provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-liveness-probe | GET | List all items |
| /api/v1/agent-liveness-probe/id | GET | Get item by ID |
| /api/v1/agent-liveness-probe | POST | Create new item |
| /api/v1/agent-liveness-probe/id | PUT | Update item |
| /api/v1/agent-liveness-probe/id | DELETE | Delete item |
