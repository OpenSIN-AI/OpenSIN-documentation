...
This document describes the agent chaos test feature within the OpenSIN-AI platform.

## Feature Description

Agent Chaos Test provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-chaos-test | GET | List all items |
| /api/v1/agent-chaos-test/id | GET | Get item by ID |
| /api/v1/agent-chaos-test | POST | Create new item |
| /api/v1/agent-chaos-test/id | PUT | Update item |
| /api/v1/agent-chaos-test/id | DELETE | Delete item |
