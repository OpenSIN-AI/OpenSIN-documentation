...
This document describes the agent health check feature within the OpenSIN-AI platform.

## Feature Description

Agent Health Check provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-health-check | GET | List all items |
| /api/v1/agent-health-check/id | GET | Get item by ID |
| /api/v1/agent-health-check | POST | Create new item |
| /api/v1/agent-health-check/id | PUT | Update item |
| /api/v1/agent-health-check/id | DELETE | Delete item |
