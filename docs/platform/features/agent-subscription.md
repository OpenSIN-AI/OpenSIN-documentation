...
This document describes the agent subscription feature within the OpenSIN-AI platform.

## Feature Description

Agent Subscription provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-subscription | GET | List all items |
| /api/v1/agent-subscription/id | GET | Get item by ID |
| /api/v1/agent-subscription | POST | Create new item |
| /api/v1/agent-subscription/id | PUT | Update item |
| /api/v1/agent-subscription/id | DELETE | Delete item |
