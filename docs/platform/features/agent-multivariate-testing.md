# Agent Multivariate Testing

> **Category:** Platform Feature | **Version:** 1.0 | **Status:** Active

## Overview

This document describes the agent multivariate testing feature within the OpenSIN-AI platform.

## Feature Description

Agent Multivariate Testing provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-multivariate-testing | GET | List all items |
| /api/v1/agent-multivariate-testing/id | GET | Get item by ID |
| /api/v1/agent-multivariate-testing | POST | Create new item |
| /api/v1/agent-multivariate-testing/id | PUT | Update item |
| /api/v1/agent-multivariate-testing/id | DELETE | Delete item |
