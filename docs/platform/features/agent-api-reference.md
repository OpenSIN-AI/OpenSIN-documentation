...
This document describes the agent api reference feature within the OpenSIN-AI platform.

## Feature Description

Agent Api Reference provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-api-reference | GET | List all items |
| /api/v1/agent-api-reference/id | GET | Get item by ID |
| /api/v1/agent-api-reference | POST | Create new item |
| /api/v1/agent-api-reference/id | PUT | Update item |
| /api/v1/agent-api-reference/id | DELETE | Delete item |
