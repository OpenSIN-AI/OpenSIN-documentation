...
This document describes the agent edge computing feature within the OpenSIN-AI platform.

## Feature Description

Agent Edge Computing provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-edge-computing | GET | List all items |
| /api/v1/agent-edge-computing/id | GET | Get item by ID |
| /api/v1/agent-edge-computing | POST | Create new item |
| /api/v1/agent-edge-computing/id | PUT | Update item |
| /api/v1/agent-edge-computing/id | DELETE | Delete item |
