...
This document describes the agent sdk feature within the OpenSIN-AI platform.

## Feature Description

Agent Sdk provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-sdk | GET | List all items |
| /api/v1/agent-sdk/id | GET | Get item by ID |
| /api/v1/agent-sdk | POST | Create new item |
| /api/v1/agent-sdk/id | PUT | Update item |
| /api/v1/agent-sdk/id | DELETE | Delete item |
