...
This document describes the agent deletion feature within the OpenSIN-AI platform.

## Feature Description

Agent Deletion provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-deletion | GET | List all items |
| /api/v1/agent-deletion/id | GET | Get item by ID |
| /api/v1/agent-deletion | POST | Create new item |
| /api/v1/agent-deletion/id | PUT | Update item |
| /api/v1/agent-deletion/id | DELETE | Delete item |
