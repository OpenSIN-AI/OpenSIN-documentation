...
This document describes the agent service mesh feature within the OpenSIN-AI platform.

## Feature Description

Agent Service Mesh provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-service-mesh | GET | List all items |
| /api/v1/agent-service-mesh/id | GET | Get item by ID |
| /api/v1/agent-service-mesh | POST | Create new item |
| /api/v1/agent-service-mesh/id | PUT | Update item |
| /api/v1/agent-service-mesh/id | DELETE | Delete item |
