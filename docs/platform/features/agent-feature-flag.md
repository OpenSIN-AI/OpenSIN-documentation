...
This document describes the agent feature flag feature within the OpenSIN-AI platform.

## Feature Description

Agent Feature Flag provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-feature-flag | GET | List all items |
| /api/v1/agent-feature-flag/id | GET | Get item by ID |
| /api/v1/agent-feature-flag | POST | Create new item |
| /api/v1/agent-feature-flag/id | PUT | Update item |
| /api/v1/agent-feature-flag/id | DELETE | Delete item |
