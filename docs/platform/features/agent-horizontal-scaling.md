...
This document describes the agent horizontal scaling feature within the OpenSIN-AI platform.

## Feature Description

Agent Horizontal Scaling provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-horizontal-scaling | GET | List all items |
| /api/v1/agent-horizontal-scaling/id | GET | Get item by ID |
| /api/v1/agent-horizontal-scaling | POST | Create new item |
| /api/v1/agent-horizontal-scaling/id | PUT | Update item |
| /api/v1/agent-horizontal-scaling/id | DELETE | Delete item |
