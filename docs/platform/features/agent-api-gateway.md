...
This document describes the agent api gateway feature within the OpenSIN-AI platform.

## Feature Description

Agent Api Gateway provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-api-gateway | GET | List all items |
| /api/v1/agent-api-gateway/id | GET | Get item by ID |
| /api/v1/agent-api-gateway | POST | Create new item |
| /api/v1/agent-api-gateway/id | PUT | Update item |
| /api/v1/agent-api-gateway/id | DELETE | Delete item |
