...
This document describes the agent cli feature within the OpenSIN-AI platform.

## Feature Description

Agent Cli provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-cli | GET | List all items |
| /api/v1/agent-cli/id | GET | Get item by ID |
| /api/v1/agent-cli | POST | Create new item |
| /api/v1/agent-cli/id | PUT | Update item |
| /api/v1/agent-cli/id | DELETE | Delete item |
