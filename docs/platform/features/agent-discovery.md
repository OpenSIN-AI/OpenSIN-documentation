...
This document describes the agent discovery feature within the OpenSIN-AI platform.

## Feature Description

Agent Discovery provides capabilities for managing and operating A2A agents within the OpenSIN-AI ecosystem.
...
|----------|--------|-------------|
| /api/v1/agent-discovery | GET | List all items |
| /api/v1/agent-discovery/id | GET | Get item by ID |
| /api/v1/agent-discovery | POST | Create new item |
| /api/v1/agent-discovery/id | PUT | Update item |
| /api/v1/agent-discovery/id | DELETE | Delete item |
