      ...
      '/guide/': [
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Production Deployment', link: '/guide/deployment-production' },
            { text: 'Monitoring', link: '/guide/monitoring' },
            { text: 'Scaling', link: '/guide/scaling' },
            { text: 'Troubleshooting', link: '/guide/troubleshooting' },
            { text: 'Migration Guide', link: '/guide/migration' },
            { text: 'Migration from Other Systems', link: '/guide/migration-from-other-systems' },
            { text: 'Changelog', link: '/guide/changelog' },
          ],
        },
        {
          text: 'SIN Features (Claude Code Equivalents)',
          items: [
            { text: 'SIN.md System', link: '/guide/sin-md-system' },
            { text: 'SIN Hooks', link: '/guide/sin-hooks' },
            { text: 'SIN Plugins', link: '/guide/sin-plugins' },
            { text: 'SIN Commands', link: '/guide/sin-commands' },
            { text: 'SIN Skills', link: '/guide/sin-skills' },
            { text: 'SIN Permissions', link: '/guide/sin-permissions' },
            { text: 'SIN Subagents', link: '/guide/sin-subagents' },
            { text: 'SIN Context Compaction', link: '/guide/sin-context-compaction' },
            { text: 'SIN Cost Tracking', link: '/guide/sin-cost-tracking' },
            { text: 'SIN Feature Dev Workflow', link: '/guide/sin-feature-dev' },
            { text: 'SIN Code Review', link: '/guide/sin-code-review' },
            { text: 'SIN Loop', link: '/guide/sin-loop' },
            { text: 'SIN Enterprise Settings', link: '/guide/sin-enterprise-settings' },
          ],
        },
        {
          text: 'SIN Features (Claude Code Equivalents)',
        ...
        },
        {
          ...
          items: [
            ...
            { text: 'Webhooks & Events', link: '/guide/webhooks-events' },
            { text: 'n8n Workflows', link: '/guide/n8n-workflows' },
            { text: 'Testing Guide', link: '/guide/testing-guide' },
            { text: 'Agent Marketplace', link: '/guide/agent-marketplace' },
          ],
        },
        {
          text: 'Reference',
          items: [
            ...
            { text: 'SDK Overview', link: '/api/sdk-overview' },
