# Incidents List API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Incidents | **Action:** List | **Version:** v1
...
Detailed reference for the incidents list endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/incidents/list \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/incidents/list",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/incidents/list", nil)
...
curl -X GET http://localhost:3000/api/v1/incidents/list

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/incidents/list
```
