# Skills Update API Endpoint — Detailed Reference

> **Method:** PUT | **Resource:** Skills | **Action:** Update | **Version:** v1
...
Detailed reference for the skills update endpoint.
...
```bash
curl -X PUT https://api.opensin.ai/api/v1/skills/update \
...
response = requests.put(
    "https://api.opensin.ai/api/v1/skills/update",
    headers={
...
```go
req, _ := http.NewRequest("PUT", "https://api.opensin.ai/api/v1/skills/update", nil)
...
curl -X PUT http://localhost:3000/api/v1/skills/update

# Test with staging
curl -X PUT https://staging-api.opensin.ai/api/v1/skills/update
```
