# Notifications Patch — API Reference

> **Endpoint:** `PATCH /api/v1/notifications`/{id} | **Method:** PATCH | **Version:** 1.0

## Overview

Detailed API reference for the notifications patch endpoint.
...
```bash
curl -X PATCH https://api.opensin.ai/api/v1/notifications/{id} \
...
response = requests.patch(
    "https://api.opensin.ai/api/v1/notifications/{id}",
    headers={
...
curl -X PATCH http://localhost:3000/api/v1/notifications/{id}

# Test with staging
curl -X PATCH https://staging-api.opensin.ai/api/v1/notifications/{id}
```

## Related Endpoints

- [Notifications List](./notifications-list.md)
- [Notifications Health](./notifications-health.md)
- [Notifications Metrics](./notifications-metrics.md)
