# Repos Metrics — API Reference

> **Endpoint:** `GET /api/v1/repos` | **Method:** GET | **Version:** 1.0

## Overview

Detailed API reference for the repos metrics endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/repos \
...
curl -X GET http://localhost:3000/api/v1/repos

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/repos
```
