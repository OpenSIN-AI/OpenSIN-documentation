# Workflows Delete — API Reference

> **Endpoint:** `DELETE /api/v1/workflows`/{id} | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the workflows delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/workflows/{id} \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/workflows/{id}",
    headers={
...
curl -X DELETE http://localhost:3000/api/v1/workflows/{id}

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/workflows/{id}
```

## Related Endpoints

- [Workflows List](./workflows-list.md)
- [Workflows Health](./workflows-health.md)
- [Workflows Metrics](./workflows-metrics.md)
