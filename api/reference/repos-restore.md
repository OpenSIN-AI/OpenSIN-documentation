# Repos Restore — API Reference

> **Endpoint:** `POST /api/v1/repos`/{id} | **Method:** POST | **Version:** 1.0

## Overview

Detailed API reference for the repos restore endpoint.
...
```bash
curl -X POST https://api.opensin.ai/api/v1/repos/{id} \
...
response = requests.post(
    "https://api.opensin.ai/api/v1/repos/{id}",
    headers={
...
curl -X POST http://localhost:3000/api/v1/repos/{id}

# Test with staging
curl -X POST https://staging-api.opensin.ai/api/v1/repos/{id}
```

## Related Endpoints

- [Repos List](./repos-list.md)
- [Repos Health](./repos-health.md)
- [Repos Metrics](./repos-metrics.md)
