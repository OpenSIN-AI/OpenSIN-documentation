# Repos Get — API Reference

> **Endpoint:** `GET /api/v1/repos`/{id} | **Method:** GET | **Version:** 1.0

## Overview

Detailed API reference for the repos get endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/repos/{id} \
...
curl -X GET http://localhost:3000/api/v1/repos/{id}

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/repos/{id}
```
