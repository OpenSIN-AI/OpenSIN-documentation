# Skills Restore — API Reference

> **Endpoint:** `POST /api/v1/skills`/{id} | **Method:** POST | **Version:** 1.0

## Overview

Detailed API reference for the skills restore endpoint.
...
```bash
curl -X POST https://api.opensin.ai/api/v1/skills/{id} \
...
response = requests.post(
    "https://api.opensin.ai/api/v1/skills/{id}",
    headers={
...
curl -X POST http://localhost:3000/api/v1/skills/{id}

# Test with staging
curl -X POST https://staging-api.opensin.ai/api/v1/skills/{id}
```
...
- [Skills Metrics](./skills-metrics.md)
