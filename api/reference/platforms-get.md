# Platforms Get — API Reference

> **Endpoint:** `GET /api/v1/platforms`/{id} | **Method:** GET | **Version:** 1.0

## Overview

Detailed API reference for the platforms get endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/platforms/{id} \
...
# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/platforms/{id}
```
