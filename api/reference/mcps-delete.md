# Mcps Delete — API Reference

> **Endpoint:** `DELETE /api/v1/mcps`/{id} | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the mcps delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/mcps/{id} \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/mcps/{id}",
    headers={
...
curl -X DELETE http://localhost:3000/api/v1/mcps/{id}

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/mcps/{id}
```

## Related Endpoints

- [Mcps List](./mcps-list.md)
- [Mcps Health](./mcps-health.md)
- [Mcps Metrics](./mcps-metrics.md)
