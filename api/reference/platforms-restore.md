# Platforms Restore — API Reference

> **Endpoint:** `POST /api/v1/platforms`/{id} | **Method:** POST | **Version:** 1.0

## Overview

Detailed API reference for the platforms restore endpoint.
...
```bash
curl -X POST https://api.opensin.ai/api/v1/platforms/{id} \
...
response = requests.post(
    "https://api.opensin.ai/api/v1/platforms/{id}",
    headers={
...
curl -X POST http://localhost:3000/api/v1/platforms/{id}

# Test with staging
curl -X POST https://staging-api.opensin.ai/api/v1/platforms/{id}
```

## Related Endpoints

- [Platforms List](./platforms-list.md)
- [Platforms Health](./platforms-health.md)
- [Platforms Metrics](./platforms-metrics.md)
