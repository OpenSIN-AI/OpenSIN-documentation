# Skills Delete — API Reference

> **Endpoint:** `DELETE /api/v1/skills`/{id} | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the skills delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/skills/{id} \
...
curl -X DELETE http://localhost:3000/api/v1/skills/{id}

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/skills/{id}
```
