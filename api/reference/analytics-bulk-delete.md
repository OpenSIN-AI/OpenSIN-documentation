# Analytics Bulk Delete — API Reference

> **Endpoint:** `DELETE /api/v1/analytics` | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the analytics bulk delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/analytics \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/analytics",
    headers={
...
curl -X DELETE http://localhost:3000/api/v1/analytics

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/analytics
```
