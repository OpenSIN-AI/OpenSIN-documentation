# Notifications Bulk Delete — API Reference

> **Endpoint:** `DELETE /api/v1/notifications` | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the notifications bulk delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/notifications \
...
# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/notifications
```
