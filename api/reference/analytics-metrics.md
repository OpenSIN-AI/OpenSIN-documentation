# Analytics Metrics — API Reference

> **Endpoint:** `GET /api/v1/analytics` | **Method:** GET | **Version:** 1.0

## Overview

Detailed API reference for the analytics metrics endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/analytics \
...
# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/analytics
```
