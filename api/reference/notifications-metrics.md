# Notifications Metrics — API Reference

> **Endpoint:** `GET /api/v1/notifications` | **Method:** GET | **Version:** 1.0

## Overview

Detailed API reference for the notifications metrics endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/notifications \
...
# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/notifications
```
