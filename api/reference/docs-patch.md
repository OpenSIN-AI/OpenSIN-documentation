# Docs Patch — API Reference

> **Endpoint:** `PATCH /api/v1/docs`/{id} | **Method:** PATCH | **Version:** 1.0

## Overview

Detailed API reference for the docs patch endpoint.
...
```bash
curl -X PATCH https://api.opensin.ai/api/v1/docs/{id} \
...
response = requests.patch(
    "https://api.opensin.ai/api/v1/docs/{id}",
    headers={
...
curl -X PATCH http://localhost:3000/api/v1/docs/{id}

# Test with staging
curl -X PATCH https://staging-api.opensin.ai/api/v1/docs/{id}
```
