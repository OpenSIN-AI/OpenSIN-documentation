# Teams Bulk Update — API Reference

> **Endpoint:** `PUT /api/v1/teams` | **Method:** PUT | **Version:** 1.0

## Overview

Detailed API reference for the teams bulk update endpoint.
...
```bash
curl -X PUT https://api.opensin.ai/api/v1/teams \
...
curl -X PUT http://localhost:3000/api/v1/teams

# Test with staging
curl -X PUT https://staging-api.opensin.ai/api/v1/teams
```
