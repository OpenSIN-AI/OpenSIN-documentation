# Repos Bulk Delete — API Reference

> **Endpoint:** `DELETE /api/v1/repos` | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the repos bulk delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/repos \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/repos",
    headers={
...
curl -X DELETE http://localhost:3000/api/v1/repos

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/repos
```
