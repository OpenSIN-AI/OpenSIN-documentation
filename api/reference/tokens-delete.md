# Tokens Delete — API Reference

> **Endpoint:** `DELETE /api/v1/tokens`/{id} | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the tokens delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/tokens/{id} \
...
curl -X DELETE http://localhost:3000/api/v1/tokens/{id}

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/tokens/{id}
```
