# Auth Get — API Reference

> **Endpoint:** `GET /api/v1/auth`/{id} | **Method:** GET | **Version:** 1.0

## Overview

Detailed API reference for the auth get endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/auth/{id} \
...
curl -X GET http://localhost:3000/api/v1/auth/{id}

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/auth/{id}
```
