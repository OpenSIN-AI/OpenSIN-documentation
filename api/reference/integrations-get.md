# Integrations Get — API Reference

> **Endpoint:** `GET /api/v1/integrations`/{id} | **Method:** GET | **Version:** 1.0

## Overview

Detailed API reference for the integrations get endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/integrations/{id} \
...
# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/integrations/{id}
```
