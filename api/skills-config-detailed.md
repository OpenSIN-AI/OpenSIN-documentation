# Skills Config API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Skills | **Action:** Config | **Version:** v1
...
Detailed reference for the skills config endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/skills/config \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/skills/config",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/skills/config", nil)
...
curl -X GET http://localhost:3000/api/v1/skills/config

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/skills/config
```
