# Auth Patch — API Reference

> **Endpoint:** `PATCH /api/v1/auth`/{id} | **Method:** PATCH | **Version:** 1.0

## Overview

Detailed API reference for the auth patch endpoint.
...
```bash
curl -X PATCH https://api.opensin.ai/api/v1/auth/{id} \
...
curl -X PATCH http://localhost:3000/api/v1/auth/{id}

# Test with staging
curl -X PATCH https://staging-api.opensin.ai/api/v1/auth/{id}
```
