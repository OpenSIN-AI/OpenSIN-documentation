# Auth Get API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Auth | **Action:** Get | **Version:** v1
...
Detailed reference for the auth get endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/auth/get \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/auth/get",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/auth/get", nil)
...
curl -X GET http://localhost:3000/api/v1/auth/get

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/auth/get
```
