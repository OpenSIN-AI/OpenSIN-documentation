# Mcps Metrics API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Mcps | **Action:** Metrics | **Version:** v1

## Endpoint

```
GET /api/v1/mcps/metrics
```

## Description

Detailed reference for the mcps metrics endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/mcps/metrics \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/mcps/metrics",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/mcps/metrics", nil)
...
curl -X GET http://localhost:3000/api/v1/mcps/metrics

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/mcps/metrics
```
