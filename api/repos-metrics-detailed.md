# Repos Metrics API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Repos | **Action:** Metrics | **Version:** v1

## Endpoint

```
GET /api/v1/repos/metrics
```

## Description

Detailed reference for the repos metrics endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/repos/metrics \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/repos/metrics",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/repos/metrics", nil)
...
curl -X GET http://localhost:3000/api/v1/repos/metrics

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/repos/metrics
```

## Related Endpoints

- [Repos List](./repos-list-detailed.md)
- [Repos Health](./repos-health-detailed.md)
