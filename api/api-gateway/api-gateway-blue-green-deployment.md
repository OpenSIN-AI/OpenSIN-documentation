...
This document covers api gateway blue green deployment for the OpenSIN-AI API Gateway.

## Configuration

```yaml
api_gateway:
  api_gateway_blue_green_deployment:
    enabled: true
    settings:
      timeout: 30s
      retries: 3
...
### Step 1: Setup
Configure the api gateway blue green deployment in the API Gateway.
