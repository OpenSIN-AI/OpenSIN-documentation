...
This document covers api gateway graphql support for the OpenSIN-AI API Gateway.

## Configuration

```yaml
api_gateway:
  api_gateway_graphql_support:
    enabled: true
    settings:
      timeout: 30s
      retries: 3
...
### Step 1: Setup
Configure the api gateway graphql support in the API Gateway.
