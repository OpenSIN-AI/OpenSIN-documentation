...
This document covers api gateway compliance for the OpenSIN-AI API Gateway.

## Configuration

```yaml
api_gateway:
  api_gateway_compliance:
    enabled: true
    settings:
      timeout: 30s
      retries: 3
...
### Step 1: Setup
Configure the api gateway compliance in the API Gateway.
