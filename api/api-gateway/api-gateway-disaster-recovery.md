...
This document covers api gateway disaster recovery for the OpenSIN-AI API Gateway.

## Configuration

```yaml
api_gateway:
  api_gateway_disaster_recovery:
    enabled: true
    settings:
      timeout: 30s
      retries: 3
...
### Step 1: Setup
Configure the api gateway disaster recovery in the API Gateway.
