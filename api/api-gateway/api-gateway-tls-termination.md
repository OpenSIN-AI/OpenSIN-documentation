...
This document covers api gateway tls termination for the OpenSIN-AI API Gateway.

## Configuration

```yaml
api_gateway:
  api_gateway_tls_termination:
    enabled: true
    settings:
      timeout: 30s
      retries: 3
...
### Step 1: Setup
Configure the api gateway tls termination in the API Gateway.
