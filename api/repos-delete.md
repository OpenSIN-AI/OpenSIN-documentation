# Repos Delete — API Reference

> **Endpoint:** `DELETE /api/v1/repos`/{id} | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the repos delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/repos/{id} \
...
curl -X DELETE http://localhost:3000/api/v1/repos/{id}

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/repos/{id}
```
