# Docs Delete — API Reference

> **Endpoint:** `DELETE /api/v1/docs`/{id} | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the docs delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/docs/{id} \
...
# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/docs/{id}
```
