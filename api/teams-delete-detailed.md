# Teams Delete API Endpoint — Detailed Reference

> **Method:** DELETE | **Resource:** Teams | **Action:** Delete | **Version:** v1

## Endpoint

```
DELETE /api/v1/teams/delete
```

## Description

Detailed reference for the teams delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/teams/delete \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/teams/delete",
    headers={
...
```go
req, _ := http.NewRequest("DELETE", "https://api.opensin.ai/api/v1/teams/delete", nil)
...
curl -X DELETE http://localhost:3000/api/v1/teams/delete

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/teams/delete
```

## Related Endpoints

- [Teams List](./teams-list-detailed.md)
- [Teams Health](./teams-health-detailed.md)
