# Agents Get API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Agents | **Action:** Get | **Version:** v1
...
Detailed reference for the agents get endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/agents/get \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/agents/get",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/agents/get", nil)
...
curl -X GET http://localhost:3000/api/v1/agents/get

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/agents/get
```
