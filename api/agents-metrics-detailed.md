# Agents Metrics API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Agents | **Action:** Metrics | **Version:** v1
...
Detailed reference for the agents metrics endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/agents/metrics \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/agents/metrics",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/agents/metrics", nil)
...
curl -X GET http://localhost:3000/api/v1/agents/metrics

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/agents/metrics
```
