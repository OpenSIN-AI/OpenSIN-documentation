# Notifications Bulk Update — API Reference

> **Endpoint:** `PUT /api/v1/notifications` | **Method:** PUT | **Version:** 1.0

## Overview

Detailed API reference for the notifications bulk update endpoint.
...
```bash
curl -X PUT https://api.opensin.ai/api/v1/notifications \
...
response = requests.put(
    "https://api.opensin.ai/api/v1/notifications",
    headers={
...
curl -X PUT http://localhost:3000/api/v1/notifications

# Test with staging
curl -X PUT https://staging-api.opensin.ai/api/v1/notifications
```
