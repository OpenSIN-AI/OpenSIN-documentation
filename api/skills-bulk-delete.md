# Skills Bulk Delete — API Reference

> **Endpoint:** `DELETE /api/v1/skills` | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the skills bulk delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/skills \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/skills",
    headers={
...
curl -X DELETE http://localhost:3000/api/v1/skills

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/skills
```
