# Auth Metrics API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Auth | **Action:** Metrics | **Version:** v1
...
Detailed reference for the auth metrics endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/auth/metrics \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/auth/metrics",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/auth/metrics", nil)
...
curl -X GET http://localhost:3000/api/v1/auth/metrics

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/auth/metrics
```
