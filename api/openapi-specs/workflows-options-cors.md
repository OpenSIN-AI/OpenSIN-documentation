# Workflows Options Cors — OpenAPI Specification

> **Endpoint:** /api/v1/workflows | **Method:** OPTIONS | **Version:** 1.0

## Overview

OpenAPI specification for the workflows options cors endpoint.
