# Repos Get API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Repos | **Action:** Get | **Version:** v1

## Endpoint

```
GET /api/v1/repos/get
```

## Description

Detailed reference for the repos get endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/repos/get \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/repos/get",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/repos/get", nil)
...
curl -X GET http://localhost:3000/api/v1/repos/get

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/repos/get
```
