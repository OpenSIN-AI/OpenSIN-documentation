# Tokens Get API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Tokens | **Action:** Get | **Version:** v1

## Endpoint

```
GET /api/v1/tokens/get
```

## Description

Detailed reference for the tokens get endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/tokens/get \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/tokens/get",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/tokens/get", nil)
...
curl -X GET http://localhost:3000/api/v1/tokens/get

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/tokens/get
```
