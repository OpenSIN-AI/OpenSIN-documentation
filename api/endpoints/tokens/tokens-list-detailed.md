# Tokens List API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Tokens | **Action:** List | **Version:** v1
...
Detailed reference for the tokens list endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/tokens/list \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/tokens/list",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/tokens/list", nil)
...
# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/tokens/list
```
