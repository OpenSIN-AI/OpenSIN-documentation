# Tokens Update API Endpoint — Detailed Reference

> **Method:** PUT | **Resource:** Tokens | **Action:** Update | **Version:** v1
...
Detailed reference for the tokens update endpoint.
...
```bash
curl -X PUT https://api.opensin.ai/api/v1/tokens/update \
...
response = requests.put(
    "https://api.opensin.ai/api/v1/tokens/update",
    headers={
...
```go
req, _ := http.NewRequest("PUT", "https://api.opensin.ai/api/v1/tokens/update", nil)
...
curl -X PUT http://localhost:3000/api/v1/tokens/update

# Test with staging
curl -X PUT https://staging-api.opensin.ai/api/v1/tokens/update
```
