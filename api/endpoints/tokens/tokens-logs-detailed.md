# Tokens Logs API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Tokens | **Action:** Logs | **Version:** v1

## Endpoint

```
GET /api/v1/tokens/logs
```

## Description

Detailed reference for the tokens logs endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/tokens/logs \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/tokens/logs",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/tokens/logs", nil)
...
curl -X GET http://localhost:3000/api/v1/tokens/logs

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/tokens/logs
```
