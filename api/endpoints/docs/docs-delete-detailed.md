# Docs Delete API Endpoint — Detailed Reference

> **Method:** DELETE | **Resource:** Docs | **Action:** Delete | **Version:** v1
...
Detailed reference for the docs delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/docs/delete \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/docs/delete",
    headers={
...
```go
req, _ := http.NewRequest("DELETE", "https://api.opensin.ai/api/v1/docs/delete", nil)
...
curl -X DELETE http://localhost:3000/api/v1/docs/delete

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/docs/delete
```
