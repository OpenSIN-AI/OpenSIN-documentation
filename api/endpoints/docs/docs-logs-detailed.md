# Docs Logs API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Docs | **Action:** Logs | **Version:** v1

## Endpoint

```
GET /api/v1/docs/logs
```

## Description

Detailed reference for the docs logs endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/docs/logs \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/docs/logs",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/docs/logs", nil)
...
curl -X GET http://localhost:3000/api/v1/docs/logs

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/docs/logs
```
