# Docs Create API Endpoint — Detailed Reference

> **Method:** POST | **Resource:** Docs | **Action:** Create | **Version:** v1
...
Detailed reference for the docs create endpoint.
...
```bash
curl -X POST https://api.opensin.ai/api/v1/docs/create \
...
response = requests.post(
    "https://api.opensin.ai/api/v1/docs/create",
    headers={
...
```go
req, _ := http.NewRequest("POST", "https://api.opensin.ai/api/v1/docs/create", nil)
...
curl -X POST http://localhost:3000/api/v1/docs/create

# Test with staging
curl -X POST https://staging-api.opensin.ai/api/v1/docs/create
```
