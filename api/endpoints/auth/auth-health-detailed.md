# Auth Health API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Auth | **Action:** Health | **Version:** v1
...
Detailed reference for the auth health endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/auth/health \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/auth/health",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/auth/health", nil)
...
# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/auth/health
```
