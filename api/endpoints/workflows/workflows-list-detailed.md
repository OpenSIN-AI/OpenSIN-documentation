# Workflows List API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Workflows | **Action:** List | **Version:** v1
...
Detailed reference for the workflows list endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/workflows/list \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/workflows/list",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/workflows/list", nil)
...
curl -X GET http://localhost:3000/api/v1/workflows/list

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/workflows/list
```
