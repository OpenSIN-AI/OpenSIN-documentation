# Workflows Delete API Endpoint — Detailed Reference

> **Method:** DELETE | **Resource:** Workflows | **Action:** Delete | **Version:** v1
...
Detailed reference for the workflows delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/workflows/delete \
...
response = requests.delete(
    "https://api.opensin.ai/api/v1/workflows/delete",
    headers={
...
```go
req, _ := http.NewRequest("DELETE", "https://api.opensin.ai/api/v1/workflows/delete", nil)
...
curl -X DELETE http://localhost:3000/api/v1/workflows/delete

# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/workflows/delete
```

## Related Endpoints

- [Workflows List](./workflows-list-detailed.md)
- [Workflows Health](./workflows-health-detailed.md)
