# Repos Config API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Repos | **Action:** Config | **Version:** v1

## Endpoint

```
GET /api/v1/repos/config
```

## Description

Detailed reference for the repos config endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/repos/config \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/repos/config",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/repos/config", nil)
...
curl -X GET http://localhost:3000/api/v1/repos/config

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/repos/config
```
