# Repos Update API Endpoint — Detailed Reference

> **Method:** PUT | **Resource:** Repos | **Action:** Update | **Version:** v1
...
Detailed reference for the repos update endpoint.
...
```bash
curl -X PUT https://api.opensin.ai/api/v1/repos/update \
...
response = requests.put(
    "https://api.opensin.ai/api/v1/repos/update",
    headers={
...
```go
req, _ := http.NewRequest("PUT", "https://api.opensin.ai/api/v1/repos/update", nil)
...
curl -X PUT http://localhost:3000/api/v1/repos/update

# Test with staging
curl -X PUT https://staging-api.opensin.ai/api/v1/repos/update
```
