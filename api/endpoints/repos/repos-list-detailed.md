# Repos List API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Repos | **Action:** List | **Version:** v1
...
Detailed reference for the repos list endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/repos/list \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/repos/list",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/repos/list", nil)
...
curl -X GET http://localhost:3000/api/v1/repos/list

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/repos/list
```
