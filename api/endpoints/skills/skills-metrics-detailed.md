# Skills Metrics API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Skills | **Action:** Metrics | **Version:** v1
...
Detailed reference for the skills metrics endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/skills/metrics \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/skills/metrics",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/skills/metrics", nil)
...
curl -X GET http://localhost:3000/api/v1/skills/metrics

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/skills/metrics
```
