# Skills Logs API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Skills | **Action:** Logs | **Version:** v1

## Endpoint

```
GET /api/v1/skills/logs
```

## Description

Detailed reference for the skills logs endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/skills/logs \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/skills/logs",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/skills/logs", nil)
...
curl -X GET http://localhost:3000/api/v1/skills/logs

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/skills/logs
```
