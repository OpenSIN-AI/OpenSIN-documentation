# Mcps Update API Endpoint — Detailed Reference

> **Method:** PUT | **Resource:** Mcps | **Action:** Update | **Version:** v1

## Endpoint

```
PUT /api/v1/mcps/update
```

## Description

Detailed reference for the mcps update endpoint.
...
```bash
curl -X PUT https://api.opensin.ai/api/v1/mcps/update \
...
response = requests.put(
    "https://api.opensin.ai/api/v1/mcps/update",
    headers={
...
```go
req, _ := http.NewRequest("PUT", "https://api.opensin.ai/api/v1/mcps/update", nil)
...
curl -X PUT http://localhost:3000/api/v1/mcps/update

# Test with staging
curl -X PUT https://staging-api.opensin.ai/api/v1/mcps/update
```
