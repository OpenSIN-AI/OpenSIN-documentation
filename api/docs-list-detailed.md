# Docs List API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Docs | **Action:** List | **Version:** v1
...
Detailed reference for the docs list endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/docs/list \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/docs/list",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/docs/list", nil)
...
curl -X GET http://localhost:3000/api/v1/docs/list

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/docs/list
```
