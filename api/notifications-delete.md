# Notifications Delete — API Reference

> **Endpoint:** `DELETE /api/v1/notifications`/{id} | **Method:** DELETE | **Version:** 1.0

## Overview

Detailed API reference for the notifications delete endpoint.
...
```bash
curl -X DELETE https://api.opensin.ai/api/v1/notifications/{id} \
...
# Test with staging
curl -X DELETE https://staging-api.opensin.ai/api/v1/notifications/{id}
```
