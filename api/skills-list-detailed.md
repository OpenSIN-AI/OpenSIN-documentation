# Skills List API Endpoint — Detailed Reference

> **Method:** GET | **Resource:** Skills | **Action:** List | **Version:** v1
...
Detailed reference for the skills list endpoint.
...
```bash
curl -X GET https://api.opensin.ai/api/v1/skills/list \
...
response = requests.get(
    "https://api.opensin.ai/api/v1/skills/list",
    headers={
...
```go
req, _ := http.NewRequest("GET", "https://api.opensin.ai/api/v1/skills/list", nil)
...
curl -X GET http://localhost:3000/api/v1/skills/list

# Test with staging
curl -X GET https://staging-api.opensin.ai/api/v1/skills/list
```
