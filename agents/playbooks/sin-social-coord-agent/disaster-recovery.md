# Sin Social Coord Agent — Disaster Recovery Playbook

> **Agent:** sin-social-coord-agent | **Playbook:** disaster-recovery | **Version:** 1.0 | **Status:** Active

## Purpose

This playbook provides standard operating procedures (SOPs) for disaster recovery playbook of the Sin Social Coord Agent.

## Scope

This playbook covers all aspects of disaster recovery for sin-social-coord-agent.
