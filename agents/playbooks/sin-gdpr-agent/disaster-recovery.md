# Sin Gdpr Agent — Disaster Recovery Playbook

> **Agent:** sin-gdpr-agent | **Playbook:** disaster-recovery | **Version:** 1.0 | **Status:** Active

## Purpose

This playbook provides standard operating procedures (SOPs) for disaster recovery playbook of the Sin Gdpr Agent.

## Scope

This playbook covers all aspects of disaster recovery for sin-gdpr-agent.
