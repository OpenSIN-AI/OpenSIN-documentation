# Sin Google Apps Coord Agent — Disaster Recovery Playbook

> **Agent:** sin-google-apps-coord-agent | **Playbook:** disaster-recovery | **Version:** 1.0 | **Status:** Active

## Purpose

This playbook provides standard operating procedures (SOPs) for disaster recovery playbook of the Sin Google Apps Coord Agent.

## Scope

This playbook covers all aspects of disaster recovery for sin-google-apps-coord-agent.
...
Execute the disaster recovery procedures:
