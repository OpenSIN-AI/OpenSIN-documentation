# Sin Audit Agent — Disaster Recovery Playbook

> **Agent:** sin-audit-agent | **Playbook:** disaster-recovery | **Version:** 1.0 | **Status:** Active

## Purpose

This playbook provides standard operating procedures (SOPs) for disaster recovery playbook of the Sin Audit Agent.

## Scope

This playbook covers all aspects of disaster recovery for sin-audit-agent.
