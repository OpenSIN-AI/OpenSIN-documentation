# Sin Google Apps Coord Agent — Deployment Guide

> **Agent:** sin-google-apps-coord-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Google Apps Coord Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-google-apps-coord-agent.git
cd sin-google-apps-coord-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-google-apps-coord-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-google-apps-coord-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-google-apps-coord-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-google-apps-coord-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-google-apps-coord-agent.md)
- [Integration Guide](../../integrations/agents/sin-google-apps-coord-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-google-apps-coord-agent.md)
