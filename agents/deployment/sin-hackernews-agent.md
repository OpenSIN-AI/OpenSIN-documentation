# Sin Hackernews Agent — Deployment Guide

> **Agent:** sin-hackernews-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Hackernews Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-hackernews-agent.git
cd sin-hackernews-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-hackernews-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-hackernews-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-hackernews-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-hackernews-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-hackernews-agent.md)
- [Integration Guide](../../integrations/agents/sin-hackernews-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-hackernews-agent.md)
