# Sin Ai Agent — Deployment Guide

> **Agent:** sin-ai-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Ai Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-ai-agent.git
cd sin-ai-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-ai-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-ai-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-ai-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-ai-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-ai-agent.md)
- [Integration Guide](../../integrations/agents/sin-ai-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-ai-agent.md)
