# Sin Logistic Agent — Deployment Guide

> **Agent:** sin-logistic-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Logistic Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-logistic-agent.git
cd sin-logistic-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-logistic-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-logistic-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-logistic-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-logistic-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-logistic-agent.md)
- [Integration Guide](../../integrations/agents/sin-logistic-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-logistic-agent.md)
