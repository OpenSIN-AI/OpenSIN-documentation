# Sin Stackoverflow Agent — Deployment Guide

> **Agent:** sin-stackoverflow-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Stackoverflow Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-stackoverflow-agent.git
cd sin-stackoverflow-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-stackoverflow-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-stackoverflow-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-stackoverflow-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-stackoverflow-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-stackoverflow-agent.md)
- [Integration Guide](../../integrations/agents/sin-stackoverflow-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-stackoverflow-agent.md)
