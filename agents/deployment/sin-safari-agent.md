# Sin Safari Agent — Deployment Guide

> **Agent:** sin-safari-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Safari Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-safari-agent.git
cd sin-safari-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-safari-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-safari-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-safari-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-safari-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-safari-agent.md)
- [Integration Guide](../../integrations/agents/sin-safari-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-safari-agent.md)
