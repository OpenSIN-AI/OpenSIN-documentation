# Sin Medium Agent — Deployment Guide

> **Agent:** sin-medium-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Medium Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-medium-agent.git
cd sin-medium-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-medium-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-medium-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-medium-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-medium-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-medium-agent.md)
- [Integration Guide](../../integrations/agents/sin-medium-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-medium-agent.md)
