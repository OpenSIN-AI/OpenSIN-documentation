# Sin Systemsettings Agent — Deployment Guide

> **Agent:** sin-systemsettings-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Systemsettings Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-systemsettings-agent.git
cd sin-systemsettings-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-systemsettings-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-systemsettings-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-systemsettings-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-systemsettings-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-systemsettings-agent.md)
- [Integration Guide](../../integrations/agents/sin-systemsettings-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-systemsettings-agent.md)
