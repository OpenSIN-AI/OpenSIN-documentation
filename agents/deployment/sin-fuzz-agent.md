# Sin Fuzz Agent — Deployment Guide

> **Agent:** sin-fuzz-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Fuzz Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-fuzz-agent.git
cd sin-fuzz-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-fuzz-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-fuzz-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-fuzz-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-fuzz-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-fuzz-agent.md)
- [Integration Guide](../../integrations/agents/sin-fuzz-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-fuzz-agent.md)
