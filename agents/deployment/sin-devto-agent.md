# Sin Devto Agent — Deployment Guide

> **Agent:** sin-devto-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Devto Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-devto-agent.git
cd sin-devto-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-devto-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-devto-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-devto-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-devto-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-devto-agent.md)
- [Integration Guide](../../integrations/agents/sin-devto-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-devto-agent.md)
