# Sin Mail Agent — Deployment Guide

> **Agent:** sin-mail-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Mail Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-mail-agent.git
cd sin-mail-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-mail-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-mail-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-mail-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-mail-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-mail-agent.md)
- [Integration Guide](../../integrations/agents/sin-mail-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-mail-agent.md)
