# Sin Docs Agent — Deployment Guide

> **Agent:** sin-docs-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Docs Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-docs-agent.git
cd sin-docs-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-docs-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-docs-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-docs-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-docs-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-docs-agent.md)
- [Integration Guide](../../integrations/agents/sin-docs-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-docs-agent.md)
