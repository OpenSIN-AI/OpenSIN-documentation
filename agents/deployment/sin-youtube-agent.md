# Sin Youtube Agent — Deployment Guide

> **Agent:** sin-youtube-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Youtube Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-youtube-agent.git
cd sin-youtube-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-youtube-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-youtube-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-youtube-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-youtube-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-youtube-agent.md)
- [Integration Guide](../../integrations/agents/sin-youtube-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-youtube-agent.md)
