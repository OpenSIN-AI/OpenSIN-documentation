# Sin Qa Agent — Deployment Guide

> **Agent:** sin-qa-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Qa Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-qa-agent.git
cd sin-qa-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-qa-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-qa-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-qa-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-qa-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-qa-agent.md)
- [Integration Guide](../../integrations/agents/sin-qa-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-qa-agent.md)
