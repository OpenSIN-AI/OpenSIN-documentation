# Sin Freelancer Agent — Deployment Guide

> **Agent:** sin-freelancer-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Freelancer Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-freelancer-agent.git
cd sin-freelancer-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-freelancer-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-freelancer-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-freelancer-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-freelancer-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-freelancer-agent.md)
- [Integration Guide](../../integrations/agents/sin-freelancer-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-freelancer-agent.md)
