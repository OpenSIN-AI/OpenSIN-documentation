# Sin Terms Agent — Deployment Guide

> **Agent:** sin-terms-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Terms Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-terms-agent.git
cd sin-terms-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-terms-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-terms-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-terms-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-terms-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-terms-agent.md)
- [Integration Guide](../../integrations/agents/sin-terms-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-terms-agent.md)
