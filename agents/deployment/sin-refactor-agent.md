# Sin Refactor Agent — Deployment Guide

> **Agent:** sin-refactor-agent | **Category:** A2A Agent Deployment | **Version:** 1.0 | **Status:** Active

## Overview

This guide provides step-by-step deployment instructions for the Sin Refactor Agent.
...
```bash
git clone git@github.com:OpenSIN-AI/sin-refactor-agent.git
cd sin-refactor-agent
```
...
curl -X POST http://92.5.60.87:8006/rest/v1/agent_registry \
  ...
  -d '{"name": "sin-refactor-agent", "status": "active", "model": "openrouter/qwen/qwen3.6-plus:free"}'
```
...
huggingface-cli repo create sin-refactor-agent --type space --space_sdk docker
git push https://huggingface.co/spaces/delqhi/sin-refactor-agent
```
...
curl http://92.5.60.87:8006/rest/v1/agent_registry?name=eq.sin-refactor-agent \
  -H "apikey: $SUPABASE_KEY"
```
...
- [Agent Reference Card](../reference-cards/sin-refactor-agent.md)
- [Integration Guide](../../integrations/agents/sin-refactor-agent.md)
- [Team Playbook](../team-playbooks/)
- [Agent Configuration](../fleet/configs/sin-refactor-agent.md)
