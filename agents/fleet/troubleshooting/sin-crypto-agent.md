...
> **Agent:** sin-crypto-agent | **Category:** Troubleshooting | **Status:** ✅ Active
...
1. Collect logs: `journalctl -u sin-crypto-agent --no-pager > /tmp/sin-crypto-agent-logs.txt`
2. Collect config: `cat /etc/opensin/sin-crypto-agent/config.yaml > /tmp/sin-crypto-agent-config.txt`
