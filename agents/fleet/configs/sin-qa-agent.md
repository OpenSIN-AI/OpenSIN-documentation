# Sin Qa Agent — Configuration Reference

> **Agent:** sin-qa-agent | **Team:** Qa | **Status:** ✅ Active
...
```json
{
  "name": "sin-qa-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin qa agent",
  "team": "qa",
...
|----------|----------|---------|-------------|
| `SIN_QA_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_QA_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_QA_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_QA_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_QA_AGENT_LOG_LEVEL` | No | info | Logging level |
