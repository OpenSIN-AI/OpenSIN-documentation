# Sin Datascience Agent — Configuration Reference

> **Agent:** sin-datascience-agent | **Team:** Datascience | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-datascience-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin datascience agent",
  "team": "datascience",
...
|----------|----------|---------|-------------|
| `SIN_DATASCIENCE_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_DATASCIENCE_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_DATASCIENCE_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_DATASCIENCE_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_DATASCIENCE_AGENT_LOG_LEVEL` | No | info | Logging level |
