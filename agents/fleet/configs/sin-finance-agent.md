# Sin Finance Agent — Configuration Reference

> **Agent:** sin-finance-agent | **Team:** Finance | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-finance-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin finance agent",
  "team": "finance",
...
|----------|----------|---------|-------------|
| `SIN_FINANCE_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_FINANCE_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_FINANCE_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_FINANCE_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_FINANCE_AGENT_LOG_LEVEL` | No | info | Logging level |
