# Sin Devto Agent — Configuration Reference

> **Agent:** sin-devto-agent | **Team:** Devto | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-devto-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin devto agent",
  "team": "devto",
...
|----------|----------|---------|-------------|
| `SIN_DEVTO_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_DEVTO_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_DEVTO_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_DEVTO_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_DEVTO_AGENT_LOG_LEVEL` | No | info | Logging level |
