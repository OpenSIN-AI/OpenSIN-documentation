# Sin Orchestrator Agent — Configuration Reference

> **Agent:** sin-orchestrator-agent | **Team:** Orchestrator | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-orchestrator-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin orchestrator agent",
  "team": "orchestrator",
...
|----------|----------|---------|-------------|
| `SIN_ORCHESTRATOR_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_ORCHESTRATOR_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_ORCHESTRATOR_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_ORCHESTRATOR_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_ORCHESTRATOR_AGENT_LOG_LEVEL` | No | info | Logging level |
