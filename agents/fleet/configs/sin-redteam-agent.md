# Sin Redteam Agent — Configuration Reference

> **Agent:** sin-redteam-agent | **Team:** Redteam | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-redteam-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin redteam agent",
  "team": "redteam",
...
|----------|----------|---------|-------------|
| `SIN_REDTEAM_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_REDTEAM_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_REDTEAM_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_REDTEAM_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_REDTEAM_AGENT_LOG_LEVEL` | No | info | Logging level |
