# Sin Pinterest Agent — Configuration Reference

> **Agent:** sin-pinterest-agent | **Team:** Pinterest | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-pinterest-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin pinterest agent",
  "team": "pinterest",
...
|----------|----------|---------|-------------|
| `SIN_PINTEREST_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_PINTEREST_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_PINTEREST_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_PINTEREST_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_PINTEREST_AGENT_LOG_LEVEL` | No | info | Logging level |
