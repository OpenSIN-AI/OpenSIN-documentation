# Sin Database Agent — Configuration Reference

> **Agent:** sin-database-agent | **Team:** Database | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-database-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin database agent",
  "team": "database",
...
|----------|----------|---------|-------------|
| `SIN_DATABASE_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_DATABASE_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_DATABASE_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_DATABASE_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_DATABASE_AGENT_LOG_LEVEL` | No | info | Logging level |
