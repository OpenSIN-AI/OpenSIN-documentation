# Sin Freelancer Agent — Configuration Reference

> **Agent:** sin-freelancer-agent | **Team:** Freelancer | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-freelancer-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin freelancer agent",
  "team": "freelancer",
...
|----------|----------|---------|-------------|
| `SIN_FREELANCER_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_FREELANCER_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_FREELANCER_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_FREELANCER_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_FREELANCER_AGENT_LOG_LEVEL` | No | info | Logging level |
