# Sin Contract Agent — Configuration Reference

> **Agent:** sin-contract-agent | **Team:** Contract | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-contract-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin contract agent",
  "team": "contract",
...
|----------|----------|---------|-------------|
| `SIN_CONTRACT_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_CONTRACT_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_CONTRACT_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_CONTRACT_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_CONTRACT_AGENT_LOG_LEVEL` | No | info | Logging level |
