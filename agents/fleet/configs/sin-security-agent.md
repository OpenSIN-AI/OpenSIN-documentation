# Sin Security Agent — Configuration Reference

> **Agent:** sin-security-agent | **Team:** Security | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-security-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin security agent",
  "team": "security",
...
|----------|----------|---------|-------------|
| `SIN_SECURITY_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_SECURITY_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_SECURITY_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_SECURITY_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_SECURITY_AGENT_LOG_LEVEL` | No | info | Logging level |
