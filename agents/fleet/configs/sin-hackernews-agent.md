# Sin Hackernews Agent — Configuration Reference

> **Agent:** sin-hackernews-agent | **Team:** Hackernews | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-hackernews-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin hackernews agent",
  "team": "hackernews",
...
|----------|----------|---------|-------------|
| `SIN_HACKERNEWS_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_HACKERNEWS_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_HACKERNEWS_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_HACKERNEWS_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_HACKERNEWS_AGENT_LOG_LEVEL` | No | info | Logging level |
