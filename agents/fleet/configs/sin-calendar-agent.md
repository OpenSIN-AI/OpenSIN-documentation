# Sin Calendar Agent — Configuration Reference
...
|----------|----------|---------|-------------|
| `SIN_CALENDAR_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_CALENDAR_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_CALENDAR_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_CALENDAR_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_CALENDAR_AGENT_LOG_LEVEL` | No | info | Logging level |
