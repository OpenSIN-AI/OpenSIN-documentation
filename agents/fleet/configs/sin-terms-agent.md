# Sin Terms Agent — Configuration Reference

> **Agent:** sin-terms-agent | **Team:** Terms | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-terms-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin terms agent",
  "team": "terms",
...
|----------|----------|---------|-------------|
| `SIN_TERMS_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_TERMS_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_TERMS_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_TERMS_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_TERMS_AGENT_LOG_LEVEL` | No | info | Logging level |
