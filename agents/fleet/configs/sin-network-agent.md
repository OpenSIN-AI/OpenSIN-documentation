# Sin Network Agent — Configuration Reference

> **Agent:** sin-network-agent | **Team:** Network | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-network-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin network agent",
  "team": "network",
...
|----------|----------|---------|-------------|
| `SIN_NETWORK_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_NETWORK_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_NETWORK_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_NETWORK_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_NETWORK_AGENT_LOG_LEVEL` | No | info | Logging level |
