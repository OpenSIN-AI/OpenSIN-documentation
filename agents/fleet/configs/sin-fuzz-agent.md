# Sin Fuzz Agent — Configuration Reference

> **Agent:** sin-fuzz-agent | **Team:** Fuzz | **Status:** ✅ Active
...
```json
{
  "name": "sin-fuzz-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin fuzz agent",
  "team": "fuzz",
...
|----------|----------|---------|-------------|
| `SIN_FUZZ_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_FUZZ_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_FUZZ_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_FUZZ_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_FUZZ_AGENT_LOG_LEVEL` | No | info | Logging level |
