# Sin Medium Agent — Configuration Reference

> **Agent:** sin-medium-agent | **Team:** Medium | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-medium-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin medium agent",
  "team": "medium",
...
|----------|----------|---------|-------------|
| `SIN_MEDIUM_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_MEDIUM_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_MEDIUM_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_MEDIUM_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_MEDIUM_AGENT_LOG_LEVEL` | No | info | Logging level |
