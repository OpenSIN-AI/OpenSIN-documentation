# Sin Auth Agent — Configuration Reference

> **Agent:** sin-auth-agent | **Team:** Auth | **Status:** ✅ Active
...
```json
{
  "name": "sin-auth-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin auth agent",
  "team": "auth",
...
|----------|----------|---------|-------------|
| `SIN_AUTH_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_AUTH_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_AUTH_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_AUTH_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_AUTH_AGENT_LOG_LEVEL` | No | info | Logging level |
