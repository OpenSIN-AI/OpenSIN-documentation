# Sin Docs Agent — Configuration Reference

> **Agent:** sin-docs-agent | **Team:** Docs | **Status:** ✅ Active
...
```json
{
  "name": "sin-docs-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin docs agent",
  "team": "docs",
...
|----------|----------|---------|-------------|
| `SIN_DOCS_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_DOCS_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_DOCS_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_DOCS_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_DOCS_AGENT_LOG_LEVEL` | No | info | Logging level |
