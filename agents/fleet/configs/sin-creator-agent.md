# Sin Creator Agent — Configuration Reference

> **Agent:** sin-creator-agent | **Team:** Creator | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-creator-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin creator agent",
  "team": "creator",
...
|----------|----------|---------|-------------|
| `SIN_CREATOR_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_CREATOR_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_CREATOR_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_CREATOR_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_CREATOR_AGENT_LOG_LEVEL` | No | info | Logging level |
