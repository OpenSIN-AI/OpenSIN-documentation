# Sin Hf Agent — Configuration Reference

> **Agent:** sin-hf-agent | **Team:** Hf | **Status:** ✅ Active
...
```json
{
  "name": "sin-hf-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin hf agent",
  "team": "hf",
...
|----------|----------|---------|-------------|
| `SIN_HF_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_HF_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_HF_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_HF_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_HF_AGENT_LOG_LEVEL` | No | info | Logging level |
