# Sin Devops Agent — Configuration Reference

> **Agent:** sin-devops-agent | **Team:** Devops | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-devops-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin devops agent",
  "team": "devops",
...
|----------|----------|---------|-------------|
| `SIN_DEVOPS_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_DEVOPS_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_DEVOPS_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_DEVOPS_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_DEVOPS_AGENT_LOG_LEVEL` | No | info | Logging level |
