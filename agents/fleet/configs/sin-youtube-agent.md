# Sin Youtube Agent — Configuration Reference
...
|----------|----------|---------|-------------|
| `SIN_YOUTUBE_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_YOUTUBE_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_YOUTUBE_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_YOUTUBE_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_YOUTUBE_AGENT_LOG_LEVEL` | No | info | Logging level |
