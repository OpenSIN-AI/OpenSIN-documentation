# Sin Photos Agent — Configuration Reference

> **Agent:** sin-photos-agent | **Team:** Photos | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-photos-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin photos agent",
  "team": "photos",
...
|----------|----------|---------|-------------|
| `SIN_PHOTOS_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_PHOTOS_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_PHOTOS_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_PHOTOS_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_PHOTOS_AGENT_LOG_LEVEL` | No | info | Logging level |
