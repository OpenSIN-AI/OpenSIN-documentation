# Sin Company Agent — Configuration Reference

> **Agent:** sin-company-agent | **Team:** Company | **Status:** ✅ Active

## Agent Card

```json
{
  "name": "sin-company-agent",
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin company agent",
  "team": "company",
...
|----------|----------|---------|-------------|
| `SIN_COMPANY_AGENT_API_KEY` | No | — | API key for external services |
| `SIN_COMPANY_AGENT_ENDPOINT` | No | — | Custom endpoint URL |
| `SIN_COMPANY_AGENT_TIMEOUT` | No | 30 | Request timeout in seconds |
| `SIN_COMPANY_AGENT_RETRIES` | No | 3 | Number of retries on failure |
| `SIN_COMPANY_AGENT_LOG_LEVEL` | No | info | Logging level |
