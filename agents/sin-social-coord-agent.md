# Sin Social Coord Agent — Troubleshooting Guide

> **Agent:** sin-social-coord-agent | **Category:** Troubleshooting | **Status:** ✅ Active
...
**Resolution:**
1. Check agent status: `sin-n8n get sin-social-coord-agent`
2. Restart agent: `opencode run --agent "sin-social-coord-agent" "ping"`
3. Check logs: `tail -f /var/log/opensin/sin-social-coord-agent.log`
...
1. Collect logs: `journalctl -u sin-social-coord-agent --no-pager > /tmp/sin-social-coord-agent-logs.txt`
2. Collect config: `cat /etc/opensin/sin-social-coord-agent/config.yaml > /tmp/sin-social-coord-agent-config.txt`
