# Sin Backup Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-backup-agent/)
- [Configuration](../fleet/configs/sin-backup-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-backup-agent.md)
