# Sin Frontend Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-frontend-agent/)
- [Configuration](../fleet/configs/sin-frontend-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-frontend-agent.md)
