# Sin Logistic Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-logistic-agent/)
- [Configuration](../fleet/configs/sin-logistic-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-logistic-agent.md)
