# Sin Devops Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-devops-agent/)
- [Configuration](../fleet/configs/sin-devops-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-devops-agent.md)
