# Sin Auth Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-auth-agent/)
- [Configuration](../fleet/configs/sin-auth-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-auth-agent.md)
