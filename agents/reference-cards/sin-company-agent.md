# Sin Company Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-company-agent/)
- [Configuration](../fleet/configs/sin-company-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-company-agent.md)
