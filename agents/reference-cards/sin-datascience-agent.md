# Sin Datascience Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-datascience-agent/)
- [Configuration](../fleet/configs/sin-datascience-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-datascience-agent.md)
