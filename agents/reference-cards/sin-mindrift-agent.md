# Sin Mindrift Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-mindrift-agent/)
- [Configuration](../fleet/configs/sin-mindrift-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-mindrift-agent.md)
