# Sin Iot Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-iot-agent/)
- [Configuration](../fleet/configs/sin-iot-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-iot-agent.md)
