# Sin Audit Agent — Agent Reference Card

> **Agent:** sin-audit-agent | **Team:** Audit | **Status:** Active
...
```json
{
  ...
  "version": "1.0.0",
  "description": "Autonomous A2A agent for sin audit agent",
  "team": "audit",
...
- [Playbooks](../playbooks/sin-audit-agent/)
- [Configuration](../fleet/configs/sin-audit-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-audit-agent.md)
