# Sin Privacy Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-privacy-agent/)
- [Configuration](../fleet/configs/sin-privacy-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-privacy-agent.md)
