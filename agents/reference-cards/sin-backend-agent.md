# Sin Backend Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-backend-agent/)
- [Configuration](../fleet/configs/sin-backend-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-backend-agent.md)
