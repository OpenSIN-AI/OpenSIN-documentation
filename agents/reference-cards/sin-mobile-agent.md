# Sin Mobile Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-mobile-agent/)
- [Configuration](../fleet/configs/sin-mobile-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-mobile-agent.md)
