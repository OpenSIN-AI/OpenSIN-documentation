# Sin Linkedin Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-linkedin-agent/)
- [Configuration](../fleet/configs/sin-linkedin-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-linkedin-agent.md)
