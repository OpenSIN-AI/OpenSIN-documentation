# Sin Social Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-social-agent/)
- [Configuration](../fleet/configs/sin-social-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-social-agent.md)
