# Sin Monitoring Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-monitoring-agent/)
- [Configuration](../fleet/configs/sin-monitoring-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-monitoring-agent.md)
