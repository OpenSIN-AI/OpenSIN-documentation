# Sin Photos Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-photos-agent/)
- [Configuration](../fleet/configs/sin-photos-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-photos-agent.md)
