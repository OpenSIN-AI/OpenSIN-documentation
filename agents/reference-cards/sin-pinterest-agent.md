# Sin Pinterest Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-pinterest-agent/)
- [Configuration](../fleet/configs/sin-pinterest-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-pinterest-agent.md)
