# Sin Orchestrator Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-orchestrator-agent/)
- [Configuration](../fleet/configs/sin-orchestrator-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-orchestrator-agent.md)
