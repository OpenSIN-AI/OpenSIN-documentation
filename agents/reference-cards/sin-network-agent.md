# Sin Network Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-network-agent/)
- [Configuration](../fleet/configs/sin-network-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-network-agent.md)
