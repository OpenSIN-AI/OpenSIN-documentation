# Sin Notifications Agent — Agent Reference Card
...
- [Playbooks](../playbooks/sin-notifications-agent/)
- [Configuration](../fleet/configs/sin-notifications-agent.md)
- [Troubleshooting](../fleet/troubleshooting/sin-notifications-agent.md)
