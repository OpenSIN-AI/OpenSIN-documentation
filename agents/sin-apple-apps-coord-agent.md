# Sin Apple Apps Coord Agent — Troubleshooting Guide

> **Agent:** sin-apple-apps-coord-agent | **Category:** Troubleshooting | **Status:** ✅ Active
...
**Resolution:**
1. Check agent status: `sin-n8n get sin-apple-apps-coord-agent`
2. Restart agent: `opencode run --agent "sin-apple-apps-coord-agent" "ping"`
3. Check logs: `tail -f /var/log/opensin/sin-apple-apps-coord-agent.log`
...
1. Collect logs: `journalctl -u sin-apple-apps-coord-agent --no-pager > /tmp/sin-apple-apps-coord-agent-logs.txt`
2. Collect config: `cat /etc/opensin/sin-apple-apps-coord-agent/config.yaml > /tmp/sin-apple-apps-coord-agent-config.txt`
